...
### `bash:devel-20260828` - linux; amd64
...
### `bash:devel-20260828` - unknown; unknown
...
### `bash:devel-20260828` - linux; arm variant v6
...
### `bash:devel-20260828` - linux; arm variant v7
...
### `bash:devel-20260828` - linux; arm64 variant v8
...
### `bash:devel-20260828` - linux; ppc64le
...
### `bash:devel-20260828` - linux; s390x
