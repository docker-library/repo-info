...
```console
$ docker pull bash@sha256:a4dc440f7ee3442895260593b6e13ff6ffccdd931a60e9e9b9745973498491c0
```
...
### `bash:devel-20260701-alpine3.24` - linux; amd64
...
### `bash:devel-20260701-alpine3.24` - unknown; unknown
...
### `bash:devel-20260701-alpine3.24` - linux; arm variant v6
...
### `bash:devel-20260701-alpine3.24` - linux; arm variant v7
...
### `bash:devel-20260701-alpine3.24` - linux; arm64 variant v8
...
### `bash:devel-20260701-alpine3.24` - linux; 386
...
### `bash:devel-20260701-alpine3.24` - linux; ppc64le
...
### `bash:devel-20260701-alpine3.24` - linux; s390x
