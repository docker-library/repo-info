## `bash:devel-20260828-alpine3.24`

```console
$ docker pull bash@sha256:64de98b0f9a2a7f80ba937fc9fd810ad3f06bf3f34d668bca4a501fa8c88c7d6
```
...
### `bash:devel-20260828-alpine3.24` - linux; amd64
...
### `bash:devel-20260828-alpine3.24` - unknown; unknown
...
### `bash:devel-20260828-alpine3.24` - linux; arm variant v6
...
### `bash:devel-20260828-alpine3.24` - linux; arm variant v7
...
### `bash:devel-20260828-alpine3.24` - linux; arm64 variant v8
...
### `bash:devel-20260828-alpine3.24` - linux; 386
...
### `bash:devel-20260828-alpine3.24` - linux; ppc64le
...
### `bash:devel-20260828-alpine3.24` - linux; s390x
