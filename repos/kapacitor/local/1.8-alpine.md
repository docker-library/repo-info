...
- Created: `2026-07-20T18:49:22.671419836Z`
- Virtual Size: ~ 354.09 Mb  
...
```console
libcap-ng-0.8.5-r2 description:
POSIX capabilities library

libcap-ng-0.8.5-r2 webpage:
https://people.redhat.com/sgrubb/libcap-ng/index.html

libcap-ng-0.8.5-r2 installed size:
39 KiB

libcap-ng-0.8.5-r2 license:
...
```console
setpriv-2.42.1-r0 description:
Run a program with different Linux privilege settings

setpriv-2.42.1-r0 webpage:
https://git.kernel.org/cgit/utils/util-linux/util-linux.git

setpriv-2.42.1-r0 installed size:
34 KiB

setpriv-2.42.1-r0 license:
GPL-2.0-or-later
