...
```console
$ docker pull memcached@sha256:27a07cb805b7dcf36ca6d72e32232c71ca6e9870f8d2a2c3e1526f5b1e2f4a1c
```
...
### `memcached:1.6.44-alpine` - linux; s390x
...
### `memcached:1.6.44-alpine3.24` - linux; s390x
