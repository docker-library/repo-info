...
### `amazoncorretto:27-alpine3.24-full` - linux; amd64
...
### `amazoncorretto:27-alpine3.24-full` - unknown; unknown
...
### `amazoncorretto:27-alpine3.24-full` - linux; arm64 variant v8
