...
### `amazoncorretto:26-alpine3.24` - linux; amd64
...
### `amazoncorretto:26-alpine3.24` - unknown; unknown
...
### `amazoncorretto:26-alpine3.24` - linux; arm64 variant v8
