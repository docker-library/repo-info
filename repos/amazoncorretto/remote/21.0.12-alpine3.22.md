...
### `amazoncorretto:21.0.12-alpine3.22` - linux; amd64
...
### `amazoncorretto:21.0.12-alpine3.22` - unknown; unknown
...
### `amazoncorretto:21.0.12-alpine3.22` - linux; arm64 variant v8
