...
### `amazoncorretto:17.0.20-al2023-headful` - linux; amd64
...
### `amazoncorretto:17.0.20-al2023-headful` - unknown; unknown
...
### `amazoncorretto:17.0.20-al2023-headful` - linux; arm64 variant v8
