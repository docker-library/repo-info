...
- Image ID: `sha256:b37a4d56eedb5e42bca59c8d4782fa550e741fba5dbce943c53767d3ceee57e6`
- Created: `2026-09-23T21:09:37.546103531Z`
...
### `dpkg` source package: `aom=3.6.0-1+deb12u3`

Binary Packages:

- `libaom3:amd64=3.6.0-1+deb12u3`
...
```console
$ apt-get source -qq --print-uris aom=3.6.0-1+deb12u3
'http://deb.debian.org/debian-security/pool/updates/main/a/aom/aom_3.6.0-1%2bdeb12u3.dsc' aom_3.6.0-1+deb12u3.dsc 2239 SHA256:8d11a3b529c65d55f11cf85244e2826d2e249e8dc7f4c484cb13370313a3b235
...
'http://deb.debian.org/debian-security/pool/updates/main/a/aom/aom_3.6.0-1%2bdeb12u3.debian.tar.xz' aom_3.6.0-1+deb12u3.debian.tar.xz 28012 SHA256:79ae3cf9a422308fce165b018866307e4b5592dfe7d34774e4f7ab8899f52011
```

Other potentially useful URLs:

- https://sources.debian.net/src/aom/3.6.0-1+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/aom/3.6.0-1+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/aom/3.6.0-1+deb12u3/ (for access to the source package after it no longer exists in the archive)
...
- `libexpat1-dev:amd64=2.5.0-1+deb12u3`
...
### `dpkg` source package: `libevent=2.1.12-stable-8+deb12u1`

Binary Packages:

- `libevent-2.1-7:amd64=2.1.12-stable-8+deb12u1`
- `libevent-core-2.1-7:amd64=2.1.12-stable-8+deb12u1`
- `libevent-dev=2.1.12-stable-8+deb12u1`
- `libevent-extra-2.1-7:amd64=2.1.12-stable-8+deb12u1`
- `libevent-openssl-2.1-7:amd64=2.1.12-stable-8+deb12u1`
- `libevent-pthreads-2.1-7:amd64=2.1.12-stable-8+deb12u1`
...
```console
$ apt-get source -qq --print-uris libevent=2.1.12-stable-8+deb12u1
'http://deb.debian.org/debian-security/pool/updates/main/libe/libevent/libevent_2.1.12-stable-8%2bdeb12u1.dsc' libevent_2.1.12-stable-8+deb12u1.dsc 2388 SHA256:acc01f440019a0369c1cf0e6256a22037a65f032b5192ee14bad548889074b55
'http://deb.debian.org/debian-security/pool/updates/main/libe/libevent/libevent_2.1.12-stable.orig.tar.gz' libevent_2.1.12-stable.orig.tar.gz 1100847 SHA256:92e6de1be9ec176428fd2367677e61ceffc2ee1cb119035037a27d346b0403bb
'http://deb.debian.org/debian-security/pool/updates/main/libe/libevent/libevent_2.1.12-stable-8%2bdeb12u1.debian.tar.xz' libevent_2.1.12-stable-8+deb12u1.debian.tar.xz 25488 SHA256:0c721f8a55e6a9e225f62f151f477675ed901400b56003bb424ef2eea74f370d
```

Other potentially useful URLs:

- https://sources.debian.net/src/libevent/2.1.12-stable-8+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/libevent/2.1.12-stable-8+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libevent/2.1.12-stable-8+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libssh2=1.10.0-3+deb12u1`

Binary Packages:

- `libssh2-1:amd64=1.10.0-3+deb12u1`
...
```console
$ apt-get source -qq --print-uris libssh2=1.10.0-3+deb12u1
'http://deb.debian.org/debian-security/pool/updates/main/libs/libssh2/libssh2_1.10.0-3%2bdeb12u1.dsc' libssh2_1.10.0-3+deb12u1.dsc 2096 SHA256:c83e73990cdc7f315c57cc558fcc677fbc6e9a102edde97b3ddb4ba9c9fc189a
'http://deb.debian.org/debian-security/pool/updates/main/libs/libssh2/libssh2_1.10.0.orig.tar.gz' libssh2_1.10.0.orig.tar.gz 965044 SHA256:2d64e90f3ded394b91d3a2e774ca203a4179f69aebee03003e5a6fa621e41d51
'http://deb.debian.org/debian-security/pool/updates/main/libs/libssh2/libssh2_1.10.0-3%2bdeb12u1.debian.tar.xz' libssh2_1.10.0-3+deb12u1.debian.tar.xz 12196 SHA256:e4da32facae7fea48f1ba73ba1a17214ee88863143517bf7e4d58a6149deb792
```

Other potentially useful URLs:

- https://sources.debian.net/src/libssh2/1.10.0-3+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/libssh2/1.10.0-3+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libssh2/1.10.0-3+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pcre2=10.42-1+deb12u1`

Binary Packages:

- `libpcre2-16-0:amd64=10.42-1+deb12u1`
- `libpcre2-32-0:amd64=10.42-1+deb12u1`
- `libpcre2-8-0:amd64=10.42-1+deb12u1`
- `libpcre2-dev:amd64=10.42-1+deb12u1`
- `libpcre2-posix3:amd64=10.42-1+deb12u1`
...
```console
$ apt-get source -qq --print-uris pcre2=10.42-1+deb12u1
'http://deb.debian.org/debian-security/pool/updates/main/p/pcre2/pcre2_10.42-1%2bdeb12u1.dsc' pcre2_10.42-1+deb12u1.dsc 2226 SHA256:20bfc5b620ab5017489fd5168fd427bbaad9d209dffa0a2e4025d5cc215f70a3
'http://deb.debian.org/debian-security/pool/updates/main/p/pcre2/pcre2_10.42.orig.tar.gz' pcre2_10.42.orig.tar.gz 2397194 SHA256:c33b418e3b936ee3153de2c61cc638e7e4fe3156022a5c77d0711bcbb9d64f1f
'http://deb.debian.org/debian-security/pool/updates/main/p/pcre2/pcre2_10.42-1%2bdeb12u1.diff.gz' pcre2_10.42-1+deb12u1.diff.gz 15939 SHA256:4e1e2103da0d905d30c69c8fea259d654ac7282b90236071281901f28e7dd719
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcre2/10.42-1+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/pcre2/10.42-1+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pcre2/10.42-1+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
- `liblzma-dev:amd64=5.4.1-1+deb12u2`
