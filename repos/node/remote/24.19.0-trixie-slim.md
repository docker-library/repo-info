...
```console
$ docker pull node@sha256:996f094d0487f4f9cbc9227a4ebba56e011d3653679909b04a9fa6dc7ab54aa4
```
...
### `node:24.19.0-trixie-slim` - linux; amd64
...
### `node:24.19.0-trixie-slim` - unknown; unknown
...
### `node:24.19.0-trixie-slim` - linux; arm64 variant v8
...
### `node:24.19.0-trixie-slim` - linux; ppc64le
...
### `node:24.19.0-trixie-slim` - linux; s390x
