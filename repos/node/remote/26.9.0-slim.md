...
```console
$ docker pull node@sha256:65f816afd401c1c4de3293acc46dce115398152af4bdcd73c103b096988922d7
```
...
### `node:26.9.0-slim` - unknown; unknown
...
### `node:26.9.0-slim` - linux; arm64 variant v8
...
### `node:26.9.0-slim` - linux; ppc64le
