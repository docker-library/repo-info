...
### `node:26.8.1-trixie-slim` - linux; amd64
...
### `node:26.8.1-trixie-slim` - unknown; unknown
...
### `node:26.8.1-trixie-slim` - linux; arm64 variant v8
...
### `node:26.8.1-trixie-slim` - linux; ppc64le
...
### `node:26.8.1-trixie-slim` - linux; s390x
