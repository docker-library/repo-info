...
```console
$ docker pull node@sha256:1354a658fbee3dcb8ca4b66ffa3e9175a4139d2d95e46442131ac8243cb5bbf4
```
...
### `node:26.7-trixie` - unknown; unknown
...
### `node:26.7-trixie` - linux; arm64 variant v8
