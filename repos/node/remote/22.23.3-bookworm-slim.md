...
### `node:22.23.3-bookworm-slim` - linux; amd64
...
### `node:22.23.3-bookworm-slim` - unknown; unknown
...
### `node:22.23.3-bookworm-slim` - linux; arm variant v7
...
### `node:22.23.3-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.23.3-bookworm-slim` - linux; ppc64le
