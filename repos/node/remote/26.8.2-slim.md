...
```console
$ docker pull node@sha256:f7bb8247fdb16250dbec7fd0e24f091c6f5f0a29d256f3aef5816a7a369166b2
```
...
### `node:26.8.2-slim` - unknown; unknown
...
### `node:26.8.2-slim` - linux; arm64 variant v8
...
### `node:26.8.2-slim` - linux; ppc64le
