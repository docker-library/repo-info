...
### `node:22.23.1-bullseye` - linux; amd64
...
### `node:22.23.1-bullseye` - unknown; unknown
...
### `node:22.23.1-bullseye` - linux; arm variant v7
...
### `node:22.23.1-bullseye` - linux; arm64 variant v8
