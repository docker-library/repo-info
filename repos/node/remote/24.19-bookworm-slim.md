...
### `node:24.19-bookworm-slim` - linux; amd64
...
### `node:24.19-bookworm-slim` - unknown; unknown
...
### `node:24.19-bookworm-slim` - linux; arm64 variant v8
...
### `node:24.19-bookworm-slim` - linux; ppc64le
