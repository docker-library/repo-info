...
### `node:26.5.1-bookworm-slim` - linux; amd64
...
### `node:26.5.1-bookworm-slim` - unknown; unknown
...
### `node:26.5.1-bookworm-slim` - linux; arm64 variant v8
...
### `node:26.5.1-bookworm-slim` - linux; ppc64le
