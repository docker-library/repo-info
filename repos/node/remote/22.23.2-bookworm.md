...
### `node:22.23.2-bookworm` - linux; amd64
...
### `node:22.23.2-bookworm` - unknown; unknown
...
### `node:22.23.2-bookworm` - linux; arm variant v7
...
### `node:22.23.2-bookworm` - linux; arm64 variant v8
...
### `node:22.23.2-bookworm` - linux; ppc64le
