...
### `node:22.23.3-trixie` - linux; amd64
...
### `node:22.23.3-trixie` - unknown; unknown
...
### `node:22.23.3-trixie` - linux; arm64 variant v8
...
### `node:22.23.3-trixie` - linux; ppc64le
...
### `node:22.23.3-trixie` - linux; s390x
