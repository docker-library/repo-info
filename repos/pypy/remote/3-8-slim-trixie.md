...
### `pypy:3-8-slim-trixie` - linux; amd64
...
### `pypy:3-8-slim-trixie` - unknown; unknown
...
### `pypy:3-8-slim-trixie` - linux; arm64 variant v8
...
### `pypy:3-8-slim-trixie` - linux; 386
