...
```console
$ docker pull postgres@sha256:c95dee655b8a0743021bdbd2d21abb7ef2fd520c5df39bd328798769c049648f
```
...
### `postgres:16.14-alpine3.23` - linux; amd64
...
### `postgres:16.14-alpine3.23` - unknown; unknown
...
### `postgres:16.14-alpine3.23` - linux; arm variant v6
...
### `postgres:16.14-alpine3.23` - linux; arm variant v7
...
### `postgres:16.14-alpine3.23` - linux; arm64 variant v8
...
### `postgres:16.14-alpine3.23` - linux; 386
...
### `postgres:16.14-alpine3.23` - linux; ppc64le
...
### `postgres:16.14-alpine3.23` - linux; riscv64
...
### `postgres:16.14-alpine3.23` - linux; s390x
