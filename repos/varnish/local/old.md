...
- Environment:
  ...
  - `VMOD_DEPS=autoconf-archive automake curl libtool make pkg-config python3-sphinx varnish-dev`
  - `VARNISH_SIZE=100M`
  - `VSM_NOPID=1`
...
### `dpkg` source package: `hiredis=1.2.0-6`

Binary Packages:

- `libhiredis1.1.0:amd64=1.2.0-6+b3`

Licenses: (parsed from: `/usr/share/doc/libhiredis1.1.0/copyright`)
...
```console
$ apt-get source -qq --print-uris hiredis=1.2.0-6
'http://deb.debian.org/debian/pool/main/h/hiredis/hiredis_1.2.0-6.dsc' hiredis_1.2.0-6.dsc 2039 SHA256:9e14f474f15d92c7ad1c9cb7c9ad0f1f8cc202492503103973f1fc08361d1cc6
'http://deb.debian.org/debian/pool/main/h/hiredis/hiredis_1.2.0.orig.tar.gz' hiredis_1.2.0.orig.tar.gz 126216 SHA256:82ad632d31ee05da13b537c124f819eb88e18851d9cb0c30ae0552084811588c
'http://deb.debian.org/debian/pool/main/h/hiredis/hiredis_1.2.0-6.debian.tar.xz' hiredis_1.2.0-6.debian.tar.xz 9964 SHA256:b0f46b0d467507ee3e1f165664484528e0f8ff33691cbdd19bf85fc96e604187
```

Other potentially useful URLs:

- https://sources.debian.net/src/hiredis/1.2.0-6/ (for browsing the source)
- https://sources.debian.net/src/hiredis/1.2.0-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/hiredis/1.2.0-6/ (for access to the source package after it no longer exists in the archive)
...
- `libluajit-5.1-2:amd64=2.1.0+openresty20250117-2`
- `libluajit-5.1-common=2.1.0+openresty20250117-2`

Licenses: (parsed from: `/usr/share/doc/libluajit-5.1-2/copyright`, `/usr/share/doc/libluajit-5.1-common/copyright`)
...
```console
$ apt-get source -qq --print-uris luajit=2.1.0+openresty20250117-2
'http://deb.debian.org/debian/pool/main/l/luajit/luajit_2.1.0%2bopenresty20250117-2.dsc' luajit_2.1.0+openresty20250117-2.dsc 2620 SHA256:861885b6d01e4802b8824cae12918ef023910659ac6b3bf414203157874f6864
'http://deb.debian.org/debian/pool/main/l/luajit/luajit_2.1.0%2bopenresty20250117.orig.tar.xz' luajit_2.1.0+openresty20250117.orig.tar.xz 734876 SHA256:99ad5fdfa85e08a291454f797f625fbb53f4d2129cac063922255a1fe34ccf1c
'http://deb.debian.org/debian/pool/main/l/luajit/luajit_2.1.0%2bopenresty20250117-2.debian.tar.xz' luajit_2.1.0+openresty20250117-2.debian.tar.xz 97500 SHA256:6138bdac1c7f3a7fcaa06997ec905f4beabd5b9938e59ff32e16f4d289833acd
```

Other potentially useful URLs:

- https://sources.debian.net/src/luajit/2.1.0+openresty20250117-2/ (for browsing the source)
- https://sources.debian.net/src/luajit/2.1.0+openresty20250117-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/luajit/2.1.0+openresty20250117-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `manpages=6.9.1-1`
...
```console
$ apt-get source -qq --print-uris manpages=6.9.1-1
'http://deb.debian.org/debian/pool/main/m/manpages/manpages_6.9.1-1.dsc' manpages_6.9.1-1.dsc 1962 SHA256:3b339c5e7cf658a5397496b6ac358a4f9c1b442c3d363de7cd621eb7d1ed0005
'http://deb.debian.org/debian/pool/main/m/manpages/manpages_6.9.1.orig.tar.xz' manpages_6.9.1.orig.tar.xz 1864500 SHA256:e23cbac29f110ba571f0da8523e79d373691466ed7f2a31301721817d34530bd
'http://deb.debian.org/debian/pool/main/m/manpages/manpages_6.9.1-1.debian.tar.xz' manpages_6.9.1-1.debian.tar.xz 57796 SHA256:d0eb77e83a9cff39ace8af0f461ef931df020b3837cd5cb16de4f537e3a5bde0
```

Other potentially useful URLs:

- https://sources.debian.net/src/manpages/6.9.1-1/ (for browsing the source)
- https://sources.debian.net/src/manpages/6.9.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/manpages/6.9.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mhash=0.9.9.9-10`
...
```console
$ apt-get source -qq --print-uris mhash=0.9.9.9-10
'http://deb.debian.org/debian/pool/main/m/mhash/mhash_0.9.9.9-10.dsc' mhash_0.9.9.9-10.dsc 1906 SHA256:68bf81dfb7a09525fcf6796643003a42316a508b5093c09feb052845f43586d4
...
'http://deb.debian.org/debian/pool/main/m/mhash/mhash_0.9.9.9-10.debian.tar.xz' mhash_0.9.9.9-10.debian.tar.xz 14164 SHA256:91efce20f169dfa49dae267d25dc5a565552d466c822cc8d721d5e1166c36a8e
```

Other potentially useful URLs:

- https://sources.debian.net/src/mhash/0.9.9.9-10/ (for browsing the source)
- https://sources.debian.net/src/mhash/0.9.9.9-10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mhash/0.9.9.9-10/ (for access to the source package after it no longer exists in the archive)
