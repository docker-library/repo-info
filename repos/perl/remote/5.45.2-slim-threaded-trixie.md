...
```console
$ docker pull perl@sha256:66bd6b5135b641f2f836b68044e5bee1bcec9cccbfdf7113cd3caa6aa5c44673
```
...
### `perl:5.45.2-slim-threaded-trixie` - linux; amd64
...
### `perl:5.45.2-slim-threaded-trixie` - unknown; unknown
...
### `perl:5.45.2-slim-threaded-trixie` - linux; arm variant v5
...
### `perl:5.45.2-slim-threaded-trixie` - linux; arm variant v7
...
### `perl:5.45.2-slim-threaded-trixie` - linux; arm64 variant v8
...
### `perl:5.45.2-slim-threaded-trixie` - linux; ppc64le
...
### `perl:5.45.2-slim-threaded-trixie` - linux; s390x
