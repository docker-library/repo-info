...
```console
$ docker pull perl@sha256:6ca0602100736717f27045f29dcb2255e85d56a9581af6681088ad441d5ee924
```
...
```console
$ docker pull perl@sha256:5215080ae810a0112dc5526b9c0baeaa62128eebed2f11b22a8ff36cc8e9a8ca
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.1 MB (331066438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa948e7d32526aa61c010923086bed054db5d725e76a4373e9640b2c40552ff3`
-	Default Command: `["perl5.44.0","-de0"]`
...
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		autoconf 		automake 		bzip2 		default-libmysqlclient-dev 		dpkg-dev 		file 		g++ 		gcc 		imagemagick 		libbz2-dev 		libc6-dev 		libcurl4-openssl-dev 		libdb-dev 		libevent-dev 		libffi-dev 		libgdbm-dev 		libglib2.0-dev 		libgmp-dev 		libjpeg-dev 		libkrb5-dev 		liblzma-dev 		libmagickcore-dev 		libmagickwand-dev 		libmaxminddb-dev 		libncurses5-dev 		libncursesw5-dev 		libpng-dev 		libpq-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		libtool 		libwebp-dev 		libxml2-dev 		libxslt-dev 		libyaml-dev 		make 		patch 		unzip 		xz-utils 		zlib1g-dev 	; 	rm -rf /var/lib/apt/lists/* # buildkit
# Wed, 22 Jul 2026 18:23:17 GMT
WORKDIR /usr/src/perl
# Wed, 22 Jul 2026 18:28:54 GMT
RUN true     && curl -fL https://cpan.metacpan.org/authors/id/L/LE/LEONT/perl-5.44.0.tar.gz -o perl-5.44.0.tar.gz     && echo '3b855066b92491cb40e86affb1ca57d1a388aa43e51b91c7806a32c2f65f96c3 *perl-5.44.0.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.44.0.tar.gz -C /usr/src/perl     && rm perl-5.44.0.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7049.tar.gz     && echo 'b9ffb88e62a06aa91bd7d5a28ef6bdbb942608aea90e3969aa29b33640035214 *App-cpanminus-1.7049.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7049.tar.gz && cd App-cpanminus-1.7049     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.96.tar.gz'     && echo 'ab213691685fb2a576c669cbc8d9266f8165a31563ad15b7c4030b94adfc0753 *Net-SSLeay-1.96.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.96.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.099.tar.gz'     && echo 'a0be800ff4852b1567ee5500e772417ad7a360abff80c01b5b875c15d44be832 *IO-Socket-SSL-2.099.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.099.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/v1.1.4/cpm -o /usr/local/bin/cpm     && echo '6f5ae6d0e25ba20f768b8856ea61481da9d142a04629d658025011c76d3bbc3f */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /root/Net-SSLeay-1.96* /root/IO-Socket-SSL-2.099* /usr/src/perl /usr/src/App-cpanminus-1.7049* /tmp/*     && cpanm --version && cpm --version # buildkit
# Wed, 22 Jul 2026 18:28:54 GMT
WORKDIR /usr/src/app
# Wed, 22 Jul 2026 18:28:54 GMT
...
-	Layers:
	...
	-	`sha256:3300a8e15ac3112b44efb386d5552f4ea35e817ec88c4e461ac414cdb509a494`  
		...
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4c93ecc9c65fd8cbbb615aea0f564ae4c5ffbfc0889c8a4d2563eb2b6b59d451`  
		Last Modified: Wed, 22 Jul 2026 18:29:15 GMT  
		Size: 15.4 MB (15405533 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:59bc2a25656639ef39b8226658b94a45e02d195e0896e5c8c6ac0acb0ed2ad0c`  
		Last Modified: Wed, 22 Jul 2026 18:29:14 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:97db8c0f18ae8677643a05a015bfee50fd0c2175c9595ad0a0a3b7b42dd71f91
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.7 MB (15683716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf0528359bbefddeb08c13287b27619a09e6e2d13e5f8fd3de2636eed534706e`

```dockerfile
```

-	Layers:
	-	`sha256:019cf2f69182aa9d9ad49b4346a78cf3ad996e98f5be8341aec3c9e069fc9671`  
		Last Modified: Wed, 22 Jul 2026 18:29:15 GMT  
		Size: 15.7 MB (15665498 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d9584182637acff0574cf2b214fc1111f1f6071fc35f574f7d947795341b9a86`  
		Last Modified: Wed, 22 Jul 2026 18:29:14 GMT  
...
```console
$ docker pull perl@sha256:ad8c5f255d1aa190dfc96d96732375a66b1f2b36a70735501f555634af359cce
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.4 MB (341436240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87e3c39285b1745a31aa0a887c56d04f4f974b6b766cb84d551a3b93a9042c12`
-	Default Command: `["perl5.44.0","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 22 Jul 2026 18:48:27 GMT
RUN true     && curl -fL https://cpan.metacpan.org/authors/id/L/LE/LEONT/perl-5.44.0.tar.gz -o perl-5.44.0.tar.gz     && echo '3b855066b92491cb40e86affb1ca57d1a388aa43e51b91c7806a32c2f65f96c3 *perl-5.44.0.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.44.0.tar.gz -C /usr/src/perl     && rm perl-5.44.0.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7049.tar.gz     && echo 'b9ffb88e62a06aa91bd7d5a28ef6bdbb942608aea90e3969aa29b33640035214 *App-cpanminus-1.7049.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7049.tar.gz && cd App-cpanminus-1.7049     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.96.tar.gz'     && echo 'ab213691685fb2a576c669cbc8d9266f8165a31563ad15b7c4030b94adfc0753 *Net-SSLeay-1.96.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.96.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.099.tar.gz'     && echo 'a0be800ff4852b1567ee5500e772417ad7a360abff80c01b5b875c15d44be832 *IO-Socket-SSL-2.099.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.099.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/v1.1.4/cpm -o /usr/local/bin/cpm     && echo '6f5ae6d0e25ba20f768b8856ea61481da9d142a04629d658025011c76d3bbc3f */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /root/Net-SSLeay-1.96* /root/IO-Socket-SSL-2.099* /usr/src/perl /usr/src/App-cpanminus-1.7049* /tmp/*     && cpanm --version && cpm --version # buildkit
# Wed, 22 Jul 2026 18:48:29 GMT
WORKDIR /usr/src/app
# Wed, 22 Jul 2026 18:48:29 GMT
CMD ["perl5.44.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:af3e8858f79c3149731e95186cdce12855b6ec222be32f78af5afd1af72c456f`  
		...
		Size: 134.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:634b9de74b202adcb04d714a182e2232d097a074cbc162d30903579619a7e852`  
		Last Modified: Wed, 22 Jul 2026 18:49:34 GMT  
		Size: 15.3 MB (15314213 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6a4c59e470b747b87fb6b1526a14ce6c6e9bbdc3017ff8c4e917685ed79f1c8e`  
		Last Modified: Wed, 22 Jul 2026 18:49:32 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:8206e952650576770c4e7ed07c9bdc507a181bdda050594d9f6f6c8a06e2d5a8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.0 KB (17990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8235e574c711874f1d02f200cd10179d9a36b9d41a647624fcf28e3103219918`

```dockerfile
```

-	Layers:
	-	`sha256:175a43bd9ab8911c7cb87cfc8c26c2735f7bf8ba35cba3a6fddd93b02d209613`  
		Last Modified: Wed, 22 Jul 2026 18:49:32 GMT  
...
```console
$ docker pull perl@sha256:481e97f91c16204489c4c781dec6ea0338348181476d3bafe7b23385ddaec35e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.8 MB (334805966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61e33bda5c02893d3d65d1ec16aab4b2bea20d6ab9c8175d68451160548b5c80`
-	Default Command: `["perl5.44.0","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 22 Jul 2026 18:34:10 GMT
RUN true     && curl -fL https://cpan.metacpan.org/authors/id/L/LE/LEONT/perl-5.44.0.tar.gz -o perl-5.44.0.tar.gz     && echo '3b855066b92491cb40e86affb1ca57d1a388aa43e51b91c7806a32c2f65f96c3 *perl-5.44.0.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.44.0.tar.gz -C /usr/src/perl     && rm perl-5.44.0.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7049.tar.gz     && echo 'b9ffb88e62a06aa91bd7d5a28ef6bdbb942608aea90e3969aa29b33640035214 *App-cpanminus-1.7049.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7049.tar.gz && cd App-cpanminus-1.7049     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.96.tar.gz'     && echo 'ab213691685fb2a576c669cbc8d9266f8165a31563ad15b7c4030b94adfc0753 *Net-SSLeay-1.96.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.96.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.099.tar.gz'     && echo 'a0be800ff4852b1567ee5500e772417ad7a360abff80c01b5b875c15d44be832 *IO-Socket-SSL-2.099.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.099.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/v1.1.4/cpm -o /usr/local/bin/cpm     && echo '6f5ae6d0e25ba20f768b8856ea61481da9d142a04629d658025011c76d3bbc3f */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /root/Net-SSLeay-1.96* /root/IO-Socket-SSL-2.099* /usr/src/perl /usr/src/App-cpanminus-1.7049* /tmp/*     && cpanm --version && cpm --version # buildkit
# Wed, 22 Jul 2026 18:34:13 GMT
WORKDIR /usr/src/app
# Wed, 22 Jul 2026 18:34:13 GMT
CMD ["perl5.44.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0377bed5cfe1387a9cddc4c72a93b60cce9d2f6c692a454a7f03c9f4cfe07869`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:93e49897d9817b6d5d0c019d113d4697af00b4f2f61a0f91ae256b083f03362f`  
		Last Modified: Wed, 22 Jul 2026 18:35:25 GMT  
		Size: 134.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1fae97222af5d8423c8cae5d43a637275f3943d094c0dfe0829ef6576ef70925`  
		Last Modified: Wed, 22 Jul 2026 18:35:29 GMT  
		Size: 16.5 MB (16452700 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:999a3907cb90d6bc93190db3db1cd073fe64327248c8f42b7441b0e5f613362a`  
		Last Modified: Wed, 22 Jul 2026 18:35:26 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:df5865436cf0920b1217d5e8fd90e44fee92757709404a3f7bb9261e72d88f0f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.7 MB (15694218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb4e82a04cf933949d6c4c0a829012f538b948bae32c9a7427bb584eb4366003`

```dockerfile
```

-	Layers:
	-	`sha256:bbe4a24d489c38785bf07a129c2d5a7eae76b4140acffec329d0239b1c8ad522`  
		Last Modified: Wed, 22 Jul 2026 18:35:28 GMT  
		Size: 15.7 MB (15676088 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:617497254b217da6ea7c43554336d9e309a10f685143dadf4894ad27b7183802`  
		Last Modified: Wed, 22 Jul 2026 18:35:24 GMT  
		Size: 18.1 KB (18130 bytes)  
		MIME: application/vnd.in-toto+json
