...
### `perl:5.44-trixie` - unknown; unknown
...
### `perl:5.44-trixie` - linux; arm variant v5
...
### `perl:5.44-trixie` - linux; arm variant v7
...
### `perl:5.44-trixie` - linux; arm64 variant v8
...
### `perl:5.44-trixie` - linux; ppc64le
...
### `perl:5.44-trixie` - linux; riscv64
