...
```console
$ docker pull perl@sha256:c1d4e6417c747dc340e3749405ba20769e27a177b74893fce1c7133f34855768
```
...
```console
$ docker pull perl@sha256:41d732b8fb982c267a5f1fb4f0b37559de7343f916ece04a5dca8004a1162a19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.8 MB (327774406 bytes)**  
...
-	Layers:
	...
	-	`sha256:1b31b6fffbedd09c0ca7199c012a5a96dc4bb8b2ec78a7203ec363b9f2d018f1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:860814c1b4fbba36da8ae79e2ef0f64f5bd1b53d0442e8ce9c0ab323bb0ac666`  
		Last Modified: Tue, 24 Jan 2023 22:11:22 GMT  
		Size: 15.7 MB (15652852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.37-threaded-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:8c1e48bbedd88170e00325335f8d1e1d17a4f0568b043c2e21ab10137d658914
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.7 MB (292665753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de2eded93ea7f6a0dd87b326d867a75415b2519d62bcee258394a5ff0154cf6e`
-	Default Command: `["perl5.37.8","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 21:39:07 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.37.8.tar.xz -o perl-5.37.8.tar.xz     && echo 'eca6396a4b1aa7a38ef467ce54ed897cc84ba948fad0f90aeb210e57b04daf3c *perl-5.37.8.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.37.8.tar.xz -C /usr/src/perl     && rm perl-5.37.8.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 21:39:08 GMT
WORKDIR /
# Tue, 24 Jan 2023 21:39:08 GMT
CMD ["perl5.37.8" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8537e93313d7070c2492af29be931bf34f38f8df607a15124058f159384c7187`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6e5b1cf12cb3d2c6c9964b290b6ef79f8cdd4f2a427533f476db4e910374331`  
		Last Modified: Tue, 24 Jan 2023 22:09:25 GMT  
		Size: 14.7 MB (14734496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.37-threaded-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:6e33ad3f1e84c8cb16ede01132e3755da4e3f6045585aac54cc10e55b32bc680
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.2 MB (318237637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db5aaee0fafaed04398864417f2feb2bf09e2d2690a7938bf1e8f4b8bf10fc1d`
-	Default Command: `["perl5.37.8","-de0"]`
...
-	Layers:
	...
	-	`sha256:7c7f37acaaa7e7d627a5a332ee5cd86508a9ee83e8406b4dff9ad1d10c67f32f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3a408f2a05c096fcc428684850a1db69194968415e873556cfabf180f9c8a87`  
		Last Modified: Tue, 24 Jan 2023 20:45:30 GMT  
		Size: 15.6 MB (15561749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.37-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:919292203f1ebdfa81faec8ac8c6b3987c16082cca6ba13712b8fadd915c28d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.5 MB (336522035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:272dd1a3e408b32c6e45d1f1548233e057669a6d1beab32dc9d9489f7c0ee73a`
-	Default Command: `["perl5.37.8","-de0"]`
...
# Tue, 24 Jan 2023 18:11:46 GMT
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 21:18:14 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.37.8.tar.xz -o perl-5.37.8.tar.xz     && echo 'eca6396a4b1aa7a38ef467ce54ed897cc84ba948fad0f90aeb210e57b04daf3c *perl-5.37.8.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.37.8.tar.xz -C /usr/src/perl     && rm perl-5.37.8.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 21:18:15 GMT
WORKDIR /
# Tue, 24 Jan 2023 21:18:15 GMT
CMD ["perl5.37.8" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:09c6afbb26a20a82fadfde72562f3d3c57305027c78fd47a6202e22bbc5bf3e3`  
		...
		Size: 134.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e97e6c2d3dd1bd7c6415376bc62a4f29d7105b30242602a6b4975f08f75d04cf`  
		Last Modified: Tue, 24 Jan 2023 21:46:55 GMT  
		Size: 15.2 MB (15190928 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
