...
- Created: `2021-08-31T04:06:03.246884111Z`
...
- `libframework2-zend-server=2.4.7+b285`
...
'http://archive.ubuntu.com/ubuntu/pool/main/libm/libmemcached/libmemcached_1.0.18-4.1ubuntu2.dsc' libmemcached_1.0.18-4.1ubuntu2.dsc 2058 SHA512:745cfcc5248db655bbfdcbb78c3170bd875b0ec31a1d35a5dcd8d9c2888bff362823b518101bb7a1c810d3911b468ffb3715ec6b6a39d61b154984aa74005889
...
'http://archive.ubuntu.com/ubuntu/pool/main/libm/libmemcached/libmemcached_1.0.18-4.1ubuntu2.debian.tar.xz' libmemcached_1.0.18-4.1ubuntu2.debian.tar.xz 12468 SHA512:0e3e3c08b2d3f45d4d73415f85b1081a39897c9b332de71c557feb07025ea8b4cb7ed7fa772b54f2b2e90704fd2355c25772cd6ac106e2a2f478af75f5c9d1f7
```
...
- `libapache2-mod-php-7.1-zend-server=7.1.33.6+b27`
...
- `lighttpd-zend-server=1.4.41+b10`
...
'http://archive.ubuntu.com/ubuntu/pool/universe/l/lighttpd/lighttpd_1.4.35-4ubuntu2.1.dsc' lighttpd_1.4.35-4ubuntu2.1.dsc 3006 SHA512:e93c3919c3f2a66d584426c200fc03ee4f06bbbac2196348c26d0fe29a6f956704709016106560ad2c85e5887e096146a0a856cbaa89a38718db5a2ae6827272
'http://archive.ubuntu.com/ubuntu/pool/universe/l/lighttpd/lighttpd_1.4.35.orig.tar.gz' lighttpd_1.4.35.orig.tar.gz 847321 SHA512:fe39c3b504f84a5f95557c9bb5df0f19b04a0d8b9de7d16e2ff8aeb7eb8abdb9082226de72643f09e5a417412d91386fd7a24ed550553235e44edb23683b0a40
'http://archive.ubuntu.com/ubuntu/pool/universe/l/lighttpd/lighttpd_1.4.35-4ubuntu2.1.debian.tar.xz' lighttpd_1.4.35-4ubuntu2.1.debian.tar.xz 33176 SHA512:d23ad99fdb73c28212969470462b3cededaad4b7634416135f6bb59360c095679b0ee6c5a41bd3638c08c66f96703c89015d1e0d3a6ba7b7857560b599985de4
```
...
- `php-7.1-pdo-mysql-zend-server=7.1.33.6+b26`
...
- `php-7.1-bcmath-zend-server=7.1.33.6+b26`
...
- `php-7.1-bin-zend-server=7.1.33.6+b27`
...
- `php-7.1-bz2-zend-server=7.1.33.6+b25`
...
- `php-7.1-calendar-zend-server=7.1.33.6+b25`
...
- `php-7.1-ctype-zend-server=7.1.33.6+b25`
...
- `php-7.1-curl-zend-server=7.1.33.6+b26`
...
- `php-7.1-dev-zend-server=7.1.33.6+b26`
...
- `php-7.1-exif-zend-server=7.1.33.6+b26`
...
- `php-7.1-fcgi-zend-server=7.1.33.6+b27`
...
- `php-7.1-fileinfo-zend-server=7.1.33.6+b25`
...
- `php-7.1-ftp-zend-server=7.1.33.6+b26`
...
- `php-7.1-gd-zend-server=7.1.33.6+b25`
...
- `php-7.1-gettext-zend-server=7.1.33.6+b26`
...
- `php-7.1-gmp-zend-server=7.1.33.6+b25`
...
- `php-7.1-imagick-zend-server=7.1.33.6+b26`
...
- `php-7.1-imap-zend-server=7.1.33.6+b26`
...
- `php-7.1-intl-zend-server=7.1.33.6+b25`
...
- `php-7.1-ldap-zend-server=7.1.33.6+b26`
...
- `php-7.1-mbstring-zend-server=7.1.33.6+b25`
...
- `php-7.1-mcrypt-zend-server=7.1.33.6+b25`
...
- `php-7.1-memcached-zend-server=7.1.33.6+b27`
...
- `php-7.1-mongodb-zend-server=7.1.33.6+b27`
...
- `php-7.1-mysqli-zend-server=7.1.33.6+b26`
...
- `php-7.1-oci8-zend-server=7.1.33.6+b26`
...
- `php-7.1-odbc-zend-server=7.1.33.6+b25`
...
- `php-7.1-pcntl-zend-server=7.1.33.6+b25`
...
- `php-7.1-pdo-dblib-zend-server=7.1.33.6+b25`
...
- `php-7.1-pdo-odbc-zend-server=7.1.33.6+b25`
...
- `php-7.1-pdo-pgsql-zend-server=7.1.33.6+b26`
...
- `php-7.1-pgsql-zend-server=7.1.33.6+b25`
...
- `php-7.1-phar-zend-server=7.1.33.6+b25`
...
- `php-7.1-posix-zend-server=7.1.33.6+b25`
...
- `php-7.1-redis-zend-server=7.1.33.6+b26`
...
- `php-7.1-shmop-zend-server=7.1.33.6+b25`
...
- `php-7.1-soap-zend-server=7.1.33.6+b26`
...
- `php-7.1-sockets-zend-server=7.1.33.6+b25`
...
- `php-7.1-ssh2-zend-server=7.1.33.6+b27`
...
- `php-7.1-sysvmsg-zend-server=7.1.33.6+b25`
...
- `php-7.1-sysvsem-zend-server=7.1.33.6+b25`
...
- `php-7.1-sysvshm-zend-server=7.1.33.6+b25`
...
- `php-7.1-tidy-zend-server=7.1.33.6+b26`
...
- `php-7.1-tokenizer-zend-server=7.1.33.6+b26`
...
- `php-7.1-wddx-zend-server=7.1.33.6+b25`
...
- `php-7.1-xdebug-zend-server=7.1.33.6+b29`
...
- `php-7.1-xmlrpc-zend-server=7.1.33.6+b25`
...
- `php-7.1-xsl-zend-server=7.1.33.6+b26`
...
- `php-7.1-zip-zend-server=7.1.33.6+b25`
...
### `dpkg` source package: `zend-server-php-7.1=9.1.0`

Binary Packages:

- `php-7.1-common-extensions-zend-server=9.1.0+b4`
- `php-7.1-extra-extensions-zend-server=9.1.0+b4`
- `php-7.1-unix-extensions-zend-server=9.1.0+b4`
- `zend-server-php-7.1=9.1.12+b211`
- `zend-server-php-7.1-common=9.1.12+b211`
