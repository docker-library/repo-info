...
### `mariadb:13.0.2-resolute` - linux; amd64
...
### `mariadb:13.0.2-resolute` - unknown; unknown
...
### `mariadb:13.0.2-resolute` - linux; arm64 variant v8
...
### `mariadb:13.0.2-resolute` - linux; ppc64le
