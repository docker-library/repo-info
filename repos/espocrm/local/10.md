...
- Created: `2026-09-15T22:32:10.574794211Z`
- Virtual Size: ~ 751.37 Mb  
...
### `dpkg` source package: `libpgm=5.3.128~dfsg-2.1`

Binary Packages:

- `libpgm-5.3-0t64:amd64=5.3.128~dfsg-2.1+b1`
...
```console
$ apt-get source -qq --print-uris libpgm=5.3.128~dfsg-2.1
'http://deb.debian.org/debian/pool/main/libp/libpgm/libpgm_5.3.128%7edfsg-2.1.dsc' libpgm_5.3.128~dfsg-2.1.dsc 1864 SHA256:987c5517dfbed29477eb3009987d3bb80adea7f704ba24ccd7d2a370e5eb6988
'http://deb.debian.org/debian/pool/main/libp/libpgm/libpgm_5.3.128%7edfsg.orig.tar.xz' libpgm_5.3.128~dfsg.orig.tar.xz 393292 SHA256:f81831dcb05fa57ba6346541372cc04e67e8bbe4ce5d7d9438c9767d31f358f2
'http://deb.debian.org/debian/pool/main/libp/libpgm/libpgm_5.3.128%7edfsg-2.1.debian.tar.xz' libpgm_5.3.128~dfsg-2.1.debian.tar.xz 6392 SHA256:ebad936f2156a31e5180f10fb0bd1b3ee77ac2053464c41c5a017d6f3b3fa73d
```

Other potentially useful URLs:

- https://sources.debian.net/src/libpgm/5.3.128~dfsg-2.1/ (for browsing the source)
- https://sources.debian.net/src/libpgm/5.3.128~dfsg-2.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libpgm/5.3.128~dfsg-2.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `norm=1.5.9+dfsg-3.1`

Binary Packages:

- `libnorm1t64:amd64=1.5.9+dfsg-3.1+b2`
...
```console
$ apt-get source -qq --print-uris norm=1.5.9+dfsg-3.1
'http://deb.debian.org/debian/pool/main/n/norm/norm_1.5.9%2bdfsg-3.1.dsc' norm_1.5.9+dfsg-3.1.dsc 2039 SHA256:10d7fa70b0ee75e9760807744aa5dabac63083665171a77a7dbc6c1360cd17b7
'http://deb.debian.org/debian/pool/main/n/norm/norm_1.5.9%2bdfsg.orig.tar.xz' norm_1.5.9+dfsg.orig.tar.xz 1526456 SHA256:603218491eaafddab44e6a5a5d6f57ff16558df9923fde0c2b21e6e17397394c
'http://deb.debian.org/debian/pool/main/n/norm/norm_1.5.9%2bdfsg-3.1.debian.tar.xz' norm_1.5.9+dfsg-3.1.debian.tar.xz 9276 SHA256:de1c2416aca07903d0c1de06c5a63f437b0a6de4c306a53354fea8e0207ec22f
```

Other potentially useful URLs:

- https://sources.debian.net/src/norm/1.5.9+dfsg-3.1/ (for browsing the source)
- https://sources.debian.net/src/norm/1.5.9+dfsg-3.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/norm/1.5.9+dfsg-3.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `zeromq3=4.3.5-1`

Binary Packages:

- `libzmq5:amd64=4.3.5-1+b3`
...
```console
$ apt-get source -qq --print-uris zeromq3=4.3.5-1
'http://deb.debian.org/debian/pool/main/z/zeromq3/zeromq3_4.3.5-1.dsc' zeromq3_4.3.5-1.dsc 1870 SHA256:0e699fe5f733857c1952a341bc23fa06a12bb773a8424712ca1a479c26a4dfc3
'http://deb.debian.org/debian/pool/main/z/zeromq3/zeromq3_4.3.5.orig.tar.gz' zeromq3_4.3.5.orig.tar.gz 875547 SHA256:6c972d1e6a91a0ecd79c3236f04cf0126f2f4dfbbad407d72b4606a7ba93f9c6
'http://deb.debian.org/debian/pool/main/z/zeromq3/zeromq3_4.3.5-1.debian.tar.xz' zeromq3_4.3.5-1.debian.tar.xz 10900 SHA256:965daee5f62496332a64aa46b6b970565da88ad1be0f73d694051427a3366a6a
```

Other potentially useful URLs:

- https://sources.debian.net/src/zeromq3/4.3.5-1/ (for browsing the source)
- https://sources.debian.net/src/zeromq3/4.3.5-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/zeromq3/4.3.5-1/ (for access to the source package after it no longer exists in the archive)
