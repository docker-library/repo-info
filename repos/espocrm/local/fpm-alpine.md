...
- Created: `2026-08-22T00:02:17.936333625Z`
- Virtual Size: ~ 302.13 Mb  
...
```console
libzmq-4.3.5-r2 description:
The ZeroMQ messaging library and tools (libraries)

libzmq-4.3.5-r2 webpage:
https://zeromq.org/

libzmq-4.3.5-r2 installed size:
713 KiB

libzmq-4.3.5-r2 license:
MPL-2.0
