...
### `espocrm:10.0.7-apache-trixie` - linux; amd64
...
### `espocrm:10.0.7-apache-trixie` - unknown; unknown
...
### `espocrm:10.0.7-apache-trixie` - linux; arm variant v5
...
### `espocrm:10.0.7-apache-trixie` - linux; arm variant v7
...
### `espocrm:10.0.7-apache-trixie` - linux; arm64 variant v8
...
### `espocrm:10.0.7-apache-trixie` - linux; 386
