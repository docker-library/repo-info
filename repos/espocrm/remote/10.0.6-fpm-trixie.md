...
### `espocrm:10.0.6-fpm-trixie` - linux; amd64
...
### `espocrm:10.0.6-fpm-trixie` - unknown; unknown
...
### `espocrm:10.0.6-fpm-trixie` - linux; arm variant v5
...
### `espocrm:10.0.6-fpm-trixie` - linux; arm variant v7
...
### `espocrm:10.0.6-fpm-trixie` - linux; arm64 variant v8
...
### `espocrm:10.0.6-fpm-trixie` - linux; 386
