...
### `espocrm:10.0.6-apache` - linux; amd64
...
### `espocrm:10.0.6-apache` - unknown; unknown
...
### `espocrm:10.0.6-apache` - linux; arm variant v5
...
### `espocrm:10.0.6-apache` - linux; arm variant v7
...
### `espocrm:10.0.6-apache` - linux; arm64 variant v8
...
### `espocrm:10.0.6-apache` - linux; 386
