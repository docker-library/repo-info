...
### `espocrm:10.0.6-fpm-alpine` - linux; amd64
...
### `espocrm:10.0.6-fpm-alpine` - unknown; unknown
...
### `espocrm:10.0.6-fpm-alpine` - linux; arm variant v6
...
### `espocrm:10.0.6-fpm-alpine` - linux; arm variant v7
...
### `espocrm:10.0.6-fpm-alpine` - linux; arm64 variant v8
...
### `espocrm:10.0.6-fpm-alpine` - linux; 386
