...
```console
$ docker pull golang@sha256:5978cc992ad5ef96a7469713c8af849c1433824761ce3be2c56381403cd8d9a3
```
...
### `golang:1.26.6-alpine3.23` - linux; amd64
...
### `golang:1.26.6-alpine3.23` - unknown; unknown
...
### `golang:1.26.6-alpine3.23` - linux; arm variant v6
...
### `golang:1.26.6-alpine3.23` - linux; arm variant v7
...
### `golang:1.26.6-alpine3.23` - linux; arm64 variant v8
...
### `golang:1.26.6-alpine3.23` - linux; 386
...
### `golang:1.26.6-alpine3.23` - linux; ppc64le
...
### `golang:1.26.6-alpine3.23` - linux; s390x
