...
```console
$ docker pull golang@sha256:5e9acfbe29a783d9e2295bc88d30b7c3556e31c8bd21de10a887c4572f58dbd9
```
...
### `golang:1.26.5-alpine3.23` - unknown; unknown
...
### `golang:1.26.5-alpine3.23` - linux; arm variant v6
...
### `golang:1.26.5-alpine3.23` - linux; arm variant v7
...
### `golang:1.26.5-alpine3.23` - linux; arm64 variant v8
...
### `golang:1.26.5-alpine3.23` - linux; 386
...
### `golang:1.26.5-alpine3.23` - linux; ppc64le
...
### `golang:1.26.5-alpine3.23` - linux; s390x
