...
```console
$ docker pull golang@sha256:48c7ac3ef6613d1e00b4858eb41eacf51ae4db7286e2ab1417e952d7004ca215
```
...
### `golang:tip-20260815-trixie` - linux; amd64
...
### `golang:tip-20260815-trixie` - unknown; unknown
...
### `golang:tip-20260815-trixie` - linux; arm variant v7
...
### `golang:tip-20260815-trixie` - linux; arm64 variant v8
...
### `golang:tip-20260815-trixie` - linux; 386
...
### `golang:tip-20260815-trixie` - linux; ppc64le

```console
$ docker pull golang@sha256:10048721494d582d92370c170cb4daae347da614ebd5f06d06075b28f345b901
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.1 MB (345138564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5604d15c3d6ed06bc4bcae80d0e9862f5319b490fd96f59c19434f48e9f417d2`
-	Default Command: `["bash"]`
...
-	Layers:
	...
	-	`sha256:6f2c0bde20aa559307571359bc3123d355d3707d58d3dcf348b04f5e47d6fad5`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:851af5910e24a7f42f9c4c14db2db20d553be96561f0aaa4b58f5d1189372ea5`  
		Last Modified: Wed, 19 Aug 2026 23:55:16 GMT  
		Size: 126.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
...
```console
$ docker pull golang@sha256:d600040aba0aaf5d950cb74144733db3b8f6dc9e22d32e36c8fb89f710ea8490
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **10.8 MB (10810619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d123ead8973a61478c7a0c639cd6ee32f97cd875ee3097d68ff975406c465c89`

```dockerfile
```

-	Layers:
	-	`sha256:d4abba0075770e1c72cf6756c7c7c5e0bcde1514fc2b1c5e3ae288f7d284b02d`  
		Last Modified: Wed, 19 Aug 2026 23:55:16 GMT  
		Size: 10.8 MB (10781885 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b97ea8d3b4ddfb48da8c19500e90813e091778a64a53541b1acd1ad007bb099a`  
		Last Modified: Wed, 19 Aug 2026 23:55:16 GMT  
		Size: 28.7 KB (28734 bytes)  
		MIME: application/vnd.in-toto+json

### `golang:tip-20260815-trixie` - linux; riscv64

```console
$ docker pull golang@sha256:6b40610d570b62d6dc3c4e6aeb7916eec573bcb93927c72b86e985c37988afc1
```
...
```console
$ docker pull golang@sha256:9ae3afa097fe3c09042637b527cfbf535a620498e83ce1d92a7186d9238bc438
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **10.9 MB (10884457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a47ac2e296b4288306830409499b3a54f22988e0056c5bf067ad4282de4f634`

```dockerfile
```

-	Layers:
	-	`sha256:d622fa2308379e941dd3dc43eaf7cc01440ba09f077c005adcb9a0ed586a1f5b`  
		Last Modified: Thu, 20 Aug 2026 02:22:57 GMT  
		Size: 10.9 MB (10855718 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:71e61d6ad8be5e09b122e78290129f94df008e9bd1f12f895d83b68a024aab3c`  
		Last Modified: Thu, 20 Aug 2026 02:22:55 GMT  
		Size: 28.7 KB (28739 bytes)  
		MIME: application/vnd.in-toto+json

### `golang:tip-20260815-trixie` - linux; s390x
