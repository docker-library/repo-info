...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/b/binutils-2.30-123.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/c/cracklib-2.9.6-15.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/c/cryptsetup-2.3.7-7.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/d/dbus-1.12.8-26.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/g/gdbm-1.18-2.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/g/gzip-1.9-13.el8_5.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/h/hostname-3.20-6.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/i/ima-evm-utils-1.3.2-12.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/i/iputils-20180629-11.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libcomps-0.1.18-1.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libnsl2-1.2.0-2.20180605git4a062cf.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libpwquality-1.4.4-6.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libreport-2.9.5-15.el8.rocky.6.3.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libseccomp-2.5.2-1.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libsemanage-2.9-9.el8_6.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/l/libutempter-1.1.6-14.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/p/python-setuptools-39.2.0-7.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/r/rootfiles-8.1-22.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/t/tar-1.30-9.el8.src.rpm
```
...
http://distro.ibiblio.org/rocky/8.10/BaseOS/source/tree/Packages/v/vim-8.0.1763-19.el8_6.4.src.rpm
```
