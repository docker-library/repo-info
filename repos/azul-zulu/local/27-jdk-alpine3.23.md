...
- Created: `2026-09-17T21:39:25.595949587Z`
...
### `apk` package: `zulu27-ca-jdk`

```console
zulu27-ca-jdk-27-r1 description:
Azul Zulu 27.28+101 (27-b35) CA JDK

zulu27-ca-jdk-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-ca-jdk-27-r1 installed size:
68 KiB

zulu27-ca-jdk-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-ca-jdk-headless`

```console
zulu27-ca-jdk-headless-27-r1 description:
Azul Zulu 27.28+101 (27-b35) CA Headless JDK

zulu27-ca-jdk-headless-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-ca-jdk-headless-27-r1 installed size:
100 MiB

zulu27-ca-jdk-headless-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-ca-jre`

```console
zulu27-ca-jre-27-r1 description:
Azul Zulu 27.28+101 (27-b35) CA JRE

zulu27-ca-jre-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-ca-jre-27-r1 installed size:
2580 KiB

zulu27-ca-jre-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-ca-jre-headless`

```console
zulu27-ca-jre-headless-27-r1 description:
Azul Zulu 27.28+101 (27-b35) CA Headless JRE

zulu27-ca-jre-headless-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-ca-jre-headless-27-r1 installed size:
236 MiB

zulu27-ca-jre-headless-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-jdk`

```console
zulu27-jdk-27-r1 description:
Azul Zulu 27.28+101 (27-b35) JDK

zulu27-jdk-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-jdk-27-r1 installed size:
4096 B

zulu27-jdk-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-jdk-headless`

```console
zulu27-jdk-headless-27-r1 description:
Azul Zulu 27.28+101 (27-b35) Headless JDK

zulu27-jdk-headless-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-jdk-headless-27-r1 installed size:
4096 B

zulu27-jdk-headless-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-jre`

```console
zulu27-jre-27-r1 description:
Azul Zulu 27.28+101 (27-b35) JRE

zulu27-jre-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-jre-27-r1 installed size:
4096 B

zulu27-jre-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0

```

### `apk` package: `zulu27-jre-headless`

```console
zulu27-jre-headless-27-r1 description:
Azul Zulu 27.28+101 (27-b35) Headless JRE

zulu27-jre-headless-27-r1 webpage:
https://www.azul.com/products/core/

zulu27-jre-headless-27-r1 installed size:
4096 B

zulu27-jre-headless-27-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0
