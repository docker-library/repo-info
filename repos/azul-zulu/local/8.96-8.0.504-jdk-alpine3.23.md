...
- Created: `2026-09-17T21:37:56.725291853Z`
- Virtual Size: ~ 163.01 Mb  
...
```console
zulu8-ca-jdk-8.0.504-r1 description:
Azul Zulu 8.96.0.205 (8u504-b01) CA JDK

zulu8-ca-jdk-8.0.504-r1 webpage:
https://www.azul.com/products/core/

zulu8-ca-jdk-8.0.504-r1 installed size:
496 KiB

zulu8-ca-jdk-8.0.504-r1 license:
...
```console
zulu8-ca-jre-8.0.504-r1 description:
Azul Zulu 8.96.0.205 (8u504-b01) CA JRE

zulu8-ca-jre-8.0.504-r1 webpage:
https://www.azul.com/products/core/

zulu8-ca-jre-8.0.504-r1 installed size:
1596 KiB

zulu8-ca-jre-8.0.504-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0
...
```console
zulu8-jdk-8.0.504-r1 description:
Azul Zulu 8.96.0.205 (8u504-b01) JDK

zulu8-jdk-8.0.504-r1 webpage:
https://www.azul.com/products/core/

zulu8-jdk-8.0.504-r1 installed size:
4096 B

zulu8-jdk-8.0.504-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0
...
```console
zulu8-jre-8.0.504-r1 description:
Azul Zulu 8.96.0.205 (8u504-b01) JRE

zulu8-jre-8.0.504-r1 webpage:
https://www.azul.com/products/core/

zulu8-jre-8.0.504-r1 installed size:
4096 B

zulu8-jre-8.0.504-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0
