# `azul-zulu:25.36-25.0.4.1-jre-debian13`

## Docker Metadata

- Image ID: `sha256:2e813141f470b69e5e26ff6533bb1be78d01d0f5d887888100a9d30a713a1ae0`
- Created: `2026-09-19T00:43:43.798751322Z`
- Virtual Size: ~ 345.67 Mb  
...
### `dpkg` source package: `alsa-lib=1.2.14-1+deb13u1`

Binary Packages:

- `libasound2-data=1.2.14-1+deb13u1`
- `libasound2t64:amd64=1.2.14-1+deb13u1`
...
```console
$ apt-get source -qq --print-uris alsa-lib=1.2.14-1+deb13u1
'http://deb.debian.org/debian/pool/main/a/alsa-lib/alsa-lib_1.2.14-1%2bdeb13u1.dsc' alsa-lib_1.2.14-1+deb13u1.dsc 2951 SHA256:45f15d45b0329394de2e59c85052d0ac084e4e0ac215346ac5299a09432f515e
...
'http://deb.debian.org/debian/pool/main/a/alsa-lib/alsa-lib_1.2.14-1%2bdeb13u1.debian.tar.xz' alsa-lib_1.2.14-1+deb13u1.debian.tar.xz 34100 SHA256:8c04f2d76c4566f21d044ea52eed39d97bdbf5a5a9cb21582662dd76f2dad38e
```

Other potentially useful URLs:

- https://sources.debian.net/src/alsa-lib/1.2.14-1+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/alsa-lib/1.2.14-1+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/alsa-lib/1.2.14-1+deb13u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `zulu25-ca=25.0.4.1-1`

Binary Packages:

- `zulu25-ca-jre=25.0.4.1-1`
- `zulu25-ca-jre-headless=25.0.4.1-1`

Licenses: (parsed from: `/usr/share/doc/zulu25-ca-jre/copyright`, `/usr/share/doc/zulu25-ca-jre-headless/copyright`)
...
### `dpkg` source package: `zulu25=25.0.4.1-1`

Binary Packages:

- `zulu25-jre=25.0.4.1-1`
- `zulu25-jre-headless=25.0.4.1-1`

Licenses: (parsed from: `/usr/share/doc/zulu25-jre/copyright`, `/usr/share/doc/zulu25-jre-headless/copyright`)
