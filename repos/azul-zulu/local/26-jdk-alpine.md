...
- Created: `2026-08-19T17:37:15.651246405Z`
...
```console
zulu26-ca-jdk-26.0.2.1-r1 description:
Azul Zulu 26.32+203 (26.0.2.1-b1) CA JDK

zulu26-ca-jdk-26.0.2.1-r1 webpage:
https://www.azul.com/products/core/

zulu26-ca-jdk-26.0.2.1-r1 installed size:
68 KiB

zulu26-ca-jdk-26.0.2.1-r1 license:
...
```console
zulu26-jdk-26.0.2.1-r1 description:
Azul Zulu 26.32+203 (26.0.2.1-b1) JDK

zulu26-jdk-26.0.2.1-r1 webpage:
https://www.azul.com/products/core/

zulu26-jdk-26.0.2.1-r1 installed size:
4096 B

zulu26-jdk-26.0.2.1-r1 license:
GPL-2.0-only WITH Classpath-exception-2.0
