...
- Created: `2026-09-17T21:15:44.761325023Z`
- Virtual Size: ~ 13.48 Mb  
...
### `apk` package: `libwebsockets`

```console
libwebsockets-4.3.5-r2 description:
C library for lightweight websocket clients and servers

libwebsockets-4.3.5-r2 webpage:
https://libwebsockets.org/

libwebsockets-4.3.5-r2 installed size:
330 KiB

libwebsockets-4.3.5-r2 license:
MIT
