...
- Created: `2026-07-16T00:20:45.585972994Z`
...
### `rpm` package: `glibc-2.34-272.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-272.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-272.el9_8.src.rpm
```

### `rpm` package: `glibc-common-2.34-272.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-272.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-272.el9_8.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-272.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-272.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-272.el9_8.src.rpm
```
...
### `rpm` package: `libatomic-11.5.0-14.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libatomic-11.5.0-14.el9
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libssh-0.10.4-18.el9.src.rpm
```
...
### `rpm` package: `openssl-devel-3.5.5-5.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-3.5.5-5.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssl-3.5.5-5.el9_8.src.rpm
```
