...
- Created: `2022-08-03T04:40:55.735293081Z`
- Virtual Size: ~ 468.87 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/docker-entrypoint.sh"]`
- Environment:
  - `PATH=/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/apache-storm-1.2.4/bin`
...
- http://snapshot.debian.org/package/expat/2.2.10-2+deb11u3/
...
- http://snapshot.debian.org/package/libksba/1.5.0-3/
