...
### `gcc:16.2-trixie` - unknown; unknown
...
### `gcc:16.2-trixie` - linux; arm variant v5
...
### `gcc:16.2-trixie` - linux; arm variant v7
...
### `gcc:16.2-trixie` - linux; arm64 variant v8
