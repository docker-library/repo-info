...
### `drupal:11.4.6-apache-bookworm` - linux; amd64
...
### `drupal:11.4.6-apache-bookworm` - unknown; unknown
...
### `drupal:11.4.6-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.4.6-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.4.6-apache-bookworm` - linux; 386
...
### `drupal:11.4.6-apache-bookworm` - linux; ppc64le
