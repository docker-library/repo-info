...
### `drupal:12.0.0-alpha1-apache` - linux; amd64
...
### `drupal:12.0.0-alpha1-apache` - unknown; unknown
...
### `drupal:12.0.0-alpha1-apache` - linux; arm variant v7
...
### `drupal:12.0.0-alpha1-apache` - linux; arm64 variant v8
...
### `drupal:12.0.0-alpha1-apache` - linux; 386
...
### `drupal:12.0.0-alpha1-apache` - linux; ppc64le
...
### `drupal:12.0.0-alpha1-apache` - linux; riscv64
...
### `drupal:12.0.0-alpha1-apache` - linux; s390x
