...
### `drupal:11.3.16-fpm-alpine3.24` - linux; amd64
...
### `drupal:11.3.16-fpm-alpine3.24` - unknown; unknown
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; 386
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; riscv64
...
### `drupal:11.3.16-fpm-alpine3.24` - linux; s390x
