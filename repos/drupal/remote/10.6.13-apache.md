...
```console
$ docker pull drupal@sha256:25b8af54ffcf851d94bb061309c6bf38169733480a39a8324b3328f484ed97fd
```
...
### `drupal:10.6.13-apache` - linux; amd64
...
### `drupal:10.6.13-apache` - unknown; unknown
...
### `drupal:10.6.13-apache` - linux; arm variant v7
...
### `drupal:10.6.13-apache` - linux; arm64 variant v8
...
### `drupal:10.6.13-apache` - linux; 386
...
### `drupal:10.6.13-apache` - linux; ppc64le
...
### `drupal:10.6.13-apache` - linux; s390x
