...
```console
$ docker pull drupal@sha256:f012efce90e98ccd2607cc96b86a911a72935cddf72c0f6193c3f4af3ebeadf5
```
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.4.1-php8.4-fpm-alpine3.23` - linux; s390x
