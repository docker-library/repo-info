...
```console
$ docker pull drupal@sha256:e610eb4df25432c8d87bc3e4781b612588c5f5b0d49cd1067a6090ec2c73d44d
```
...
### `drupal:11.2.14-php8.4-fpm` - linux; amd64
...
### `drupal:11.2.14-php8.4-fpm` - unknown; unknown
...
### `drupal:11.2.14-php8.4-fpm` - linux; arm variant v7
...
### `drupal:11.2.14-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:11.2.14-php8.4-fpm` - linux; 386
...
### `drupal:11.2.14-php8.4-fpm` - linux; ppc64le
...
### `drupal:11.2.14-php8.4-fpm` - linux; riscv64

```console
$ docker pull drupal@sha256:144732e09b5eade0d49c6427ca30965984006063551915f9d512d65fc2bb830f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.6 MB (230631029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41b06b625f4eadefc3fb2737891919308dc1f97eea5c011f646ce50a3a17ea29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:77f17934895121bb3ed463523214b4098d948987a77e7b31911b7672d48427df`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:21d84da486b16db0b41b09bb511ef7193018210f893f599834868e473a5705bc`  
		Last Modified: Sat, 27 Jun 2026 18:12:58 GMT  
		Size: 20.7 MB (20738902 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.2.14-php8.4-fpm` - unknown; unknown

```console
$ docker pull drupal@sha256:b0ff83db4beae846cff1faf4e90fd6fb914ce1e84ebce57814aaf98f7403af19
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.0 MB (7041554 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cd62f1b2ea086deb5c6a5a1d83e99a1413425e67c533b18b13ac78972d23ab3`

```dockerfile
```

-	Layers:
	-	`sha256:7d17b01dbe720ae16b42e305412d875f0e2d47a636ab9ba6fa001060d2d4f56c`  
		Last Modified: Sat, 27 Jun 2026 18:12:55 GMT  
		Size: 7.0 MB (7005624 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a92fcedc12111a020b0901da1aa91e2687c16856970668cdb098d0f1d0203e30`  
		Last Modified: Sat, 27 Jun 2026 18:12:54 GMT  
		Size: 35.9 KB (35930 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2.14-php8.4-fpm` - linux; s390x
