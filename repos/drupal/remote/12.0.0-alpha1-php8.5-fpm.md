...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; amd64
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - unknown; unknown
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; arm variant v7
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; arm64 variant v8
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; 386
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; ppc64le
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; riscv64
...
### `drupal:12.0.0-alpha1-php8.5-fpm` - linux; s390x
