...
```console
$ docker pull drupal@sha256:79d62da8316a6c17dc0573ff9fe821af5abe8bc0fbc9b4582416d0b06d9c73ca
```
...
### `drupal:11.4.1-apache` - linux; amd64
...
### `drupal:11.4.1-apache` - unknown; unknown
...
### `drupal:11.4.1-apache` - linux; arm variant v7
...
### `drupal:11.4.1-apache` - linux; arm64 variant v8
...
### `drupal:11.4.1-apache` - linux; 386
...
### `drupal:11.4.1-apache` - linux; ppc64le
...
### `drupal:11.4.1-apache` - linux; s390x
