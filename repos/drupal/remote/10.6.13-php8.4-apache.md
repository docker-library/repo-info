...
### `drupal:10.6.13-php8.4-apache` - linux; amd64
...
### `drupal:10.6.13-php8.4-apache` - unknown; unknown
...
### `drupal:10.6.13-php8.4-apache` - linux; arm variant v7
...
### `drupal:10.6.13-php8.4-apache` - linux; arm64 variant v8
...
### `drupal:10.6.13-php8.4-apache` - linux; 386
...
### `drupal:10.6.13-php8.4-apache` - linux; ppc64le
...
### `drupal:10.6.13-php8.4-apache` - linux; riscv64
...
### `drupal:10.6.13-php8.4-apache` - linux; s390x
