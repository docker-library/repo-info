...
```console
$ docker pull drupal@sha256:d09777d3378abb36edb1c44ce4ec6f20322471821499d26adafc1452ffc0ed6f
```
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; amd64
...
### `drupal:11.4.7-php8.5-fpm-alpine` - unknown; unknown
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; 386
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.4.7-php8.5-fpm-alpine` - linux; s390x
