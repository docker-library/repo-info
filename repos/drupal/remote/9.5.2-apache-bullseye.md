...
```console
$ docker pull drupal@sha256:32a8a885d0683b815630b0a4b95f623f42285ab672b0af8e3bfdf6587319a1cf
```
...
### `drupal:9.5.2-apache-bullseye` - linux; amd64
...
### `drupal:9.5.2-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.5.2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.5.2-apache-bullseye` - linux; 386
...
### `drupal:9.5.2-apache-bullseye` - linux; ppc64le
...
### `drupal:9.5.2-apache-bullseye` - linux; s390x
