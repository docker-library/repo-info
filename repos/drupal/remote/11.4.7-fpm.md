...
### `drupal:11.4.7-fpm` - unknown; unknown
...
### `drupal:11.4.7-fpm` - linux; arm variant v7
...
### `drupal:11.4.7-fpm` - linux; arm64 variant v8
...
### `drupal:11.4.7-fpm` - linux; ppc64le
