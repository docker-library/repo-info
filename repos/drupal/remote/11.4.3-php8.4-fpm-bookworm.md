...
```console
$ docker pull drupal@sha256:1fc111c03c8a14cef374e5dfb8d65994bdfb46d0ed26c0ece3893cc1d7d5291e
```
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - linux; amd64
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - unknown; unknown
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - linux; 386
...
### `drupal:11.4.3-php8.4-fpm-bookworm` - linux; s390x
