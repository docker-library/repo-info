...
```console
$ docker pull drupal@sha256:ff24415600aff5ce739e45b5504fcdd44be844d466842ffd181da1c11c9a9f75
```
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; amd64
...
### `drupal:11.4.7-php8.5-fpm-trixie` - unknown; unknown
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; 386
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; ppc64le
...
### `drupal:11.4.7-php8.5-fpm-trixie` - linux; s390x
