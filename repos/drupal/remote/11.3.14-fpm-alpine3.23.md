...
```console
$ docker pull drupal@sha256:a3517b54e6d75f36361a73346ddb4530e7181b551568d37b13304a776d223f61
```
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.14-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.14-fpm-alpine3.23` - linux; s390x
