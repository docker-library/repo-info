...
```console
$ docker pull drupal@sha256:c63b476b95d669c96fb0a2f75261aa941009600fdc8fa40909ac4d852fe53748
```
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; amd64
...
### `drupal:10.6.17-fpm-alpine3.24` - unknown; unknown
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; 386
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:10.6.17-fpm-alpine3.24` - linux; s390x
