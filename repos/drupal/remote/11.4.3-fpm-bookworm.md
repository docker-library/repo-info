...
```console
$ docker pull drupal@sha256:e7f77ada2bc04ebcc2d5ba6fec9c394672ece2f30db6bdb64e6cde3c1532f00f
```
...
### `drupal:11.4.3-fpm-bookworm` - linux; amd64
...
### `drupal:11.4.3-fpm-bookworm` - unknown; unknown
...
### `drupal:11.4.3-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.4.3-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.4.3-fpm-bookworm` - linux; 386
...
### `drupal:11.4.3-fpm-bookworm` - linux; s390x
