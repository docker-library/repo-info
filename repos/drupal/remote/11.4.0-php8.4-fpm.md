...
```console
$ docker pull drupal@sha256:02557c6d0a7c3a87cd8c6155bb6dc17b2d5834cdc69701988a5bcc8515db8d11
```
...
### `drupal:11.4.0-php8.4-fpm` - linux; amd64
...
### `drupal:11.4.0-php8.4-fpm` - unknown; unknown
...
### `drupal:11.4.0-php8.4-fpm` - linux; arm variant v7
...
### `drupal:11.4.0-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:11.4.0-php8.4-fpm` - linux; 386
...
### `drupal:11.4.0-php8.4-fpm` - linux; ppc64le
...
### `drupal:11.4.0-php8.4-fpm` - linux; s390x
