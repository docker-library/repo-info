...
```console
$ docker pull drupal@sha256:6fec4d919cdb1f09f418f0fa04e560e4e22ea66cd49205b234e4198f246a278f
```
...
### `drupal:10.6.17-fpm-trixie` - linux; amd64
...
### `drupal:10.6.17-fpm-trixie` - unknown; unknown
...
### `drupal:10.6.17-fpm-trixie` - linux; arm variant v7
...
### `drupal:10.6.17-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.17-fpm-trixie` - linux; 386
...
### `drupal:10.6.17-fpm-trixie` - linux; ppc64le
...
### `drupal:10.6.17-fpm-trixie` - linux; s390x
