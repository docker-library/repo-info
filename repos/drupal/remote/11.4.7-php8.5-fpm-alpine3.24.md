...
```console
$ docker pull drupal@sha256:53afbf2f4edb78e866a8e4a8534faab4f30830d22da0e655c91cac19261c124a
```
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; amd64
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - unknown; unknown
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; 386
...
### `drupal:11.4.7-php8.5-fpm-alpine3.24` - linux; ppc64le
