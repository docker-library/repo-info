...
### `drupal:11.4.7-php8.5-fpm` - linux; amd64
...
### `drupal:11.4.7-php8.5-fpm` - unknown; unknown
...
### `drupal:11.4.7-php8.5-fpm` - linux; arm variant v7
...
### `drupal:11.4.7-php8.5-fpm` - linux; arm64 variant v8
...
### `drupal:11.4.7-php8.5-fpm` - linux; 386
...
### `drupal:11.4.7-php8.5-fpm` - linux; ppc64le
...
### `drupal:11.4.7-php8.5-fpm` - linux; s390x
