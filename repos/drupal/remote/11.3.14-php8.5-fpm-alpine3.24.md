...
```console
$ docker pull drupal@sha256:08bfb42d27e546e5201e5182e07b9356eca920b84319035dfd37d856193fdf87
```
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; amd64
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - unknown; unknown
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; 386
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; riscv64

```console
$ docker pull drupal@sha256:4fec5c83b460baee7e4cf55c5d70d0afd440daee395236b1a35879080837b196
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **65.1 MB (65110173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a618eef2cb628efd8435ef45212155652f8e3a9c52b3e8e742eb1b87216ef00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:84a33e1a98aa1a4a43b3a200f1c8f6c83ae187d97a0868ffde8fb5868d0f161a`  
		...
		Size: 111.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:56cf1033ecc0f329617c593790a9b644dc35d309feb068b591537a9d1a656a40`  
		Last Modified: Fri, 17 Jul 2026 00:03:35 GMT  
		Size: 21.4 MB (21426547 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.3.14-php8.5-fpm-alpine3.24` - unknown; unknown

```console
$ docker pull drupal@sha256:5a8b3a6eb0ee887c042b4ef7bf30b2ef5699c8a9ee764bc5aab386309739ad9f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.6 KB (400618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ce6f6ce57f044659cc809dc3914cf47d10538536f05f41c5ad1752bb2fc21f2`

```dockerfile
```

-	Layers:
	-	`sha256:e564f840e2a00664f67831bc3f5f94c8b9b066b8ff7895105868e5f4edf4fd61`  
		Last Modified: Fri, 17 Jul 2026 00:03:31 GMT  
		Size: 368.1 KB (368128 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:dc2e67407bc67790a0b92850b8eaf8996c1640d77093407969d99a1f82b83aa1`  
		Last Modified: Fri, 17 Jul 2026 00:03:31 GMT  
		Size: 32.5 KB (32490 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.3.14-php8.5-fpm-alpine3.24` - linux; s390x
