...
```console
$ docker pull drupal@sha256:14faad486740395087535e549e998a00dd6a1739041133f8f2b8aad4f04e7195
```
...
### `drupal:11.4.1-php8.4-fpm` - linux; amd64
...
### `drupal:11.4.1-php8.4-fpm` - unknown; unknown
...
### `drupal:11.4.1-php8.4-fpm` - linux; arm variant v7
...
### `drupal:11.4.1-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:11.4.1-php8.4-fpm` - linux; 386
...
### `drupal:11.4.1-php8.4-fpm` - linux; ppc64le
...
### `drupal:11.4.1-php8.4-fpm` - linux; s390x
