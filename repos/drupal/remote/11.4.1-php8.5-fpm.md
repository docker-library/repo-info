...
```console
$ docker pull drupal@sha256:1e04d9c4e2dffe70c9a9235d945b25ebf82b5ed74b3b689557e1304b9b7305be
```
...
### `drupal:11.4.1-php8.5-fpm` - linux; amd64
...
### `drupal:11.4.1-php8.5-fpm` - unknown; unknown
...
### `drupal:11.4.1-php8.5-fpm` - linux; arm variant v7
...
### `drupal:11.4.1-php8.5-fpm` - linux; arm64 variant v8
...
### `drupal:11.4.1-php8.5-fpm` - linux; 386
...
### `drupal:11.4.1-php8.5-fpm` - linux; ppc64le
...
### `drupal:11.4.1-php8.5-fpm` - linux; s390x
