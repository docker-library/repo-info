...
```console
$ docker pull drupal@sha256:079b0a75f37b0a9a4aef8d545521a6190174435e9e81e9e1412bfb4f8f57e61e
```
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.4.0-php8.4-fpm-alpine3.23` - linux; s390x
