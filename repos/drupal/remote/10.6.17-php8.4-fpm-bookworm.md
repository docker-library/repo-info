...
### `drupal:10.6.17-php8.4-fpm-bookworm` - linux; amd64
...
### `drupal:10.6.17-php8.4-fpm-bookworm` - unknown; unknown
...
### `drupal:10.6.17-php8.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.6.17-php8.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.6.17-php8.4-fpm-bookworm` - linux; 386
...
### `drupal:10.6.17-php8.4-fpm-bookworm` - linux; ppc64le
