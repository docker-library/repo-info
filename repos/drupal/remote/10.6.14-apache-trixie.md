...
```console
$ docker pull drupal@sha256:4924164c5e0fc485a739b2b128ba5c4dc2abbc82a447b86d5b8ebf2832430066
```
...
### `drupal:10.6.14-apache-trixie` - linux; amd64
...
### `drupal:10.6.14-apache-trixie` - unknown; unknown
...
### `drupal:10.6.14-apache-trixie` - linux; arm variant v7
...
### `drupal:10.6.14-apache-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.14-apache-trixie` - linux; 386
...
### `drupal:10.6.14-apache-trixie` - linux; ppc64le
...
### `drupal:10.6.14-apache-trixie` - linux; s390x
