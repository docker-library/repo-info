...
```console
$ docker pull drupal@sha256:c50fe64317d30f0f4eac1cc96112bdcbd544b92a8621092644a9c5be2d61f975
```
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; amd64
...
### `drupal:11.4.3-php8.5-fpm-alpine` - unknown; unknown
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; 386
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.4.3-php8.5-fpm-alpine` - linux; s390x
