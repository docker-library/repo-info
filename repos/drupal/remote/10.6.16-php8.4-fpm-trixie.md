...
```console
$ docker pull drupal@sha256:f1e31cb4b50b00bffca2424ec5652d59c48720836f5e1de552fa3d3620094c54
```
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:10.6.16-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; 386
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; ppc64le

```console
$ docker pull drupal@sha256:ec58f92b81eee17fde6f6c180c07f64a4cebef78ad578d089f47b5568144fd89
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.8 MB (208840297 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c72b762eee20d6ff8d42c14a9161c0072d289b58fed9eccbcd44996bcb49ca9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:304fb57b38003d9f25ce7f045b52237d08db9591c3e5eb07fa0e8ff31902ab42`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:483001934b0e9ad7d36139fb899d7cf7745dfab32cf89b7be5dd64221041a2db`  
		Last Modified: Wed, 16 Sep 2026 05:50:21 GMT  
		Size: 22.0 MB (22043031 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.16-php8.4-fpm-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:4697b5432b7a2979d1d11ab9deaf6c75e0f30ef29ff5fa0aaff9612997d719cb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.0 MB (6962452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0593a0480a82e506b5386ea0e4c14539de69a9abf5f9dd394454aeb18a54c0aa`

```dockerfile
```

-	Layers:
	-	`sha256:462c4bf5ae1aaa058b61384070e37795db671d0cca8a5d9a07a8fe709085a7d3`  
		Last Modified: Wed, 16 Sep 2026 05:50:20 GMT  
		Size: 6.9 MB (6925250 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:9e8c0b4a85ae47e9b4ffded06f37ce5306c794a80cd952e8cb49294d0269bb10`  
		Last Modified: Wed, 16 Sep 2026 05:50:20 GMT  
		Size: 37.2 KB (37202 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.16-php8.4-fpm-trixie` - linux; riscv64
...
### `drupal:10.6.16-php8.4-fpm-trixie` - linux; s390x
