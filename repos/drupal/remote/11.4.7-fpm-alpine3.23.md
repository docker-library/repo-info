...
```console
$ docker pull drupal@sha256:641345a7782d53ce436d11ce9732599d9a6e7533afc07c09c5bbe5b6a737216e
```
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.4.7-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; 386
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.4.7-fpm-alpine3.23` - linux; s390x
