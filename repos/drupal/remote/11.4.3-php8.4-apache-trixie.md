...
```console
$ docker pull drupal@sha256:ad55488f322f63b72f95b40ced1315cee11126e14c5ba9f18381920569d41226
```
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; amd64
...
### `drupal:11.4.3-php8.4-apache-trixie` - unknown; unknown
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; arm variant v7
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; arm64 variant v8
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; 386
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; ppc64le
...
### `drupal:11.4.3-php8.4-apache-trixie` - linux; s390x
