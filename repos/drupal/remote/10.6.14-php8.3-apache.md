...
```console
$ docker pull drupal@sha256:8ef97f59a1b6ed6738f9248f88230da11c3f4509101710101b006f2a4a7fabed
```
...
### `drupal:10.6.14-php8.3-apache` - linux; amd64
...
### `drupal:10.6.14-php8.3-apache` - unknown; unknown
...
### `drupal:10.6.14-php8.3-apache` - linux; arm variant v7
...
### `drupal:10.6.14-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.6.14-php8.3-apache` - linux; 386
...
### `drupal:10.6.14-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.14-php8.3-apache` - linux; s390x
