...
```console
$ docker pull drupal@sha256:8a715130de2828f274d9f283a7a4c825e276ed57b1c7808cac8f2e3c4adf1c73
```
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - linux; amd64
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - unknown; unknown
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - linux; 386
...
### `drupal:10.6.16-php8.4-fpm-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:008b2e27d9a6fd424a5761b6514e00d2df40530454674d080aba3d85b95a6835
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.2 MB (211220952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6eb5e10751d1b99c94d17ebdbd6570fc4bb81093f7d7e18ae2a2f4a1dc36b476`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:a9563601284904d0606a5cba12c234e61e1499705d02e5ea26a06f008a47784a`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:61c8d7f0585e9eb58061cc4cc27ed1623ea9bd0b317d2793344aaa2d11c086c6`  
		Last Modified: Wed, 16 Sep 2026 05:52:07 GMT  
		Size: 22.0 MB (22043183 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.16-php8.4-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:8bb7c1ec5c99fa7949e388d67001dca766e1ede21e17e80443dc8f97daafc4b3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.6 MB (6634897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c45a591e68544c0c163f99b9b9f875e0bca42430575f8c0764b4c72a9296a857`

```dockerfile
```

-	Layers:
	-	`sha256:3b927689629627266d7885baf61d414a40a47b649066786bd004a843b7994ee0`  
		Last Modified: Wed, 16 Sep 2026 05:52:06 GMT  
		Size: 6.6 MB (6599555 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7db582d37fd9a39ad3ae8a4d441f523378bb6a52ae3befb54870af423ce69b47`  
		Last Modified: Wed, 16 Sep 2026 05:52:06 GMT  
