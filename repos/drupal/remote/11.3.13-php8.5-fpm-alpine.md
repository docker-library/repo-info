...
```console
$ docker pull drupal@sha256:6fb016f03241eb96efaeb643262db9d873f1ed7392dff8a7eda63a8dd892e9d4
```
...
### `drupal:11.3.13-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.13-php8.5-fpm-alpine` - linux; riscv64
