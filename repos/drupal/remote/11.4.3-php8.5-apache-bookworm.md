...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; amd64
...
### `drupal:11.4.3-php8.5-apache-bookworm` - unknown; unknown
...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; 386
...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; ppc64le
...
### `drupal:11.4.3-php8.5-apache-bookworm` - linux; s390x
