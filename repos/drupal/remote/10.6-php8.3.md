...
```console
$ docker pull drupal@sha256:66abf38d0c09f6df0a6a0d43bb400accd57ea1b7f28ecd83194be557a37e92ea
```
...
```console
$ docker pull drupal@sha256:30cec536026b5fb7eae406e7a4ab505be1c7ff4584a851aad33ee37832748407
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.8 MB (232792608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0c573478d70836a3ceb45e299675d47e84e99fffee3d327e73d7c22cafcf9d6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 14 Jul 2026 23:03:49 GMT
CMD ["apache2-foreground"]
# Fri, 17 Jul 2026 00:52:07 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libavif-dev 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-avif 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 17 Jul 2026 00:52:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Fri, 17 Jul 2026 00:52:08 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Fri, 17 Jul 2026 00:52:08 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Fri, 17 Jul 2026 00:52:09 GMT
ENV DRUPAL_VERSION=10.6.13
# Fri, 17 Jul 2026 00:52:09 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Fri, 17 Jul 2026 00:52:09 GMT
WORKDIR /opt/drupal
# Fri, 17 Jul 2026 00:52:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Fri, 17 Jul 2026 00:52:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:dfdc31c4e627fe0e4eb3a814e6e4b7ab96fa2f6cda6dfcc01c22bc90b3898433`  
		Last Modified: Fri, 17 Jul 2026 00:57:32 GMT  
		Size: 7.1 MB (7063792 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5d934555e8d208979d14e61e6a4020f8ab22347b8b5ab0da81fae6ec2b06c934`  
		Last Modified: Fri, 17 Jul 2026 00:57:31 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1d368bcf02a489e99f9606c278b10d94012c17532841eb4f6433c92fa60f0597`  
		Last Modified: Fri, 17 Jul 2026 00:57:31 GMT  
		Size: 262.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:50d2747f8a817bcd022437e6870385a4959282701b65afebbf28809d5d37d1ca`  
		Last Modified: Fri, 17 Jul 2026 00:57:31 GMT  
		Size: 832.3 KB (832289 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:89df4c79067e2ee15dd965ea38a0b08fcbc4821f0250de22c24bded7dafaa12b`  
		Last Modified: Fri, 17 Jul 2026 00:57:32 GMT  
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:01e10b2dc306818ffa616a4ad716b26da7f2be7a3628eaf6b370e39267b56b64`  
		Last Modified: Fri, 17 Jul 2026 00:57:36 GMT  
		Size: 21.9 MB (21949274 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6-php8.3` - unknown; unknown

```console
$ docker pull drupal@sha256:76efd9afcf0147da1c03d60455c71887354c268502113501e0d0977dc3465572
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.6 MB (7569717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:357af34aa29e7f96503641aeb8fe363c09587de58a741dbb6a6eedd0c35f727d`

```dockerfile
```

-	Layers:
	-	`sha256:3ce7feb9dd9770001222b5d73551d289bbb33b2cdef9c5f6887026f8be6381d5`  
		Last Modified: Fri, 17 Jul 2026 00:57:32 GMT  
		Size: 7.5 MB (7525293 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ccd775d3db210622259dece0d5a60f81f1b8ff12c877424e6e85ff21ce469085`  
		Last Modified: Fri, 17 Jul 2026 00:57:30 GMT  
