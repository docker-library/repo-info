...
```console
$ docker pull drupal@sha256:a9aab70c806d446ca090c16f15a138b96b4b5e831e5726eb9610b673ddcfec7e
```
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.4.3-php8.4-fpm-alpine3.23` - linux; s390x
