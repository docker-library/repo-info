...
### `docker:29.6.2-dind` - linux; amd64
...
### `docker:29.6.2-dind` - unknown; unknown
...
### `docker:29.6.2-dind` - linux; arm variant v6
...
### `docker:29.6.2-dind` - linux; arm variant v7
...
### `docker:29.6.2-dind` - linux; arm64 variant v8
