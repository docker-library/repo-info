...
### `docker:29.7.1-cli-alpine3.24` - linux; amd64
...
### `docker:29.7.1-cli-alpine3.24` - unknown; unknown
...
### `docker:29.7.1-cli-alpine3.24` - linux; arm variant v6
...
### `docker:29.7.1-cli-alpine3.24` - linux; arm variant v7
...
### `docker:29.7.1-cli-alpine3.24` - linux; arm64 variant v8
