...
- Created: `2026-07-02T02:31:12.277794979Z`
- Virtual Size: ~ 842.19 Mb  
...
### `dpkg` source package: `mongodb-org=8.3.4`

Binary Packages:

- `mongodb-org=8.3.4`
- `mongodb-org-database=8.3.4`
- `mongodb-org-database-tools-extra=8.3.4`
- `mongodb-org-mongos=8.3.4`
- `mongodb-org-server=8.3.4`
- `mongodb-org-shell=8.3.4`
- `mongodb-org-tools=8.3.4`
