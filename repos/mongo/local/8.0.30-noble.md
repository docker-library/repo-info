...
- Created: `2026-09-09T02:33:55.748146217Z`
- Virtual Size: ~ 942.11 Mb  
...
### `dpkg` source package: `mongodb-database-tools=100.18.0`
...
### `dpkg` source package: `mongodb-mongosh=2.10.0`

Binary Packages:

- `mongodb-mongosh=2.10.0`
...
### `dpkg` source package: `mongodb-org=8.0.30`

Binary Packages:

- `mongodb-org=8.0.30`
- `mongodb-org-database=8.0.30`
- `mongodb-org-database-tools-extra=8.0.30`
- `mongodb-org-mongos=8.0.30`
- `mongodb-org-server=8.0.30`
- `mongodb-org-shell=8.0.30`
- `mongodb-org-tools=8.0.30`
