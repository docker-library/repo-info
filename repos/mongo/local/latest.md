...
- Created: `2026-09-09T02:35:37.407766172Z`
- Virtual Size: ~ 831.17 Mb  
...
### `dpkg` source package: `mongodb-org=8.3.9`

Binary Packages:

- `mongodb-org=8.3.9`
- `mongodb-org-database=8.3.9`
- `mongodb-org-database-tools-extra=8.3.9`
- `mongodb-org-mongos=8.3.9`
- `mongodb-org-server=8.3.9`
- `mongodb-org-shell=8.3.9`
- `mongodb-org-tools=8.3.9`
