...
- Created: `2026-08-18T19:24:31.729043742Z`
- Virtual Size: ~ 941.71 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.29`

Binary Packages:

- `mongodb-org=8.0.29`
- `mongodb-org-database=8.0.29`
- `mongodb-org-database-tools-extra=8.0.29`
- `mongodb-org-mongos=8.0.29`
- `mongodb-org-server=8.0.29`
- `mongodb-org-shell=8.0.29`
- `mongodb-org-tools=8.0.29`
