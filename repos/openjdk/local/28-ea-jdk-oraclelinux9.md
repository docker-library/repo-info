...
- Created: `2026-06-26T17:50:13.676530133Z`
- Virtual Size: ~ 616 Mb  
...
### `rpm` package: `coreutils-single-8.32-40.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.32-40.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-40.0.1.el9.src.rpm
```
...
### `rpm` package: `glib2-2.68.4-19.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glib2-2.68.4-19.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-19.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-19.el9.src.rpm
```

### `rpm` package: `glibc-2.34-266.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-266.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
```

### `rpm` package: `glibc-common-2.34-266.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-266.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-266.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-266.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.8.10-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.8.10-3.el9.src.rpm
```
...
### `rpm` package: `krb5-libs-1.21.1-9.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.21.1-9.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/krb5-1.21.1-9.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/krb5-1.21.1-9.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsolv-0.7.24-4.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsolv-0.7.24-4.el9.src.rpm
```
...
### `rpm` package: `openssl-3.5.5-2.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.5.5-2.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.5-2.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.5-2.0.1.el9_8.src.rpm
```
...
### `rpm` package: `openssl-libs-3.5.5-2.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.5-2.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.5-2.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.5-2.0.1.el9_8.src.rpm
```
...
### `rpm` package: `systemd-252-67.0.1.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-67.0.1.el9_8.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
```

### `rpm` package: `systemd-libs-252-67.0.1.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-67.0.1.el9_8.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
```

### `rpm` package: `systemd-pam-252-67.0.1.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-67.0.1.el9_8.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-67.0.1.el9_8.2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-67.0.1.el9_8.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.2.src.rpm
```
