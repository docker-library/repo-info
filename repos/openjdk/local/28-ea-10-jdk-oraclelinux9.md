# `openjdk:28-ea-10-jdk-oraclelinux9`

## Docker Metadata

- Image ID: `sha256:b132616e7b24e34bceb6ab12b84a2ff56ea90c1a336f98e593dd40c502aeea86`
- Created: `2026-08-10T23:34:25.294410326Z`
- Virtual Size: ~ 685.36 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/acl-2.4.0-1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/acl-2.4.0-1.el9_8.src.rpm
```
...
```console
$ dnf --quiet download --source --url audit-libs-3.1.5-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/audit-3.1.5-8.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/audit-3.1.5-8.0.1.el9.src.rpm
```
...
### `rpm` package: `binutils-2.35.2-72.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-72.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-72.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-72.0.1.el9.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-72.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-72.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-72.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-72.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/bzip2-1.0.8-11.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/bzip2-1.0.8-11.el9.src.rpm
```
...
### `rpm` package: `coreutils-single-8.32-41.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.32-41.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-41.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/cracklib-2.9.6-28.el9.src.rpm
```
...
### `rpm` package: `crypto-policies-20260224-1.0.1.gitea0f072.el9_8.noarch`
...
```console
$ dnf --quiet download --source --url crypto-policies-20260224-1.0.1.gitea0f072.el9_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/crypto-policies-20260224-1.0.1.gitea0f072.el9_8.src.rpm
```

### `rpm` package: `curl-7.76.1-40.el9.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-40.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-40.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-40.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.5.0-6.el9_8.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.5.0-6.el9_8.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/file-5.39-17.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/file-5.39-17.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-19.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-19.el9_8.2.src.rpm
```

### `rpm` package: `glibc-2.34-274.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-274.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
```

### `rpm` package: `glibc-common-2.34-274.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-274.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-274.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-274.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.8.10-4.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.8.10-4.el9_8.src.rpm
```
...
### `rpm` package: `krb5-libs-1.21.1-10.0.1.el9_8.x86_64`
...
### `rpm` package: `libcurl-7.76.1-40.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-40.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-40.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-40.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-18.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-18.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libeconf-0.4.1-7.el9_8.src.rpm
```
...
### `rpm` package: `libfdisk-2.37.4-25.0.1.el9.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/nghttp2-1.43.0-6.el9_8.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/librepo-1.19.0-1.el9.src.rpm
```
...
### `rpm` package: `libsmartcols-2.37.4-25.0.1.el9.x86_64`
...
### `rpm` package: `libssh-0.10.4-18.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libssh-0.10.4-18.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libssh-0.10.4-18.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libssh-0.10.4-18.el9.src.rpm
```

### `rpm` package: `libssh-config-0.10.4-18.el9.noarch`
...
```console
$ dnf --quiet download --source --url libssh-config-0.10.4-18.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libssh-0.10.4-18.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libssh-0.10.4-18.el9.src.rpm
```
...
### `rpm` package: `libuuid-2.37.4-25.0.1.el9.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-14.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-14.el9_8.2.src.rpm
```
...
### `rpm` package: `openssl-3.5.5-5.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.5.5-5.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.5-5.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.5-5.0.1.el9_8.src.rpm
```
...
### `rpm` package: `openssl-libs-3.5.5-5.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.5-5.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.5-5.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.5-5.0.1.el9_8.src.rpm
```
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.8-1.0.7.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.8-1.0.7.el9.src.rpm
```

### `rpm` package: `oraclelinux-release-el9-1.0-29.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-29.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-29.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/p11-kit-0.26.2-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/p11-kit-0.26.2-1.el9.src.rpm
```
...
### `rpm` package: `pam-1.5.1-28.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url pam-1.5.1-28.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-28.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-28.0.1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url redhat-release-9.8-0.7.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/redhat-release-9.8-0.7.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/sed-4.8-10.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/shadow-utils-4.9-16.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/sqlite-3.34.1-10.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/sqlite-3.34.1-10.el9_8.src.rpm
```

### `rpm` package: `systemd-252-67.0.1.el9_8.4.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-67.0.1.el9_8.4
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
```

### `rpm` package: `systemd-libs-252-67.0.1.el9_8.4.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-67.0.1.el9_8.4
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
```

### `rpm` package: `systemd-pam-252-67.0.1.el9_8.4.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-67.0.1.el9_8.4
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-67.0.1.el9_8.4.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-67.0.1.el9_8.4.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-67.0.1.el9_8.4.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tar-1.34-11.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2026b-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2026b-1.el9.src.rpm
```
