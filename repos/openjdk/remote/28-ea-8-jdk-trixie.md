...
### `openjdk:28-ea-8-jdk-trixie` - linux; amd64
...
### `openjdk:28-ea-8-jdk-trixie` - unknown; unknown
...
### `openjdk:28-ea-8-jdk-trixie` - linux; arm64 variant v8
