...
### `openjdk:28-ea-9-slim-bookworm` - linux; amd64
...
### `openjdk:28-ea-9-slim-bookworm` - unknown; unknown
...
### `openjdk:28-ea-9-slim-bookworm` - linux; arm64 variant v8
