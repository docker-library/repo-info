...
### `openjdk:28-ea-7-jdk` - linux; amd64
...
### `openjdk:28-ea-7-jdk` - unknown; unknown
...
### `openjdk:28-ea-7-jdk` - linux; arm64 variant v8
...
### `openjdk:28-ea-7-jdk` - windows version 10.0.26100.33158; amd64
...
### `openjdk:28-ea-7-jdk` - windows version 10.0.20348.5386; amd64
