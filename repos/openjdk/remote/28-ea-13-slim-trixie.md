...
### `openjdk:28-ea-13-slim-trixie` - linux; amd64
...
### `openjdk:28-ea-13-slim-trixie` - unknown; unknown
...
### `openjdk:28-ea-13-slim-trixie` - linux; arm64 variant v8
