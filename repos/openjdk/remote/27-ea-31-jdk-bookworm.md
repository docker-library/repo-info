...
### `openjdk:27-ea-31-jdk-bookworm` - linux; amd64
...
### `openjdk:27-ea-31-jdk-bookworm` - unknown; unknown
...
### `openjdk:27-ea-31-jdk-bookworm` - linux; arm64 variant v8
