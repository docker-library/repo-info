...
### `openjdk:27-ea-32-jdk-bookworm` - linux; amd64
...
### `openjdk:27-ea-32-jdk-bookworm` - unknown; unknown
...
### `openjdk:27-ea-32-jdk-bookworm` - linux; arm64 variant v8
