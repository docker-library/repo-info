...
### `openjdk:28-ea-10-slim-trixie` - linux; amd64
...
### `openjdk:28-ea-10-slim-trixie` - unknown; unknown
...
### `openjdk:28-ea-10-slim-trixie` - linux; arm64 variant v8
