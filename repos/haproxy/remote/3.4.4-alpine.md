...
```console
$ docker pull haproxy@sha256:52c5921e1619f39cbd5b25e1b4b5847667917f39745056cf004d9c263fbf11b9
```
...
### `haproxy:3.4.4-alpine` - linux; amd64
...
### `haproxy:3.4.4-alpine` - unknown; unknown
...
### `haproxy:3.4.4-alpine` - linux; arm variant v6
...
### `haproxy:3.4.4-alpine` - linux; arm variant v7
...
### `haproxy:3.4.4-alpine` - linux; arm64 variant v8
...
### `haproxy:3.4.4-alpine` - linux; 386
...
### `haproxy:3.4.4-alpine` - linux; ppc64le
...
### `haproxy:3.4.4-alpine` - linux; riscv64
...
### `haproxy:3.4.4-alpine` - linux; s390x
