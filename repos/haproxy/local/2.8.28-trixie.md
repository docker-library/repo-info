...
- Created: `2026-09-19T00:14:24.379511878Z`
- Virtual Size: ~ 101.09 Mb  
...
- Environment:
  ...
  - `HAPROXY_VERSION=2.8.28`
  - `HAPROXY_URL=https://www.haproxy.org/download/2.8/src/haproxy-2.8.28.tar.gz`
  - `HAPROXY_SHA256=f6e7f9a5ad3597a2de54c38661f786a90e6607644adf5b0c93d99bcbd42edef8`
...
### `dpkg` source package: `socat=1.8.0.3-1+deb13u1`
...
```console
$ apt-get source -qq --print-uris socat=1.8.0.3-1+deb13u1
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.8.0.3-1%2bdeb13u1.dsc' socat_1.8.0.3-1+deb13u1.dsc 1898 SHA256:03f70af2e858ca01fc29d32cf2cb105a6f984cdeccdf7ba263a4a4c12dd8a62f
...
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.8.0.3-1%2bdeb13u1.debian.tar.xz' socat_1.8.0.3-1+deb13u1.debian.tar.xz 16704 SHA256:2c19480da54317ad12d7e9b176bc23bde368b38756ed87aca3712b753ef83e86
```

Other potentially useful URLs:

- https://sources.debian.net/src/socat/1.8.0.3-1+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/socat/1.8.0.3-1+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/socat/1.8.0.3-1+deb13u1/ (for access to the source package after it no longer exists in the archive)
