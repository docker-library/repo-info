...
```console
cairo-1.18.4-r1 description:
A vector graphics library

cairo-1.18.4-r1 webpage:
https://cairographics.org/

cairo-1.18.4-r1 installed size:
1056 KiB

cairo-1.18.4-r1 license:
...
```console
libraw-0.22.1-r0 description:
Library for reading RAW files obtained from digital photo cameras

libraw-0.22.1-r0 webpage:
https://www.libraw.org/

libraw-0.22.1-r0 installed size:
2567 KiB

libraw-0.22.1-r0 license:
...
```console
librsvg-2.62.3-r0 description:
Library to render SVG images to Cairo surfaces

librsvg-2.62.3-r0 webpage:
https://gitlab.gnome.org/GNOME/librsvg

librsvg-2.62.3-r0 installed size:
3681 KiB

librsvg-2.62.3-r0 license:
LGPL-2.1-or-later
...
```console
pango-1.57.1-r0 description:
library for layout and rendering of text

pango-1.57.1-r0 webpage:
https://www.pango.org/

pango-1.57.1-r0 installed size:
625 KiB

pango-1.57.1-r0 license:
LGPL-2.1-or-later
...
```console
shared-mime-info-2.4-r7 description:
Freedesktop.org Shared MIME Info

shared-mime-info-2.4-r7 webpage:
https://www.freedesktop.org/Software/shared-mime-info

shared-mime-info-2.4-r7 installed size:
2489 KiB

shared-mime-info-2.4-r7 license:
GPL-2.0-or-later
