...
### `nextcloud:32.0.14-apache` - linux; amd64
...
### `nextcloud:32.0.14-apache` - unknown; unknown
...
### `nextcloud:32.0.14-apache` - linux; arm variant v5
...
### `nextcloud:32.0.14-apache` - linux; arm variant v7
...
### `nextcloud:32.0.14-apache` - linux; arm64 variant v8
...
### `nextcloud:32.0.14-apache` - linux; 386
...
### `nextcloud:32.0.14-apache` - linux; ppc64le
...
### `nextcloud:32.0.14-apache` - linux; riscv64
...
### `nextcloud:32.0.14-apache` - linux; s390x
