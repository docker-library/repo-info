...
### `nextcloud:34.0.3-apache` - linux; amd64
...
### `nextcloud:34.0.3-apache` - unknown; unknown
...
### `nextcloud:34.0.3-apache` - linux; arm variant v5
...
### `nextcloud:34.0.3-apache` - linux; arm variant v7
...
### `nextcloud:34.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:34.0.3-apache` - linux; 386
...
### `nextcloud:34.0.3-apache` - linux; ppc64le
...
### `nextcloud:34.0.3-apache` - linux; riscv64
...
### `nextcloud:34.0.3-apache` - linux; s390x
