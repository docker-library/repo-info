...
```console
$ docker pull nextcloud@sha256:ddbaa38ac1ac3a1d5480765fe8f0993bf8598c4dfe18de4865cfc4c483e407f4
```
...
### `nextcloud:32.0.13-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.13-fpm-alpine` - unknown; unknown
...
### `nextcloud:32.0.13-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:32.0.13-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:32.0.13-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.13-fpm-alpine` - linux; 386
...
### `nextcloud:32.0.13-fpm-alpine` - linux; ppc64le
...
### `nextcloud:32.0.13-fpm-alpine` - linux; s390x
