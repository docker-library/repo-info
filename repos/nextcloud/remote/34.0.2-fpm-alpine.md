...
```console
$ docker pull nextcloud@sha256:6e810f949f65dbf3cb1d79bd8f5a51682ecc66b16670b5c3532680945c91558f
```
...
### `nextcloud:34.0.2-fpm-alpine` - linux; amd64
...
### `nextcloud:34.0.2-fpm-alpine` - unknown; unknown
...
### `nextcloud:34.0.2-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:34.0.2-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:34.0.2-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:34.0.2-fpm-alpine` - linux; 386
...
### `nextcloud:34.0.2-fpm-alpine` - linux; ppc64le
...
### `nextcloud:34.0.2-fpm-alpine` - linux; s390x
