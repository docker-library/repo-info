...
```console
$ docker pull nextcloud@sha256:0b83f065f0c6240356862116a441bdc245156c849ad7e762d6f4a3fca15b5bce
```
...
### `nextcloud:33.0.8-fpm` - linux; amd64
...
### `nextcloud:33.0.8-fpm` - unknown; unknown
...
### `nextcloud:33.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:33.0.8-fpm` - linux; arm variant v7
...
### `nextcloud:33.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:33.0.8-fpm` - linux; 386
...
### `nextcloud:33.0.8-fpm` - linux; ppc64le
...
### `nextcloud:33.0.8-fpm` - linux; riscv64
...
### `nextcloud:33.0.8-fpm` - linux; s390x
