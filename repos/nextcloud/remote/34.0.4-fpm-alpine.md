...
```console
$ docker pull nextcloud@sha256:b051b306eadda13ffc20affe05dd6fd8db05208d70485d957aa459660acd6672
```
...
### `nextcloud:34.0.4-fpm-alpine` - linux; amd64
...
### `nextcloud:34.0.4-fpm-alpine` - unknown; unknown
...
### `nextcloud:34.0.4-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:34.0.4-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:34.0.4-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:34.0.4-fpm-alpine` - linux; 386
...
### `nextcloud:34.0.4-fpm-alpine` - linux; ppc64le
