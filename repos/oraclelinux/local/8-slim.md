...
- Image ID: `sha256:44e22902e94e9d60582da5eb328df4e68357406fc919d09e9b72ff7433014881`
- Created: `2026-09-08T18:58:13.198238837Z`
- Virtual Size: ~ 115.86 Mb  
...
### `rpm` package: `coreutils-single-8.30-20.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.30-20.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/coreutils-8.30-20.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8_10.13.src.rpm
```
...
### `rpm` package: `glib2-2.56.4-170.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url glib2-2.56.4-170.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glib2-2.56.4-170.el8_10.src.rpm
```

### `rpm` package: `glibc-2.28-251.0.5.el8_10.40.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-251.0.5.el8_10.40
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
```

### `rpm` package: `glibc-common-2.28-251.0.5.el8_10.40.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-251.0.5.el8_10.40
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-251.0.5.el8_10.40.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-251.0.5.el8_10.40
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.5.el8_10.40.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/acl-2.4.0-1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/attr-2.6.0-1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libgcrypt-1.8.5-8.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/nghttp2-1.33.0-6.el8_10.3.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsolv-0.7.20-7.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libusbx-1.0.30-1.el8_10.src.rpm
```
...
### `rpm` package: `libxml2-2.9.7-21.el8_10.6.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-2.9.7-21.el8_10.6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libxml2-2.9.7-21.el8_10.6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libxml2-2.9.7-21.el8_10.6.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-17.el8_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.13.el8_10.17
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.13.el8_10.17.src.rpm
```
...
### `rpm` package: `tzdata-2026c-1.0.1.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2026c-1.0.1.el8_10.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tzdata-2026c-1.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/tzdata-2026c-1.0.1.el8_10.src.rpm
```
