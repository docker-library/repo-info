...
- Created: `2026-06-23T23:31:07.007986141Z`
...
### `rpm` package: `coreutils-8.32-40.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-40.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-40.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.5.0-6.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.5.0-6.el9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-266.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-266.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-266.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libeconf-0.4.1-5.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-26.0.1.el9_8.4.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-26.0.1.el9_8.4
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.4.src.rpm
```
