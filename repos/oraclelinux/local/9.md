...
- Created: `2026-07-16T20:47:02.174808093Z`
- Virtual Size: ~ 240.22 Mb  
...
### `rpm` package: `glibc-langpack-en-2.34-272.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-272.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-272.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-272.0.1.el9_8.src.rpm
```
...
### `rpm` package: `python3-3.9.25-7.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-7.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-7.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-7.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.src.rpm
```
