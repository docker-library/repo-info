...
- Created: `2026-09-11T23:24:07.464291578Z`
- Virtual Size: ~ 240.25 Mb  
...
### `rpm` package: `coreutils-8.32-41.0.1.el9_8.1.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-41.0.1.el9_8.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-41.0.1.el9_8.1.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-26.0.1.el9_8.21.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-26.0.1.el9_8.21
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.21.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.21.src.rpm
```
