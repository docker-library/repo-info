...
- Created: `2026-09-08T18:58:45.779064512Z`
- Virtual Size: ~ 240.24 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-19.el9_8.9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-19.el9_8.9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-275.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-275.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-275.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-275.0.1.el9_8.src.rpm
```
...
### `rpm` package: `openssh-9.9p1-9.0.3.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-9.9p1-9.0.3.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
```

### `rpm` package: `openssh-clients-9.9p1-9.0.3.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-9.9p1-9.0.3.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
```

### `rpm` package: `openssh-server-9.9p1-9.0.3.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-9.9p1-9.0.3.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-9.0.3.el9_8.src.rpm
```
...
### `rpm` package: `python3-3.9.25-7.0.1.el9_8.3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-7.0.1.el9_8.3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.3.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-7.0.1.el9_8.3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-7.0.1.el9_8.3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.3.src.rpm
```
