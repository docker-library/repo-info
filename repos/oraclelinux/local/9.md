...
- Created: `2022-12-07T01:50:47.9135618Z`
- Virtual Size: ~ 224.65 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/bash-5.1.8-5.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/cryptsetup-2.4.3-5.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-19.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-19.el9.src.rpm
```
...
### `rpm` package: `dbus-1.12.20-6.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-1.12.20-6.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
```
...
### `rpm` package: `dbus-common-1.12.20-6.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dbus-common-1.12.20-6.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
```

### `rpm` package: `dbus-libs-1.12.20-6.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.20-6.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-6.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.4.9-1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.4.9-1.el9_1.src.rpm
```
...
### `rpm` package: `glibc-2.34-40.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-40.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
```

### `rpm` package: `glibc-common-2.34-40.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-40.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.34-40.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-40.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-40.0.1.el9.src.rpm
```
...
### `rpm` package: `gnutls-3.7.6-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.7.6-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.7.6-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.7.6-12.0.1.el9_0.src.rpm
```
...
### `rpm` package: `iproute-5.18.0-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-5.18.0-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-5.18.0-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-7.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-7.el9.src.rpm
```
...
### `rpm` package: `libgcc-11.3.1-2.1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-11.3.1-2.1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libgcrypt-1.10.0-8.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libgcrypt-1.10.0-8.el9_0.src.rpm
```

### `rpm` package: `libgomp-11.3.1-2.1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.3.1-2.1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libksba-1.5.1-5.el9_0.src.rpm
```
...
### `rpm` package: `libstdc++-11.3.1-2.1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-11.3.1-2.1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-2.1.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libtasn1-4.16.0-7.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libtasn1-4.16.0-7.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/lua-5.4.2-4.el9_0.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/lua-5.4.2-4.el9_0.3.src.rpm
```
...
### `rpm` package: `openssl-3.0.1-43.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.0.1-43.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.1-43.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.1-43.0.1.el9_0.src.rpm
```

### `rpm` package: `openssl-libs-3.0.1-43.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.0.1-43.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.1-43.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.1-43.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.14-1.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.14-1.el9_1.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-setuptools-53.0.0-10.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/sqlite-3.34.1-5.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/sqlite-3.34.1-5.el9.src.rpm
```

### `rpm` package: `systemd-250-12.0.1.el9_1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-250-12.0.1.el9_1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
```

### `rpm` package: `systemd-libs-250-12.0.1.el9_1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-250-12.0.1.el9_1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
```

### `rpm` package: `systemd-pam-250-12.0.1.el9_1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-250-12.0.1.el9_1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-250-12.0.1.el9_1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-250-12.0.1.el9_1.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.1.el9_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tar-1.34-5.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2022g-1.el9_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2022g-1.el9_1.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-16.0.1.el9_0.3.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-16.0.1.el9_0.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-16.0.1.el9_0.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-16.0.1.el9_0.3.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/zlib-1.2.11-34.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-34.el9.src.rpm
```
