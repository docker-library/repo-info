...
- Created: `2026-07-23T22:56:10.734845889Z`
- Virtual Size: ~ 240.2 Mb  
...
### `rpm` package: `chkconfig-1.24-2.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.24-2.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/chkconfig-1.24-2.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/chkconfig-1.24-2.0.1.el9.src.rpm
```

### `rpm` package: `coreutils-8.32-41.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-41.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-41.0.1.el9_8.src.rpm
```
...
### `rpm` package: `dhcp-client-4.4.2-20.b1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-client-4.4.2-20.b1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-20.b1.el9.src.rpm
```

### `rpm` package: `dhcp-common-4.4.2-20.b1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.4.2-20.b1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-20.b1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-34.0.1.el9_8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-34.0.1.el9_8.noarch
...
### `rpm` package: `dnf-plugins-core-4.3.0-26.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-26.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-274.0.1.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-274.0.1.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-274.0.1.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ima-evm-utils-1.6.2-2.el9.src.rpm
```

### `rpm` package: `initscripts-10.11.8-4.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-10.11.8-4.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.8-4.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-rename-device-10.11.8-4.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-rename-device-10.11.8-4.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.8-4.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-service-10.11.8-4.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url initscripts-service-10.11.8-4.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.8-4.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-6.17.0-2.el9.src.rpm
```

### `rpm` package: `iputils-20210202-15.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-15.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-15.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-15.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-1.5.0-3.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libedit-3.1-39.20210216cvs.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libedit-3.1-39.20210216cvs.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-14.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-14.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-14.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-14.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libmnl-1.0.4-16.el9_4.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-17.el9.src.rpm
```
...
### `rpm` package: `openssh-9.9p1-7.0.2.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-9.9p1-7.0.2.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
```

### `rpm` package: `openssh-clients-9.9p1-7.0.2.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-9.9p1-7.0.2.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
```

### `rpm` package: `openssh-server-9.9p1-7.0.2.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-9.9p1-7.0.2.el9_8
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-7.0.2.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/policycoreutils-3.6-5.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/policycoreutils-3.6-5.el9.src.rpm
```
...
### `rpm` package: `python3-3.9.25-7.0.1.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-7.0.1.el9_8.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-dateutil-2.9.0.post0-1.el9_7.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-34.0.1.el9_8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-34.0.1.el9_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-34.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-34.0.1.el9_8.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-26.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-26.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-18.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-18.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-18.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-18.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-18.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-18.0.1.el9.src.rpm
```

### `rpm` package: `python3-libs-3.9.25-7.0.1.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-7.0.1.el9_8.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-7.0.1.el9_8.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-pip-21.3.1-2.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python-pip-21.3.1-2.el9_8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-systemd-234-19.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rootfiles-8.1-35.el9.src.rpm
```
...
### `rpm` package: `rsyslog-8.2510.0-2.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2510.0-2.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2510.0-2.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tpm2-tss-3.2.3-1.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-26.0.1.el9_8.10.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-26.0.1.el9_8.10
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-26.0.1.el9_8.10.src.rpm
```
...
### `rpm` package: `yum-4.14.0-34.0.1.el9_8.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-34.0.1.el9_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-34.0.1.el9_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-34.0.1.el9_8.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-26.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-26.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-26.0.1.el9.src.rpm
```
