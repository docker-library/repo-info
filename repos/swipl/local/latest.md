...
- `tdsodbc:amd64=1.3.17+ds-2+deb13u1`
...
### `dpkg` source package: `geos=3.13.1-1`

Binary Packages:

- `libgeos-c1t64:amd64=3.13.1-1`
- `libgeos3.13.1:amd64=3.13.1-1`

Licenses: (parsed from: `/usr/share/doc/libgeos-c1t64/copyright`, `/usr/share/doc/libgeos3.13.1/copyright`)
...
```console
$ apt-get source -qq --print-uris geos=3.13.1-1
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.13.1-1.dsc' geos_3.13.1-1.dsc 2312 SHA256:4ee8da76cf819fecd5a808058fb69049681018d384edd971e80312bb2f9af341
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.13.1.orig.tar.bz2' geos_3.13.1.orig.tar.bz2 6839955 SHA256:df2c50503295f325e7c8d7b783aca8ba4773919cde984193850cf9e361dfd28c
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.13.1-1.debian.tar.xz' geos_3.13.1-1.debian.tar.xz 78032 SHA256:2895799369803d3b156552238beaf39fa99d15d26204c90939a0d34df27f928b
```

Other potentially useful URLs:

- https://sources.debian.net/src/geos/3.13.1-1/ (for browsing the source)
- https://sources.debian.net/src/geos/3.13.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/geos/3.13.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `google-perftools=2.16-1`

Binary Packages:

- `libtcmalloc-minimal4t64:amd64=2.16-1`
...
```console
$ apt-get source -qq --print-uris google-perftools=2.16-1
'http://deb.debian.org/debian/pool/main/g/google-perftools/google-perftools_2.16-1.dsc' google-perftools_2.16-1.dsc 2247 SHA256:45739fce4abfd180e21cc49e7b4893481390c13591b8d291803bcb2305928d24
'http://deb.debian.org/debian/pool/main/g/google-perftools/google-perftools_2.16.orig.tar.gz' google-perftools_2.16.orig.tar.gz 1743259 SHA256:737be182b4e42f5c7f595da2a7aa59ce0489a73d336d0d16847f2aa52d5221b4
'http://deb.debian.org/debian/pool/main/g/google-perftools/google-perftools_2.16-1.debian.tar.xz' google-perftools_2.16-1.debian.tar.xz 8068 SHA256:7df158f40167a2aac99e906f81b007e5dd1cc531a2392833e308551d063a19c1
```

Other potentially useful URLs:

- https://sources.debian.net/src/google-perftools/2.16-1/ (for browsing the source)
- https://sources.debian.net/src/google-perftools/2.16-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/google-perftools/2.16-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libarchive=3.7.4-4+deb13u1`

Binary Packages:

- `libarchive13t64:amd64=3.7.4-4+deb13u1`
...
```console
$ apt-get source -qq --print-uris libarchive=3.7.4-4+deb13u1
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.7.4-4%2bdeb13u1.dsc' libarchive_3.7.4-4+deb13u1.dsc 2634 SHA256:0579aa62c9b547a520fd3af48382b1b071c75dde75643c5063fc5f5dcb80545b
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.7.4-4%2bdeb13u1.debian.tar.xz' libarchive_3.7.4-4+deb13u1.debian.tar.xz 40084 SHA256:72da9703b642c6c9bc0432704f1ad14919c57f743336396b5f8aefaf9bf79874
```

Other potentially useful URLs:

- https://sources.debian.net/src/libarchive/3.7.4-4+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/libarchive/3.7.4-4+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libarchive/3.7.4-4+deb13u1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/o/openssl/openssl_3.5.7-1%7edeb13u2.dsc' openssl_3.5.7-1~deb13u2.dsc 2707 SHA256:25904642004d30c5c3da4642a72a7d09f8d9eb6e5ce62dab53c0371114faf8f2
'http://deb.debian.org/debian/pool/main/o/openssl/openssl_3.5.7.orig.tar.gz' openssl_3.5.7.orig.tar.gz 53153930 SHA256:a8c0d28a529ca480f9f36cf5792e2cd21984552a3c8e4aa11a24aa31aeac98e8
'http://deb.debian.org/debian/pool/main/o/openssl/openssl_3.5.7.orig.tar.gz.asc' openssl_3.5.7.orig.tar.gz.asc 833 SHA256:d3d082bee3f658c31db53af625eceecf29d777c7010394bed5787ebcc98abdf2
'http://deb.debian.org/debian/pool/main/o/openssl/openssl_3.5.7-1%7edeb13u2.debian.tar.xz' openssl_3.5.7-1~deb13u2.debian.tar.xz 74836 SHA256:593a47654ead460a3b609503733f80bef552ff0802799d3b47784faacc50809f
```
...
### `dpkg` source package: `ossp-uuid=1.6.4-1`

Binary Packages:

- `libossp-uuid16:amd64=1.6.4-1`

Licenses: (parsed from: `/usr/share/doc/libossp-uuid16/copyright`)
...
```console
$ apt-get source -qq --print-uris ossp-uuid=1.6.4-1
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.4-1.dsc' ossp-uuid_1.6.4-1.dsc 2356 SHA256:212c2ae04c512fca773c9138b987f71a6eb0efe7bef57302b15f25fd8460535a
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.4.orig.tar.gz' ossp-uuid_1.6.4.orig.tar.gz 54283 SHA256:7331f7a47bafaa4ffad23b4635a4c532f55e400280c1560fe1acbe09862bcd88
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.4.orig.tar.gz.asc' ossp-uuid_1.6.4.orig.tar.gz.asc 833 SHA256:80d6ae2f895417ebb900937ccfa022ab6529ce930f38904ed624308dd17ab685
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.4-1.debian.tar.xz' ossp-uuid_1.6.4-1.debian.tar.xz 24292 SHA256:3a46e1a03b139f284a4237f07ba2f5a6c20ad1366870ecec26e53f9affb6a4ec
```

Other potentially useful URLs:

- https://sources.debian.net/src/ossp-uuid/1.6.4-1/ (for browsing the source)
- https://sources.debian.net/src/ossp-uuid/1.6.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ossp-uuid/1.6.4-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pcre2=10.46-1~deb13u2`
...
```console
$ apt-get source -qq --print-uris pcre2=10.46-1~deb13u2
'http://deb.debian.org/debian/pool/main/p/pcre2/pcre2_10.46-1%7edeb13u2.dsc' pcre2_10.46-1~deb13u2.dsc 2380 SHA256:4eac7bfc4d11259da7d299f90b6c74b359d7cbb3be2f017e039b02524f30d2e6
...
'http://deb.debian.org/debian/pool/main/p/pcre2/pcre2_10.46-1%7edeb13u2.diff.gz' pcre2_10.46-1~deb13u2.diff.gz 19569 SHA256:4523b65a28a1fc9c418be7e70af68a354ae128d541243b1e1ea5c03a9e542236
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcre2/10.46-1~deb13u2/ (for browsing the source)
- https://sources.debian.net/src/pcre2/10.46-1~deb13u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pcre2/10.46-1~deb13u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `psqlodbc=1:17.00.0004-2`

Binary Packages:

- `odbc-postgresql:amd64=1:17.00.0004-2`
...
```console
$ apt-get source -qq --print-uris psqlodbc=1:17.00.0004-2
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_17.00.0004-2.dsc' psqlodbc_17.00.0004-2.dsc 2138 SHA256:53190fdd11074ac48d96f793e99e867adabce00f931ce80f1e4b1747b2af7498
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_17.00.0004.orig.tar.gz' psqlodbc_17.00.0004.orig.tar.gz 656433 SHA256:6d15bc4f49a0c9e0d263ff30b042d4d49ef4ead745c2dd1f0d0d9c3d2a98b4fc
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_17.00.0004-2.debian.tar.xz' psqlodbc_17.00.0004-2.debian.tar.xz 10560 SHA256:8c9e5a7997010100d306a5eb09436b98b10b48d94ef32e016a5226f972a7b56d
```

Other potentially useful URLs:

- https://sources.debian.net/src/psqlodbc/1:17.00.0004-2/ (for browsing the source)
- https://sources.debian.net/src/psqlodbc/1:17.00.0004-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/psqlodbc/1:17.00.0004-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python3.13=3.13.5-2+deb13u5`
...
```console
$ apt-get source -qq --print-uris python3.13=3.13.5-2+deb13u5
'http://deb.debian.org/debian/pool/main/p/python3.13/python3.13_3.13.5-2%2bdeb13u5.dsc' python3.13_3.13.5-2+deb13u5.dsc 4298 SHA256:4be84e20fb902354fa86955e2fbea6e8bdbd158f54833423488308a9b3532662
...
'http://deb.debian.org/debian/pool/main/p/python3.13/python3.13_3.13.5-2%2bdeb13u5.debian.tar.xz' python3.13_3.13.5-2+deb13u5.debian.tar.xz 299640 SHA256:a51f456e654ce2c9b40cc1db8005e5041cdb0b2c3aa96ab0871c49fe95280366
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.13/3.13.5-2+deb13u5/ (for browsing the source)
- https://sources.debian.net/src/python3.13/3.13.5-2+deb13u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.13/3.13.5-2+deb13u5/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `raptor2=2.0.16-6`
...
```console
$ apt-get source -qq --print-uris raptor2=2.0.16-6
'http://deb.debian.org/debian/pool/main/r/raptor2/raptor2_2.0.16-6.dsc' raptor2_2.0.16-6.dsc 2314 SHA256:7a3ce85ae6af1f6455c07341f4b8fbdeae29423c13327516c4856244c19f54b0
'http://deb.debian.org/debian/pool/main/r/raptor2/raptor2_2.0.16.orig.tar.gz' raptor2_2.0.16.orig.tar.gz 1750726 SHA256:089db78d7ac982354bdbf39d973baf09581e6904ac4c92a98c5caadb3de44680
'http://deb.debian.org/debian/pool/main/r/raptor2/raptor2_2.0.16-6.debian.tar.xz' raptor2_2.0.16-6.debian.tar.xz 25184 SHA256:589162e22b9f6facf28be0e0c1eecce4e7a64f9c360f719d64b3ac0f3d09a1dd
```

Other potentially useful URLs:

- https://sources.debian.net/src/raptor2/2.0.16-6/ (for browsing the source)
- https://sources.debian.net/src/raptor2/2.0.16-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/raptor2/2.0.16-6/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `serd=0.32.4-1`

Binary Packages:

- `libserd-0-0:amd64=0.32.4-1`
...
```console
$ apt-get source -qq --print-uris serd=0.32.4-1
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.32.4-1.dsc' serd_0.32.4-1.dsc 2486 SHA256:698bc84a88a541655becb6cff460ec88fe980a0cdf7d8fec98a355e89dbe96b8
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.32.4.orig.tar.xz' serd_0.32.4.orig.tar.xz 174476 SHA256:cbefb569e8db686be8c69cb3866a9538c7cb055e8f24217dd6a4471effa7d349
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.32.4.orig.tar.xz.asc' serd_0.32.4.orig.tar.xz.asc 833 SHA256:6e6bb48341b8c2a9dc98f55dcb5e7f598d233f15155050cf6ecd8b099e8c7c8c
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.32.4-1.debian.tar.xz' serd_0.32.4-1.debian.tar.xz 20764 SHA256:7ec6e701933878419978c0ffa9765ecce08becf3f1060b1f38e42d9c08e13f59
```

Other potentially useful URLs:

- https://sources.debian.net/src/serd/0.32.4-1/ (for browsing the source)
- https://sources.debian.net/src/serd/0.32.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/serd/0.32.4-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `spatialindex=2.1.0-1`

Binary Packages:

- `libspatialindex-c8:amd64=2.1.0-1`
- `libspatialindex8:amd64=2.1.0-1`

Licenses: (parsed from: `/usr/share/doc/libspatialindex-c8/copyright`, `/usr/share/doc/libspatialindex8/copyright`)
...
```console
$ apt-get source -qq --print-uris spatialindex=2.1.0-1
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_2.1.0-1.dsc' spatialindex_2.1.0-1.dsc 2207 SHA256:eecbd14037f0545abc7bdb888d5802f083bd84c684f84f9624c19db962e3209d
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_2.1.0.orig.tar.gz' spatialindex_2.1.0.orig.tar.gz 670671 SHA256:a04513cea04dd20ab2c9d153c14cc45692805ee496b30619103f7929f6fb81bf
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_2.1.0-1.debian.tar.xz' spatialindex_2.1.0-1.debian.tar.xz 18392 SHA256:33f9469d49bba0491545f505ee545b09bace0f653a9c7266b2e9d48f5be81b1a
```

Other potentially useful URLs:

- https://sources.debian.net/src/spatialindex/2.1.0-1/ (for browsing the source)
- https://sources.debian.net/src/spatialindex/2.1.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/spatialindex/2.1.0-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `sqlite3=3.46.1-7+deb13u2`
...
```console
$ apt-get source -qq --print-uris sqlite3=3.46.1-7+deb13u2
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.46.1-7%2bdeb13u2.dsc' sqlite3_3.46.1-7+deb13u2.dsc 2673 SHA256:46e1eec171e11108fc436e45309b635b601029726b6ffd3bf435bb474e511638
...
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.46.1-7%2bdeb13u2.debian.tar.xz' sqlite3_3.46.1-7+deb13u2.debian.tar.xz 37084 SHA256:59d33bc436258603702bb051d645743ab03612b82f79e7c7d638c65127c21261
```

Other potentially useful URLs:

- https://sources.debian.net/src/sqlite3/3.46.1-7+deb13u2/ (for browsing the source)
- https://sources.debian.net/src/sqlite3/3.46.1-7+deb13u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/sqlite3/3.46.1-7+deb13u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tzdata=2026c-0+deb13u1`
...
```console
$ apt-get source -qq --print-uris tzdata=2026c-0+deb13u1
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2026c-0%2bdeb13u1.dsc' tzdata_2026c-0+deb13u1.dsc 2466 SHA256:b18d6eddfb23971bacbf569a2641cda837002a813d8e8940d8792ea7ba8e2d4e
...
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2026c-0%2bdeb13u1.debian.tar.xz' tzdata_2026c-0+deb13u1.debian.tar.xz 127148 SHA256:48cd3f42cee2b8ec62ca9c2f4c43cf6c0ec05e1a5ae97f4ed771635811b82f29
```

Other potentially useful URLs:

- https://sources.debian.net/src/tzdata/2026c-0+deb13u1/ (for browsing the source)
...
### `dpkg` source package: `unixodbc=2.3.12-2+deb13u1`

Binary Packages:

- `libodbc2:amd64=2.3.12-2+deb13u1`
- `libodbccr2:amd64=2.3.12-2+deb13u1`
- `libodbcinst2:amd64=2.3.12-2+deb13u1`
- `odbcinst=2.3.12-2+deb13u1`
- `unixodbc-common=2.3.12-2+deb13u1`

Licenses: (parsed from: `/usr/share/doc/libodbc2/copyright`, `/usr/share/doc/libodbccr2/copyright`, `/usr/share/doc/libodbcinst2/copyright`, `/usr/share/doc/odbcinst/copyright`, `/usr/share/doc/unixodbc-common/copyright`)
...
```console
$ apt-get source -qq --print-uris unixodbc=2.3.12-2+deb13u1
...
- https://sources.debian.net/src/unixodbc/2.3.12-2+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/unixodbc/2.3.12-2+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unixodbc/2.3.12-2+deb13u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `yajl=2.1.0-5`
...
```console
$ apt-get source -qq --print-uris yajl=2.1.0-5
'http://deb.debian.org/debian/pool/main/y/yajl/yajl_2.1.0-5.dsc' yajl_2.1.0-5.dsc 1954 SHA256:600912827b535a70463cdf5877cce30b8a20445cc64994dc05d8f2b69589a36e
...
'http://deb.debian.org/debian/pool/main/y/yajl/yajl_2.1.0-5.debian.tar.xz' yajl_2.1.0-5.debian.tar.xz 7148 SHA256:6bd9c7b55c1fc4004cfdab15553ba751af34d3d19c900aef2add5d354e36abc8
```

Other potentially useful URLs:

- https://sources.debian.net/src/yajl/2.1.0-5/ (for browsing the source)
- https://sources.debian.net/src/yajl/2.1.0-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/yajl/2.1.0-5/ (for access to the source package after it no longer exists in the archive)
