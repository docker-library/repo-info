...
```console
$ docker pull python@sha256:f886ad5986b6110ae437de3ccfc837cd94f05317e3ea3456dec3a4941a64f2c0
```
...
### `python:3.13.15-windowsservercore-ltsc2022` - windows version 10.0.20348.5386; amd64
