...
- Created: `2026-09-17T21:56:10.171486852Z`
...
- Environment:
  ...
  - `JAVA_HOME=/usr/lib/jvm/java-27-sapmachine-jre`
...
```console
nspr-4.38.2-r0 description:
Netscape Portable Runtime

nspr-4.38.2-r0 webpage:
https://www.mozilla.org/projects/nspr/

nspr-4.38.2-r0 installed size:
275 KiB

nspr-4.38.2-r0 license:
MPL-2.0
...
```console
nss-3.124-r0 description:
Mozilla Network Security Services

nss-3.124-r0 webpage:
https://developer.mozilla.org/docs/Mozilla/Projects/NSS

nss-3.124-r0 installed size:
3984 KiB

nss-3.124-r0 license:
MPL-2.0

```

### `apk` package: `sapmachine-27-jre`

```console
sapmachine-27-jre-27-r0 description:
The SapMachine Java Runtime Environment

sapmachine-27-jre-27-r0 webpage:
https://sapmachine.io

sapmachine-27-jre-27-r0 installed size:
148 MiB

sapmachine-27-jre-27-r0 license:
