...
### `sapmachine:17.0.20.1-ubuntu` - linux; amd64
...
### `sapmachine:17.0.20.1-ubuntu` - unknown; unknown
...
### `sapmachine:17.0.20.1-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-ubuntu` - linux; ppc64le
