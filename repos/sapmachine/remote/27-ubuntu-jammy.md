...
### `sapmachine:27-ubuntu-jammy` - linux; amd64
...
### `sapmachine:27-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:27-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:27-ubuntu-jammy` - linux; ppc64le
