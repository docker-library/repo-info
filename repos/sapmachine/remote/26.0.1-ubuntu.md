...
### `sapmachine:26.0.1-ubuntu` - linux; amd64
...
### `sapmachine:26.0.1-ubuntu` - unknown; unknown
...
### `sapmachine:26.0.1-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-ubuntu` - linux; ppc64le
