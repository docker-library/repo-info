...
### `sapmachine:27-jre-ubuntu` - linux; amd64
...
### `sapmachine:27-jre-ubuntu` - unknown; unknown
...
### `sapmachine:27-jre-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:27-jre-ubuntu` - linux; ppc64le
