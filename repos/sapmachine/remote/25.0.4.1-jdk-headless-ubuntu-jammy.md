...
### `sapmachine:25.0.4.1-jdk-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:25.0.4.1-jdk-headless-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:25.0.4.1-jdk-headless-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:25.0.4.1-jdk-headless-ubuntu-jammy` - linux; ppc64le
