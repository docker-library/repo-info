...
### `sapmachine:26.0.1-jdk` - linux; amd64
...
### `sapmachine:26.0.1-jdk` - unknown; unknown
...
### `sapmachine:26.0.1-jdk` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jdk` - linux; ppc64le
