...
### `sapmachine:26.0.2-jre-ubuntu` - linux; amd64
...
### `sapmachine:26.0.2-jre-ubuntu` - unknown; unknown
...
### `sapmachine:26.0.2-jre-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:26.0.2-jre-ubuntu` - linux; ppc64le
