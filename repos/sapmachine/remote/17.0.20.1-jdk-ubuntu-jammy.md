...
### `sapmachine:17.0.20.1-jdk-ubuntu-jammy` - linux; amd64
...
### `sapmachine:17.0.20.1-jdk-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:17.0.20.1-jdk-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-jdk-ubuntu-jammy` - linux; ppc64le
