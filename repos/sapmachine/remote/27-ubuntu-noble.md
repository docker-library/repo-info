...
### `sapmachine:27-ubuntu-noble` - linux; amd64
...
### `sapmachine:27-ubuntu-noble` - unknown; unknown
...
### `sapmachine:27-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:27-ubuntu-noble` - linux; ppc64le
