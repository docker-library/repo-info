...
### `sapmachine:27-jdk-headless` - linux; amd64
...
### `sapmachine:27-jdk-headless` - unknown; unknown
...
### `sapmachine:27-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:27-jdk-headless` - linux; ppc64le
