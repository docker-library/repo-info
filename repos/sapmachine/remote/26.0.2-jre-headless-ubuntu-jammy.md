...
### `sapmachine:26.0.2-jre-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:26.0.2-jre-headless-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:26.0.2-jre-headless-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:26.0.2-jre-headless-ubuntu-jammy` - linux; ppc64le
