...
### `sapmachine:25.0.4-jdk-headless-ubuntu` - linux; amd64
...
### `sapmachine:25.0.4-jdk-headless-ubuntu` - unknown; unknown
...
### `sapmachine:25.0.4-jdk-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:25.0.4-jdk-headless-ubuntu` - linux; ppc64le
