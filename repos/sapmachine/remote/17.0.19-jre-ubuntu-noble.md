## `sapmachine:17.0.19-jre-ubuntu-noble`
...
### `sapmachine:17.0.19-jre-ubuntu-noble` - linux; amd64
...
### `sapmachine:17.0.19-jre-ubuntu-noble` - unknown; unknown
...
### `sapmachine:17.0.19-jre-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:17.0.19-jre-ubuntu-noble` - linux; ppc64le
