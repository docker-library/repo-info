## `sapmachine:26.0.1-jre-headless`
...
### `sapmachine:26.0.1-jre-headless` - linux; amd64
...
### `sapmachine:26.0.1-jre-headless` - unknown; unknown
...
### `sapmachine:26.0.1-jre-headless` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jre-headless` - linux; ppc64le
