## `sapmachine:26.0.1-jre-headless-ubuntu`
...
### `sapmachine:26.0.1-jre-headless-ubuntu` - linux; amd64
...
### `sapmachine:26.0.1-jre-headless-ubuntu` - unknown; unknown
...
### `sapmachine:26.0.1-jre-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jre-headless-ubuntu` - linux; ppc64le
