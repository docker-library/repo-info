...
### `sapmachine:21.0.12.1-ubuntu` - linux; amd64
...
### `sapmachine:21.0.12.1-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.12.1-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.12.1-ubuntu` - linux; ppc64le
