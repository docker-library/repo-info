...
### `sapmachine:26-ubuntu` - linux; amd64
...
### `sapmachine:26-ubuntu` - unknown; unknown
...
### `sapmachine:26-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:26-ubuntu` - linux; ppc64le
