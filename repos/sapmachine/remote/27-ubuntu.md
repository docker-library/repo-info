...
### `sapmachine:27-ubuntu` - linux; amd64
...
### `sapmachine:27-ubuntu` - unknown; unknown
...
### `sapmachine:27-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:27-ubuntu` - linux; ppc64le
