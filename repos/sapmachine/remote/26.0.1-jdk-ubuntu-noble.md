## `sapmachine:26.0.1-jdk-ubuntu-noble`
...
### `sapmachine:26.0.1-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:26.0.1-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:26.0.1-jdk-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jdk-ubuntu-noble` - linux; ppc64le
