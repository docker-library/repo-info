## `sapmachine:26.0.2.1-jre-ubuntu-jammy`
...
### `sapmachine:26.0.2.1-jre-ubuntu-jammy` - linux; amd64
...
### `sapmachine:26.0.2.1-jre-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:26.0.2.1-jre-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:26.0.2.1-jre-ubuntu-jammy` - linux; ppc64le
