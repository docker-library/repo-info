...
### `sapmachine:25.0.4.1-jre` - linux; amd64
...
### `sapmachine:25.0.4.1-jre` - unknown; unknown
...
### `sapmachine:25.0.4.1-jre` - linux; arm64 variant v8
...
### `sapmachine:25.0.4.1-jre` - linux; ppc64le
