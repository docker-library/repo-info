...
### `sapmachine:27-jre-headless` - linux; amd64
...
### `sapmachine:27-jre-headless` - unknown; unknown
...
### `sapmachine:27-jre-headless` - linux; arm64 variant v8
...
### `sapmachine:27-jre-headless` - linux; ppc64le
