...
### `sapmachine:lts-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:lts-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:lts-jdk-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:lts-jdk-ubuntu-noble` - linux; ppc64le
