...
### `sapmachine:17.0.20.1-jdk-ubuntu` - linux; amd64
...
### `sapmachine:17.0.20.1-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:17.0.20.1-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-jdk-ubuntu` - linux; ppc64le
