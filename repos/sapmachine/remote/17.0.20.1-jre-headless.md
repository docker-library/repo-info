...
### `sapmachine:17.0.20.1-jre-headless` - linux; amd64
...
### `sapmachine:17.0.20.1-jre-headless` - unknown; unknown
...
### `sapmachine:17.0.20.1-jre-headless` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-jre-headless` - linux; ppc64le
