...
### `sapmachine:25.0.3-ubuntu` - linux; amd64
...
### `sapmachine:25.0.3-ubuntu` - unknown; unknown
...
### `sapmachine:25.0.3-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:25.0.3-ubuntu` - linux; ppc64le
