...
### `sapmachine:21.0.12-jdk-ubuntu` - linux; amd64
...
### `sapmachine:21.0.12-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.12-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.12-jdk-ubuntu` - linux; ppc64le
