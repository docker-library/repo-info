...
### `sapmachine:26.0.2.1-ubuntu-noble` - linux; amd64
...
### `sapmachine:26.0.2.1-ubuntu-noble` - unknown; unknown
...
### `sapmachine:26.0.2.1-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:26.0.2.1-ubuntu-noble` - linux; ppc64le
