...
### `sapmachine:26.0.1-jre` - linux; amd64
...
### `sapmachine:26.0.1-jre` - unknown; unknown
...
### `sapmachine:26.0.1-jre` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jre` - linux; ppc64le
