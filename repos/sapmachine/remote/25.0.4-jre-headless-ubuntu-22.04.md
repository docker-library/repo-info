...
```console
$ docker pull sapmachine@sha256:ad04b09a48535e855dd95650baeb8c582570fca3220b1fb25ffc82ae8e4e14e8
```
...
### `sapmachine:25.0.4-jre-headless-ubuntu-22.04` - linux; amd64
...
### `sapmachine:25.0.4-jre-headless-ubuntu-22.04` - unknown; unknown
...
### `sapmachine:25.0.4-jre-headless-ubuntu-22.04` - linux; arm64 variant v8
...
### `sapmachine:25.0.4-jre-headless-ubuntu-22.04` - linux; ppc64le
