...
### `sapmachine:27-jdk-ubuntu` - linux; amd64
...
### `sapmachine:27-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:27-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:27-jdk-ubuntu` - linux; ppc64le
