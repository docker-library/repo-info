...
### `sapmachine:17.0.20.1-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:17.0.20.1-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:17.0.20.1-jdk-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-jdk-ubuntu-noble` - linux; ppc64le
