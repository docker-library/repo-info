...
### `sapmachine:17.0.20.1-jre-headless-ubuntu-noble` - linux; amd64
...
### `sapmachine:17.0.20.1-jre-headless-ubuntu-noble` - unknown; unknown
...
### `sapmachine:17.0.20.1-jre-headless-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:17.0.20.1-jre-headless-ubuntu-noble` - linux; ppc64le
