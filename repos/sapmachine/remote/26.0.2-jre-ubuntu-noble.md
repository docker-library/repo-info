...
### `sapmachine:26.0.2-jre-ubuntu-noble` - linux; amd64
...
### `sapmachine:26.0.2-jre-ubuntu-noble` - unknown; unknown
...
### `sapmachine:26.0.2-jre-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:26.0.2-jre-ubuntu-noble` - linux; ppc64le
