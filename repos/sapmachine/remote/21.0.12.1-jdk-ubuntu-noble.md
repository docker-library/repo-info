...
### `sapmachine:21.0.12.1-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:21.0.12.1-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:21.0.12.1-jdk-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:21.0.12.1-jdk-ubuntu-noble` - linux; ppc64le
