...
```console
$ docker pull ruby@sha256:2635c8f83247a7d018077855764dca7336be79ef5a67fa415f32fcb9e25c188f
```
...
### `ruby:4.0.6-bookworm` - linux; arm variant v5
...
### `ruby:4.0.6-bookworm` - linux; s390x
