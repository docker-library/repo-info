...
```console
$ docker pull ruby@sha256:f39c4b9da555eb91ebe0764bc26974b388c569a963f33437af66bdd97ea1c387
```
...
### `ruby:4.0.6-alpine3.23` - linux; amd64
...
### `ruby:4.0.6-alpine3.23` - unknown; unknown
...
### `ruby:4.0.6-alpine3.23` - linux; arm variant v6
...
### `ruby:4.0.6-alpine3.23` - linux; arm variant v7
...
### `ruby:4.0.6-alpine3.23` - linux; arm64 variant v8
...
### `ruby:4.0.6-alpine3.23` - linux; 386
...
### `ruby:4.0.6-alpine3.23` - linux; ppc64le
...
### `ruby:4.0.6-alpine3.23` - linux; s390x
