...
- Created: `2026-08-25T01:42:39.418271027Z`
- Virtual Size: ~ 336.91 Mb  
...
- Environment:
  ...
  - `INFLUXDB_VERSION=1.13.0-c1.13.0`
  - `INFLUXDB_PR=`
  - `INFLUXDB_PV=1.13.0-c1.13.0`
...
### `dpkg` source package: `influxdb-data=1.13.0-c1.13.0`

Binary Packages:

- `influxdb-data=1.13.0-c1.13.0`
