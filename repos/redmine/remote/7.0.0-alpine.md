...
### `redmine:7.0.0-alpine` - linux; amd64
...
### `redmine:7.0.0-alpine` - unknown; unknown
...
### `redmine:7.0.0-alpine` - linux; arm64 variant v8
...
### `redmine:7.0.0-alpine` - linux; ppc64le
...
### `redmine:7.0.0-alpine` - linux; riscv64
...
### `redmine:7.0.0-alpine` - linux; s390x
