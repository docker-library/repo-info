...
- Created: `2026-07-16T00:18:39.98794121Z`
- Virtual Size: ~ 106.87 Mb  
...
```console
nginx-1.30.4-r1 description:
High performance web server

nginx-1.30.4-r1 webpage:
https://nginx.org/

nginx-1.30.4-r1 installed size:
2744 KiB

nginx-1.30.4-r1 license:
...
```console
nginx-module-acme-1.30.4.0.4.1-r1 description:
nginx nginx-acme

nginx-module-acme-1.30.4.0.4.1-r1 webpage:
https://nginx.org/

nginx-module-acme-1.30.4.0.4.1-r1 installed size:
8167 KiB

nginx-module-acme-1.30.4.0.4.1-r1 license:
2-clause BSD-like license
...
```console
nginx-module-geoip-1.30.4-r1 description:
nginx GeoIP dynamic modules

nginx-module-geoip-1.30.4-r1 webpage:
https://nginx.org/

nginx-module-geoip-1.30.4-r1 installed size:
62 KiB

nginx-module-geoip-1.30.4-r1 license:
2-clause BSD-like license
...
```console
nginx-module-image-filter-1.30.4-r1 description:
nginx image filter dynamic module

nginx-module-image-filter-1.30.4-r1 webpage:
https://nginx.org/

nginx-module-image-filter-1.30.4-r1 installed size:
46 KiB

nginx-module-image-filter-1.30.4-r1 license:
2-clause BSD-like license
...
```console
nginx-module-otel-1.30.4.0.1.2-r1 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.30.4.0.1.2-r1 webpage:
https://nginx.org/

nginx-module-otel-1.30.4.0.1.2-r1 installed size:
700 KiB

nginx-module-otel-1.30.4.0.1.2-r1 license:
2-clause BSD-like license
...
```console
nginx-module-xslt-1.30.4-r1 description:
nginx xslt dynamic module

nginx-module-xslt-1.30.4-r1 webpage:
https://nginx.org/

nginx-module-xslt-1.30.4-r1 installed size:
46 KiB

nginx-module-xslt-1.30.4-r1 license:
2-clause BSD-like license
