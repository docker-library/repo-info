...
- Created: `2026-09-17T23:17:04.360173981Z`
...
```console
nginx-module-otel-1.31.6.0.1.2-r1 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.31.6.0.1.2-r1 webpage:
https://nginx.org/

nginx-module-otel-1.31.6.0.1.2-r1 installed size:
600 KiB

nginx-module-otel-1.31.6.0.1.2-r1 license:
2-clause BSD-like license
