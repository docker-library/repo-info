...
- Created: `2026-07-16T00:18:24.123661633Z`
...
```console
nginx-module-perl-1.30.4-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.30.4-r1 webpage:
https://nginx.org/

nginx-module-perl-1.30.4-r1 installed size:
85 KiB

nginx-module-perl-1.30.4-r1 license:
2-clause BSD-like license
