...
- Created: `2026-09-02T21:48:27.319857054Z`
...
```console
nginx-module-perl-1.31.5-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.31.5-r1 webpage:
https://nginx.org/

nginx-module-perl-1.31.5-r1 installed size:
85 KiB

nginx-module-perl-1.31.5-r1 license:
2-clause BSD-like license
