...
### `nginx:1.31.3-alpine3.24` - linux; amd64
...
### `nginx:1.31.3-alpine3.24` - unknown; unknown
...
### `nginx:1.31.3-alpine3.24` - linux; arm variant v6
...
### `nginx:1.31.3-alpine3.24` - linux; arm variant v7
...
### `nginx:1.31.3-alpine3.24` - linux; arm64 variant v8
...
### `nginx:1.31.3-alpine3.24` - linux; 386
...
### `nginx:1.31.3-alpine3.24` - linux; ppc64le
...
### `nginx:1.31.3-alpine3.24` - linux; riscv64
...
### `nginx:1.31.3-alpine3.24` - linux; s390x
