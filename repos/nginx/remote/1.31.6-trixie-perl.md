...
```console
$ docker pull nginx@sha256:c4a2f92e690e4fb2edd216a8e8cb06b0505fe955b324cf21f01a93d09b2ce9dc
```
...
### `nginx:1.31.6-trixie-perl` - linux; amd64
...
### `nginx:1.31.6-trixie-perl` - unknown; unknown
...
### `nginx:1.31.6-trixie-perl` - linux; arm variant v5
...
### `nginx:1.31.6-trixie-perl` - linux; arm variant v7
...
### `nginx:1.31.6-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.31.6-trixie-perl` - linux; 386
...
### `nginx:1.31.6-trixie-perl` - linux; ppc64le
...
### `nginx:1.31.6-trixie-perl` - linux; s390x
