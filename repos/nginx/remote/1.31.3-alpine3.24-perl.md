...
```console
$ docker pull nginx@sha256:5a1b9b3dd82ce370617a2ad9825c03b354415b2f74f856a54273a5ec6052cb38
```
...
### `nginx:1.31.3-alpine3.24-perl` - linux; amd64
...
### `nginx:1.31.3-alpine3.24-perl` - unknown; unknown
...
### `nginx:1.31.3-alpine3.24-perl` - linux; arm variant v6
...
### `nginx:1.31.3-alpine3.24-perl` - linux; arm variant v7
...
### `nginx:1.31.3-alpine3.24-perl` - linux; arm64 variant v8
...
### `nginx:1.31.3-alpine3.24-perl` - linux; 386
...
### `nginx:1.31.3-alpine3.24-perl` - linux; ppc64le
...
### `nginx:1.31.3-alpine3.24-perl` - linux; riscv64
...
### `nginx:1.31.3-alpine3.24-perl` - linux; s390x
