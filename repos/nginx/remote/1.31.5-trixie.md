...
```console
$ docker pull nginx@sha256:db3099a8d62d2bd8f5f7875e6e3d2dfbd92c999cd35967fb05d41374386535e1
```
...
### `nginx:1.31.5-trixie` - linux; amd64
...
### `nginx:1.31.5-trixie` - unknown; unknown
...
### `nginx:1.31.5-trixie` - linux; arm variant v5
...
### `nginx:1.31.5-trixie` - linux; arm variant v7
...
### `nginx:1.31.5-trixie` - linux; arm64 variant v8
...
### `nginx:1.31.5-trixie` - linux; ppc64le
...
### `nginx:1.31.5-trixie` - linux; s390x
