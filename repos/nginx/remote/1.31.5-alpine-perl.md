...
```console
$ docker pull nginx@sha256:9c0cd54a2f03e1c7d8e9973ac60f112dd988d04049a6fee49fbd994ce9f39057
```
...
### `nginx:1.31.5-alpine-perl` - linux; amd64
...
### `nginx:1.31.5-alpine-perl` - unknown; unknown
...
### `nginx:1.31.5-alpine-perl` - linux; arm variant v6
...
### `nginx:1.31.5-alpine-perl` - linux; arm variant v7
...
### `nginx:1.31.5-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.31.5-alpine-perl` - linux; 386
...
### `nginx:1.31.5-alpine-perl` - linux; ppc64le
...
### `nginx:1.31.5-alpine-perl` - linux; riscv64
...
### `nginx:1.31.5-alpine-perl` - linux; s390x
