...
```console
$ docker pull nginx@sha256:34f40471dea485273c5e2a04dd5e97a682332ceb4a9adecd67de450dcb2fb390
```
...
### `nginx:1.31.5-alpine3.24` - linux; amd64
...
### `nginx:1.31.5-alpine3.24` - unknown; unknown
...
### `nginx:1.31.5-alpine3.24` - linux; arm variant v6
...
### `nginx:1.31.5-alpine3.24` - linux; arm variant v7
...
### `nginx:1.31.5-alpine3.24` - linux; arm64 variant v8
...
### `nginx:1.31.5-alpine3.24` - linux; 386
...
### `nginx:1.31.5-alpine3.24` - linux; ppc64le
...
### `nginx:1.31.5-alpine3.24` - linux; s390x
