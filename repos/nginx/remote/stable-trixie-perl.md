...
```console
$ docker pull nginx@sha256:b4e074db247b80902b2fde4b46c7123f4f7d79397a4d020bdf083268d47c39f6
```
...
```console
$ docker pull nginx@sha256:7bc5e8ff8ff22728b47cf472a2f1815f76361c481eafe1c313608c99c1d4d42c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.1 MB (80113686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c29474882eea7138b847890ee028492c31adb4ae4e1bb0e7ab79fc6cfec47a8c`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:e2339be4ce737d3a96c4990398cd4f99d1da02d06f69f964f4d71cdecc3c4365`  
		...
		Size: 1.4 KB (1399 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:424d590f022f364dbd8f26a134abd0efcaa63ce1beb01f0c8882cf17be120093`  
		Last Modified: Tue, 14 Jul 2026 11:50:55 GMT  
		Size: 12.9 MB (12900139 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:stable-trixie-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:ef46d2f028bf9d1146d3bfcbf445e7114cacf2904966dcb4c8b7c019ea099d32
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4301320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:faa4c39741340a157c6ee5d4efce90e1f59673e203098a7c0cdd46068b278ef5`

```dockerfile
```

-	Layers:
	-	`sha256:5205f233ce8dda254630822b44b81c0f482cab99db5d8015fb110881706993ff`  
		Last Modified: Tue, 14 Jul 2026 11:50:55 GMT  
		Size: 4.3 MB (4278043 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:19a6487b0cb0715b2636d65f838b6c012095040cc14606a53d35e007b6ca21d8`  
