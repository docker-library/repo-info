...
```console
$ docker pull nginx@sha256:865bd567ede55893f380ae4548ef74363611136fadbdd7b7f46ac0e8a976582a
```
...
### `nginx:1.31.6-alpine3.24-slim` - linux; amd64
...
### `nginx:1.31.6-alpine3.24-slim` - unknown; unknown
...
### `nginx:1.31.6-alpine3.24-slim` - linux; arm variant v6
...
### `nginx:1.31.6-alpine3.24-slim` - linux; arm variant v7
...
### `nginx:1.31.6-alpine3.24-slim` - linux; arm64 variant v8
...
### `nginx:1.31.6-alpine3.24-slim` - linux; 386
...
### `nginx:1.31.6-alpine3.24-slim` - linux; ppc64le
...
### `nginx:1.31.6-alpine3.24-slim` - linux; riscv64
