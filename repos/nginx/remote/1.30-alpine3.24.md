...
```console
$ docker pull nginx@sha256:02b1b2a0445514891a14aa371845f6085d5d9d10d385b30d6aad606a50a29a05
```
...
### `nginx:1.30-alpine3.24` - linux; amd64
...
### `nginx:1.30-alpine3.24` - unknown; unknown
...
### `nginx:1.30-alpine3.24` - linux; arm variant v6
...
### `nginx:1.30-alpine3.24` - linux; arm variant v7
...
### `nginx:1.30-alpine3.24` - linux; arm64 variant v8
...
### `nginx:1.30-alpine3.24` - linux; 386
...
### `nginx:1.30-alpine3.24` - linux; ppc64le
...
### `nginx:1.30-alpine3.24` - linux; riscv64
...
### `nginx:1.30-alpine3.24` - linux; s390x
