...
### `nginx:alpine3.24` - unknown; unknown
...
### `nginx:alpine3.24` - linux; arm variant v6
...
### `nginx:alpine3.24` - linux; arm variant v7
...
### `nginx:alpine3.24` - linux; arm64 variant v8
...
### `nginx:alpine3.24` - linux; ppc64le
...
### `nginx:alpine3.24` - linux; riscv64
