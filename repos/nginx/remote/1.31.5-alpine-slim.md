...
```console
$ docker pull nginx@sha256:ac8c92d192f5d66410fae6fbb3addac897c3bb690e221303588e3b32373972c1
```
...
### `nginx:1.31.5-alpine-slim` - linux; amd64
...
### `nginx:1.31.5-alpine-slim` - unknown; unknown
...
### `nginx:1.31.5-alpine-slim` - linux; arm variant v6
...
### `nginx:1.31.5-alpine-slim` - linux; arm variant v7
...
### `nginx:1.31.5-alpine-slim` - linux; arm64 variant v8
...
### `nginx:1.31.5-alpine-slim` - linux; 386
...
### `nginx:1.31.5-alpine-slim` - linux; ppc64le
...
### `nginx:1.31.5-alpine-slim` - linux; s390x
