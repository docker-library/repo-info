...
- Created: `2022-09-20T20:24:34.090552331Z`
- Virtual Size: ~ 825.79 Mb  
...
### `rpm` package: `deltarpm-3.6-3.el7.x86_64`
...
```console
$ dnf --quiet download --source --url deltarpm-3.6-3.el7
http://vault.centos.org/centos/7/os/Source/SPackages/deltarpm-3.6-3.el7.src.rpm
```
