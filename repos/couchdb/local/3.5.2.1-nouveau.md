...
Licenses: (parsed from: `/usr/share/doc/apt/copyright`, `/usr/share/doc/apt-transport-https/copyright`, `/usr/share/doc/libapt-pkg7.0/copyright`)
...
'http://deb.debian.org/debian/pool/main/c/ca-certificates-java/ca-certificates-java_20240118.dsc' ca-certificates-java_20240118.dsc 1939 SHA256:1b69c89b50f705bbe70ea19add2937c331dc02539f0630a87a4db86e734368b9
'http://deb.debian.org/debian/pool/main/c/ca-certificates-java/ca-certificates-java_20240118.tar.xz' ca-certificates-java_20240118.tar.xz 19104 SHA256:41eed3fec4fac8d32b20d744059151749ed4077f55644623fdd2d15bc51d8e57
```

Other potentially useful URLs:

- https://sources.debian.net/src/ca-certificates-java/20240118/ (for browsing the source)
- https://sources.debian.net/src/ca-certificates-java/20240118/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ca-certificates-java/20240118/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `nspr=2:4.36-1`
...
```console
$ apt-get source -qq --print-uris nspr=2:4.36-1
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.36-1.dsc' nspr_4.36-1.dsc 2000 SHA256:0654be27e3cbe2ccc704b293effc12d05c6bbcb2c3da90de5c5ebf53734e6064
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.36.orig.tar.gz' nspr_4.36.orig.tar.gz 1036274 SHA256:55dec317f1401cd2e5dba844d340b930ab7547f818179a4002bce62e6f1c6895
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.36-1.debian.tar.xz' nspr_4.36-1.debian.tar.xz 11264 SHA256:f48d96dc446d689aaee085e827d7ef08d5cea850d4eea98080910f378880eeed
```

Other potentially useful URLs:

- https://sources.debian.net/src/nspr/2:4.36-1/ (for browsing the source)
...
### `dpkg` source package: `pcsc-lite=2.3.3-1`
...
```console
$ apt-get source -qq --print-uris pcsc-lite=2.3.3-1
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_2.3.3-1.dsc' pcsc-lite_2.3.3-1.dsc 2394 SHA256:196b3a5967bb805c4382d8428a39f9c7df01846c4e42c906131baedef5bfa5ee
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_2.3.3.orig.tar.xz' pcsc-lite_2.3.3.orig.tar.xz 210592 SHA256:cdff7d7153a0b37aa74e26dfec89ec7dc5c5286aa21b91b903e38739d227e8e7
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_2.3.3.orig.tar.xz.asc' pcsc-lite_2.3.3.orig.tar.xz.asc 833 SHA256:725840eeaff8d69a0410e4fd16a5b715a409a9c76c65a288b7b5e6422812d83e
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_2.3.3-1.debian.tar.xz' pcsc-lite_2.3.3-1.debian.tar.xz 20420 SHA256:9026853375fc014f5d0052f5b6daf7f1d14e821e72f79d4f6c78ce1e3e1eb0e4
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcsc-lite/2.3.3-1/ (for browsing the source)
- https://sources.debian.net/src/pcsc-lite/2.3.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pcsc-lite/2.3.3-1/ (for access to the source package after it no longer exists in the archive)
