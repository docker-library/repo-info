...
- Created: `2026-07-27T22:08:37.973376221Z`
- Virtual Size: ~ 933.83 Mb  
...
### `rpm` package: `bzip2-1.0.8-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url bzip2-1.0.8-11.el9
...
### `rpm` package: `mysql-community-server-minimal-9.7.2-1.el9.x86_64`
...
### `rpm` package: `mysql-shell-9.7.1-1.el9.x86_64`
