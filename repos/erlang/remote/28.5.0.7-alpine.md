...
```console
$ docker pull erlang@sha256:3a5cb9b1bd46230f19c5d15a9e01be815b6a71ef0545c61f6060fe5484968a4e
```
...
### `erlang:28.5.0.7-alpine` - linux; arm variant v7
...
### `erlang:28.5.0.7-alpine` - unknown; unknown
...
### `erlang:28.5.0.7-alpine` - linux; arm64 variant v8
...
### `erlang:28.5.0.7-alpine` - linux; 386
...
### `erlang:28.5.0.7-alpine` - linux; ppc64le
...
### `erlang:28.5.0.7-alpine` - linux; s390x
