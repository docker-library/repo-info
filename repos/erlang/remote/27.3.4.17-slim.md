...
### `erlang:27.3.4.17-slim` - linux; amd64
...
### `erlang:27.3.4.17-slim` - unknown; unknown
...
### `erlang:27.3.4.17-slim` - linux; arm variant v7
...
### `erlang:27.3.4.17-slim` - linux; arm64 variant v8
...
### `erlang:27.3.4.17-slim` - linux; 386
