...
```console
$ docker pull rust@sha256:34fb2f168c432d421a09883c663b275b33cbb30f6b18642fbd09a684c6546d0e
```
...
### `rust:1.97-slim-trixie` - linux; amd64
...
### `rust:1.97-slim-trixie` - unknown; unknown
...
### `rust:1.97-slim-trixie` - linux; arm variant v7
...
### `rust:1.97-slim-trixie` - linux; arm64 variant v8
...
### `rust:1.97-slim-trixie` - linux; 386
...
### `rust:1.97-slim-trixie` - linux; ppc64le
...
### `rust:1.97-slim-trixie` - linux; riscv64
...
### `rust:1.97-slim-trixie` - linux; s390x
