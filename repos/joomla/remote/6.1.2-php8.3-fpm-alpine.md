...
```console
$ docker pull joomla@sha256:3bca9ca2314f41c77fc0146238cbca28e8ca2587e06b40af6d5394f550956c2a
```
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; amd64
...
### `joomla:6.1.2-php8.3-fpm-alpine` - unknown; unknown
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; arm variant v6
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; arm variant v7
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; 386
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; ppc64le
...
### `joomla:6.1.2-php8.3-fpm-alpine` - linux; s390x
