...
```console
$ docker pull joomla@sha256:8a14cef857be611272863ab357a4e20d3b38248d9039ba755e53930e5dd3bf3c
```
...
### `joomla:5.4.6-php8.2-apache` - linux; amd64
...
### `joomla:5.4.6-php8.2-apache` - unknown; unknown
...
### `joomla:5.4.6-php8.2-apache` - linux; arm variant v5
...
### `joomla:5.4.6-php8.2-apache` - linux; arm variant v7
...
### `joomla:5.4.6-php8.2-apache` - linux; arm64 variant v8
...
### `joomla:5.4.6-php8.2-apache` - linux; 386
...
### `joomla:5.4.6-php8.2-apache` - linux; ppc64le
...
### `joomla:5.4.6-php8.2-apache` - linux; riscv64
...
### `joomla:5.4.6-php8.2-apache` - linux; s390x
