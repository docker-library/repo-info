...
```console
$ docker pull joomla@sha256:779d5a627682f3b0b3a1743b1d49a6378ce84e795878f92c8264d5e1156248a7
```
...
### `joomla:5.4.6-php8.2-fpm` - linux; amd64
...
### `joomla:5.4.6-php8.2-fpm` - unknown; unknown
...
### `joomla:5.4.6-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.4.6-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.4.6-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.4.6-php8.2-fpm` - linux; 386
...
### `joomla:5.4.6-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.4.6-php8.2-fpm` - linux; riscv64
...
### `joomla:5.4.6-php8.2-fpm` - linux; s390x
