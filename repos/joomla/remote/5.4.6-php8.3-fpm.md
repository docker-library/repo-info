...
```console
$ docker pull joomla@sha256:b882b6742ce05f0416b2b2db1ccd040798083d7a2ac2ef18bf5a6c4eeb54dfff
```
...
### `joomla:5.4.6-php8.3-fpm` - linux; amd64
...
### `joomla:5.4.6-php8.3-fpm` - unknown; unknown
...
### `joomla:5.4.6-php8.3-fpm` - linux; arm variant v5
...
### `joomla:5.4.6-php8.3-fpm` - linux; arm variant v7
...
### `joomla:5.4.6-php8.3-fpm` - linux; arm64 variant v8
...
### `joomla:5.4.6-php8.3-fpm` - linux; 386
...
### `joomla:5.4.6-php8.3-fpm` - linux; ppc64le
...
### `joomla:5.4.6-php8.3-fpm` - linux; riscv64
...
### `joomla:5.4.6-php8.3-fpm` - linux; s390x
