...
### `joomla:5.4.6-apache` - linux; amd64
...
### `joomla:5.4.6-apache` - unknown; unknown
...
### `joomla:5.4.6-apache` - linux; arm variant v5
...
### `joomla:5.4.6-apache` - linux; arm variant v7
...
### `joomla:5.4.6-apache` - linux; arm64 variant v8
...
### `joomla:5.4.6-apache` - linux; ppc64le
...
### `joomla:5.4.6-apache` - linux; riscv64
...
### `joomla:5.4.6-apache` - linux; s390x
