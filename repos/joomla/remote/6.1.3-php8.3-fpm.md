...
```console
$ docker pull joomla@sha256:21d58b1dd8f16adb3d0f4d2656c101bb809ed81ad08c91c4c388ff0efff84386
```
...
### `joomla:6.1.3-php8.3-fpm` - linux; amd64
...
### `joomla:6.1.3-php8.3-fpm` - unknown; unknown
...
### `joomla:6.1.3-php8.3-fpm` - linux; arm variant v5
...
### `joomla:6.1.3-php8.3-fpm` - linux; arm variant v7
...
### `joomla:6.1.3-php8.3-fpm` - linux; arm64 variant v8
...
### `joomla:6.1.3-php8.3-fpm` - linux; 386
...
### `joomla:6.1.3-php8.3-fpm` - linux; ppc64le
...
### `joomla:6.1.3-php8.3-fpm` - linux; s390x
