...
- Created: `2026-09-24T19:38:33.620226672Z`
- Virtual Size: ~ 787.84 Mb  
...
### `dpkg` source package: `jbig2dec=0.20-1+deb13u1`

Binary Packages:

- `libjbig2dec0:amd64=0.20-1+deb13u1`
...
```console
$ apt-get source -qq --print-uris jbig2dec=0.20-1+deb13u1
...
- https://sources.debian.net/src/jbig2dec/0.20-1+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/jbig2dec/0.20-1+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jbig2dec/0.20-1+deb13u1/ (for access to the source package after it no longer exists in the archive)
