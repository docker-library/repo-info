...
- Created: `2026-07-14T02:29:56.982324207Z`
...
- `curl=8.21.0-2`
- `libcurl3t64-gnutls:amd64=8.21.0-2`
...
### `dpkg` source package: `libpsl=0.23.0-1`

Binary Packages:

- `libpsl5t64:amd64=0.23.0-1`
...
### `dpkg` source package: `openssh=1:10.4p1-1`

Binary Packages:

- `openssh-client=1:10.4p1-1`
- `openssh-common=1:10.4p1-1`
...
### `dpkg` source package: `systemd=261.1-3`

Binary Packages:

- `libsystemd-shared:amd64=261.1-3`
- `libsystemd0:amd64=261.1-3`
- `libudev1:amd64=261.1-3`
- `systemd=261.1-3`
...
```console
$ apt-get source -qq --print-uris systemd=261.1-3
'http://deb.debian.org/debian/pool/main/s/systemd/systemd_261.1-3.dsc' systemd_261.1-3.dsc 8848 SHA256:a4637cc8c672daebb3df4e193ed4975928c046471ee3b1ff961432623905dc9a
...
'http://deb.debian.org/debian/pool/main/s/systemd/systemd_261.1-3.debian.tar.xz' systemd_261.1-3.debian.tar.xz 189636 SHA256:a71633a2f335ccc58c0d3d36d63f939dbea4f9af97620fbedf5c45c5880a4845
```

Other potentially useful URLs:

- https://sources.debian.net/src/systemd/261.1-3/ (for browsing the source)
- https://sources.debian.net/src/systemd/261.1-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/systemd/261.1-3/ (for access to the source package after it no longer exists in the archive)
