...
- Created: `2026-09-22T18:52:53.489314858Z`
...
- Environment:
  ...
  - `SWIFT_BRANCH=swift-6.4.0-release`
  - `SWIFT_VERSION=swift-6.4.0-RELEASE`
  - `SWIFT_WEBROOT=https://download.swift.org`
- Labels:
  - `architecture=x86_64`
  - `build-date=2026-09-22T11:15:31Z`
  ...
  - `name=ubi10/ubi`
  - `org.opencontainers.image.created=2026-09-22T11:15:31Z`
  - `org.opencontainers.image.revision=722ce2d831882d64cc239d0c97dbd8e895bc5dbd`
  - `release=1790075508`
  - `summary=Provides the latest release of Red Hat Universal Base Image 10.`
  - `url=https://catalog.redhat.com/en/search?searchType=containers`
  - `vcs-ref=722ce2d831882d64cc239d0c97dbd8e895bc5dbd`
  - `vcs-type=git`
  - `vendor=Red Hat, Inc.`
  - `version=10.2`
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/a/attr-2.6.0-1.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/c/crypto-policies-20260216-1.git0e54016.el10_2.2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/d/dbus-broker-36-5.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/e/expat-2.7.3-1.el10_2.3.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/g/glib2-2.80.4-12.el10_2.22.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/g/gzip-1.13-4.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/l/libevent-2.1.13-1.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/p/pam-1.6.1-9.el10_2.1.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/s/sqlite-3.46.1-6.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/t/tar-1.35-13.el10_2.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi10/10/x86_64/baseos/source/SRPMS/Packages/x/xz-5.6.2-4.el10_2.1.src.rpm
```
