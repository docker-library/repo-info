...
- Created: `2026-07-03T00:30:24.018730681Z`
...
- Labels:
  ...
  - `name=ubi9/ubi`
  - `org.opencontainers.image.created=2026-06-30T17:49:35Z`
  - `org.opencontainers.image.revision=f55fcf2a35c9fe343a15bb3cfbc2f2ee52a0d6a1`
  - `release=1782841664`
...
### `rpm` package: `vim-minimal-8.2.2637-26.el9_8.6.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-26.el9_8.6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/v/vim-8.2.2637-26.el9_8.6.src.rpm
```
