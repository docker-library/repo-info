...
- Created: `2026-07-16T00:27:26.177922015Z`
- Virtual Size: ~ 3.87 Gb  
...
### `rpm` package: `glibc-devel-2.34-272.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-272.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-272.el9_8.src.rpm
```

### `rpm` package: `glibc-headers-2.34-272.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-272.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-272.el9_8.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-687.26.1.el9_8.x86_64`
...
### `rpm` package: `python3-devel-3.9.25-7.el9_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-devel-3.9.25-7.el9_8.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.25-7.el9_8.2.src.rpm
```
