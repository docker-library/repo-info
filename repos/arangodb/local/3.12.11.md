...
- Created: `2026-08-31T19:07:13.832031148Z`
...
```console
numactl-2.0.19-r0 description:
Simple NUMA policy support

numactl-2.0.19-r0 webpage:
https://github.com/numactl/numactl

numactl-2.0.19-r0 installed size:
50 KiB

numactl-2.0.19-r0 license:
LGPL-2.1-only
...
```console
numactl-tools-2.0.19-r0 description:
NUMA policy control tools

numactl-tools-2.0.19-r0 webpage:
https://github.com/numactl/numactl

numactl-tools-2.0.19-r0 installed size:
145 KiB

numactl-tools-2.0.19-r0 license:
GPL-2.0-only
