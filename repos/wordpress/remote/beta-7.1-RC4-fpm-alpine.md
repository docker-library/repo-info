...
```console
$ docker pull wordpress@sha256:6f13db476f4ec667fa5879db1219e32c60d8b4f5f58e0c23922ce79978cc793e
```
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-fpm-alpine` - linux; s390x
