...
```console
$ docker pull wordpress@sha256:1d64606dae40c09ed3c39c23f9a8eec94cfac0040e94ba7b7bd07703ba5fa7a9
```
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.2-php8.4-fpm-alpine` - linux; s390x
