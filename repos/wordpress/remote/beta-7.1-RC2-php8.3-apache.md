...
```console
$ docker pull wordpress@sha256:7e06693e4786f04cb6b4027e5e37b782bfe92b77d1b975929243f91cec61f9af
```
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.3-apache` - linux; s390x
