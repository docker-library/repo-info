...
```console
$ docker pull wordpress@sha256:d65469d6f40a3e72b4f816ff7edac141e0496b471f4970ee077ad6b089df0517
```
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.5-fpm-alpine` - linux; s390x
