## `wordpress:7.0.4-php8.5-apache`

```console
$ docker pull wordpress@sha256:938e20e0ba412da1111a8ac8c03caad3719ac6a1aef4929aeaa16aab590d0d9f
```
...
### `wordpress:7.0.4-php8.5-apache` - linux; amd64
...
### `wordpress:7.0.4-php8.5-apache` - unknown; unknown
...
### `wordpress:7.0.4-php8.5-apache` - linux; arm variant v5
...
### `wordpress:7.0.4-php8.5-apache` - linux; arm variant v7
...
### `wordpress:7.0.4-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:7.0.4-php8.5-apache` - linux; 386
...
### `wordpress:7.0.4-php8.5-apache` - linux; ppc64le
...
### `wordpress:7.0.4-php8.5-apache` - linux; s390x
