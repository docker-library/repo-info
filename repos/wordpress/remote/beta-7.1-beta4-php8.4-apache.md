...
```console
$ docker pull wordpress@sha256:a3d4b093c5063a651b37113388ba283ab904149310e6d5c3ee59bc9a90fe8a6c
```
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-beta4-php8.4-apache` - linux; s390x
