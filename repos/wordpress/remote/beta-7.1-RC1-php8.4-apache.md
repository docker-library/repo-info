...
```console
$ docker pull wordpress@sha256:366145e9c321671454104157f318607f3c260b85b405ab9c7530cebfd18ca457
```
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.4-apache` - linux; s390x
