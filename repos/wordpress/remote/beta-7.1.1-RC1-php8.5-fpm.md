...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; amd64
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - unknown; unknown
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; 386
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1.1-RC1-php8.5-fpm` - linux; s390x
