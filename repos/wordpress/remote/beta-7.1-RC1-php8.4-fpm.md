...
```console
$ docker pull wordpress@sha256:18e1d7a8c9ee12a1548864be2ba83cac6c6800e84ccbf33485c485afd61319b9
```
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.4-fpm` - linux; s390x
