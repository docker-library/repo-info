...
```console
$ docker pull wordpress@sha256:3043051bcc01612fdc6d55c77de1b9aaa4dcf03d76bf59172fcaa5480058a122
```
...
### `wordpress:7.1.2-php8.2-fpm` - linux; amd64
...
### `wordpress:7.1.2-php8.2-fpm` - unknown; unknown
...
### `wordpress:7.1.2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:7.1.2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:7.1.2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:7.1.2-php8.2-fpm` - linux; 386
...
### `wordpress:7.1.2-php8.2-fpm` - linux; ppc64le
...
### `wordpress:7.1.2-php8.2-fpm` - linux; s390x
