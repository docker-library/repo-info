...
```console
$ docker pull wordpress@sha256:18bb0a3aa5341b43a7eb0dc63f8f3ab4e1257eaa21170bb02824219594729f56
```
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; amd64
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - unknown; unknown
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; 386
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-beta1-php8.2-apache` - linux; s390x
