...
```console
$ docker pull wordpress@sha256:40695e7965b0995514656acba2f471c781e97ac23c8a8c7e078d3497bb852f99
```
...
### `wordpress:7.0.4-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.4-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.4-fpm-alpine` - linux; 386
...
### `wordpress:7.0.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.4-fpm-alpine` - linux; s390x
