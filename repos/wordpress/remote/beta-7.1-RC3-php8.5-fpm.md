...
```console
$ docker pull wordpress@sha256:0fb611d5e85237cc5fca04d483134660032e0485f988198ed836d834973ed410
```
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-RC3-php8.5-fpm` - linux; s390x
