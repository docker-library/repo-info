...
```console
$ docker pull wordpress@sha256:f9b78d1c2a9114a5fdfce5d665552a36ad881c6d4ca1b29aebef47d226963e26
```
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta4-php8.5-fpm-alpine` - linux; s390x
