...
```console
$ docker pull wordpress@sha256:3dfd38be945c7588979ef87e097269dc4ed22b19fe16e4430b5649f890f2c494
```
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.5-fpm-alpine` - linux; s390x
