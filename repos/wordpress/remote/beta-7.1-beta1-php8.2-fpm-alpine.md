...
```console
$ docker pull wordpress@sha256:d0e2112973bfee3bcef8da2fdac8ef8f798d5e149850bf781a50d4f0dc7e5cbf
```
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta1-php8.2-fpm-alpine` - linux; s390x
