...
```console
$ docker pull wordpress@sha256:29b5afb02f0f282f52220747eb59f0355204276b705e406d278cbcb0aedf436d
```
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.1.1-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1.1-php8.4-fpm` - linux; s390x
