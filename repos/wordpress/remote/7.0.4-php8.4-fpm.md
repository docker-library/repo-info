...
```console
$ docker pull wordpress@sha256:c102119039537984d5e324bc64ea81057774aaad6ca3a478a561af8a0151775f
```
...
### `wordpress:7.0.4-php8.4-fpm` - linux; amd64
...
### `wordpress:7.0.4-php8.4-fpm` - unknown; unknown
...
### `wordpress:7.0.4-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:7.0.4-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:7.0.4-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.4-php8.4-fpm` - linux; 386
...
### `wordpress:7.0.4-php8.4-fpm` - linux; ppc64le
...
### `wordpress:7.0.4-php8.4-fpm` - linux; s390x
