...
```console
$ docker pull wordpress@sha256:4b61b22df40b860dcbc630eb389e72f72fbbd41275be240427eb4dbba2f991d0
```
...
### `wordpress:7.0.2-php8.5-fpm` - linux; amd64
...
### `wordpress:7.0.2-php8.5-fpm` - unknown; unknown
...
### `wordpress:7.0.2-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:7.0.2-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:7.0.2-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.2-php8.5-fpm` - linux; 386
...
### `wordpress:7.0.2-php8.5-fpm` - linux; ppc64le
...
### `wordpress:7.0.2-php8.5-fpm` - linux; s390x
