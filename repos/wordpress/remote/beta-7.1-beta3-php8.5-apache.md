...
```console
$ docker pull wordpress@sha256:047e9ae60ae50a0f02fdf1adbf76079781b72b8c339b37df006c74385a7f190d
```
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; amd64
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - unknown; unknown
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; 386
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-beta3-php8.5-apache` - linux; s390x
