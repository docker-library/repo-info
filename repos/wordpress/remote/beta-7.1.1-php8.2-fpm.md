...
```console
$ docker pull wordpress@sha256:4ba29c6c24b0243d33a48ca60d4ae03ca93806f0117cf7fc5e53a86f8ed16bfc
```
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.1.1-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1.1-php8.2-fpm` - linux; s390x
