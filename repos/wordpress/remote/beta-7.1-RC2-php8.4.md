...
### `wordpress:beta-7.1-RC2-php8.4` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.4` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; riscv64
...
### `wordpress:beta-7.1-RC2-php8.4` - linux; s390x
