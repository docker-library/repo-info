...
```console
$ docker pull wordpress@sha256:1e04a8fad25b9b2df637cf20762361988f3cc1bafa996c30495bc50250a1d503
```
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.1.1-php8.4-fpm-alpine` - linux; s390x
