...
```console
$ docker pull wordpress@sha256:5490f8e4508483a8b10d05ed807438ca8b636231d8625f3205a5fddb8c3f31d0
```
...
### `wordpress:7.0.3-php8.2-fpm` - linux; amd64
...
### `wordpress:7.0.3-php8.2-fpm` - unknown; unknown
...
### `wordpress:7.0.3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:7.0.3-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:7.0.3-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.3-php8.2-fpm` - linux; 386
...
### `wordpress:7.0.3-php8.2-fpm` - linux; ppc64le
...
### `wordpress:7.0.3-php8.2-fpm` - linux; s390x
