...
```console
$ docker pull wordpress@sha256:d791ca9701b9743bb022778958846200aae50d872a834e53f33a1d99f6e9cec5
```
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; amd64
...
### `wordpress:beta-7.0.1-RC1-fpm` - unknown; unknown
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; 386
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; riscv64
...
### `wordpress:beta-7.0.1-RC1-fpm` - linux; s390x
