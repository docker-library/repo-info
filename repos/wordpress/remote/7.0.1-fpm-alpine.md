...
### `wordpress:7.0.1-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.1-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.1-fpm-alpine` - linux; 386
...
### `wordpress:7.0.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.1-fpm-alpine` - linux; riscv64
...
### `wordpress:7.0.1-fpm-alpine` - linux; s390x
