...
```console
$ docker pull wordpress@sha256:7e0d4fbc4f8950a5380d244d6bdadc13e6599a144a6cc81738b818059eaa631c
```
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-RC3-php8.4-apache` - linux; s390x
