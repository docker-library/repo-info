...
```console
$ docker pull wordpress@sha256:364caf23fd9c48103a2fb262cb9d2087e2ec98fb3c45dbaeb636d722e4772cf7
```
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.4-apache` - linux; s390x
