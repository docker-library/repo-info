...
```console
$ docker pull wordpress@sha256:caeaae2e846d471ef9f0a636286f6fc5a0332a521a16834c8466fe0d13308206
```
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.3-fpm-alpine` - linux; s390x
