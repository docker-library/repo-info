...
```console
$ docker pull wordpress@sha256:87a94a8452c76984f10aa703d1fd4f14046804fd52492813138c99b55c6609b9
```
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; riscv64
...
### `wordpress:beta-7.0.1-RC1-php8.4-fpm` - linux; s390x
