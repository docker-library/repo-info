...
```console
$ docker pull wordpress@sha256:3848e3245b444ae626bd4faedc6394d36cb9511ec1c514ce77f2f1e5514d7752
```
...
### `wordpress:7.1.1-php8.4` - linux; amd64
...
### `wordpress:7.1.1-php8.4` - unknown; unknown
...
### `wordpress:7.1.1-php8.4` - linux; arm variant v5
...
### `wordpress:7.1.1-php8.4` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.4` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.4` - linux; 386
...
### `wordpress:7.1.1-php8.4` - linux; ppc64le
...
### `wordpress:7.1.1-php8.4` - linux; s390x
