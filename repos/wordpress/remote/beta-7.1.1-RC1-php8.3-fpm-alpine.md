...
```console
$ docker pull wordpress@sha256:90adf5cf8ed744b80336f7331e54d248a440dde5adda72ae3dff659349b2b4ed
```
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1.1-RC1-php8.3-fpm-alpine` - linux; ppc64le
