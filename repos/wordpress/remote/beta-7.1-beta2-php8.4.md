...
```console
$ docker pull wordpress@sha256:55c719e098d682aabc78cb167626c852fb2da8ed816d259606608ff9c20f6791
```
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.4` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.4` - linux; s390x
