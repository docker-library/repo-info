...
```console
$ docker pull wordpress@sha256:efb9bf108779ccc3ff6d173d61ee220a465c2918fcc2c7f885bc44da927d8d51
```
...
### `wordpress:beta-7.1.1-php8.2` - linux; amd64
...
### `wordpress:beta-7.1.1-php8.2` - unknown; unknown
...
### `wordpress:beta-7.1.1-php8.2` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-php8.2` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-php8.2` - linux; 386
...
### `wordpress:beta-7.1.1-php8.2` - linux; ppc64le
...
### `wordpress:beta-7.1.1-php8.2` - linux; s390x
