...
```console
$ docker pull wordpress@sha256:6f4906fbf460bbe6235e878da9b45efe16544efddd67749a400fd3cf774deff1
```
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.3-php8.5-fpm-alpine` - linux; s390x
