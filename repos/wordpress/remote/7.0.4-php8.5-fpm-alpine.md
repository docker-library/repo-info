...
```console
$ docker pull wordpress@sha256:6106bb6383a509b998223fae99c7acd5f9d90066582f1f3916839f5917bda57f
```
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.4-php8.5-fpm-alpine` - linux; s390x
