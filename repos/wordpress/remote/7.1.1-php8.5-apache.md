...
```console
$ docker pull wordpress@sha256:1d379e24fdb152717d0e64a2816f60b3b76e78ae3e190166d2e8fb5ad8435f54
```
...
### `wordpress:7.1.1-php8.5-apache` - linux; amd64
...
### `wordpress:7.1.1-php8.5-apache` - unknown; unknown
...
### `wordpress:7.1.1-php8.5-apache` - linux; arm variant v5
...
### `wordpress:7.1.1-php8.5-apache` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.5-apache` - linux; 386
...
### `wordpress:7.1.1-php8.5-apache` - linux; ppc64le
...
### `wordpress:7.1.1-php8.5-apache` - linux; s390x
