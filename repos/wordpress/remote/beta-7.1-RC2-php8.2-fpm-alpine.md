...
```console
$ docker pull wordpress@sha256:c21f9169fd64d749fd820bb300b70c21a0715d6ac3e639a8f820cc62876b11cf
```
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.2-fpm-alpine` - linux; s390x
