...
```console
$ docker pull wordpress@sha256:7c9162fe5929e6bc7def58df05c34a44aff6ac8baa5223d1eee13390fa369b05
```
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1.1-RC1-php8.4-apache` - linux; ppc64le
