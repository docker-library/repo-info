...
```console
$ docker pull wordpress@sha256:c7d5f844c89bbf1751f5f9cde9927c10f55b8ed7a17d909229488bd471a6bef5
```
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-php8.5-fpm-alpine` - linux; s390x
