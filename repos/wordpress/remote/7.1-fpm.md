...
### `wordpress:7.1-fpm` - unknown; unknown
...
### `wordpress:7.1-fpm` - linux; arm variant v5
...
### `wordpress:7.1-fpm` - linux; arm variant v7
...
### `wordpress:7.1-fpm` - linux; arm64 variant v8
...
### `wordpress:7.1-fpm` - linux; ppc64le
...
### `wordpress:7.1-fpm` - linux; riscv64
