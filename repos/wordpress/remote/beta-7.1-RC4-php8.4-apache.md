...
```console
$ docker pull wordpress@sha256:e97fa9163ab8b15863fa66d43add04340c201f18e3a42aa5a695e44eb9e88c68
```
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-php8.4-apache` - linux; s390x
