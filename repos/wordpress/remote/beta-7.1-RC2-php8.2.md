## `wordpress:beta-7.1-RC2-php8.2`

```console
$ docker pull wordpress@sha256:12906c23b53f2e7079dc253dddbc5af8247973fc34e023329cd5b18b3c03314b
```
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.2` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.2` - linux; s390x
