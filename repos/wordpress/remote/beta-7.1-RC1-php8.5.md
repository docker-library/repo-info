...
```console
$ docker pull wordpress@sha256:895421dc65225281cfdc9272b050048e79106ebabeb5115eed911bc90c6dc92a
```
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.5` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.5` - linux; s390x
