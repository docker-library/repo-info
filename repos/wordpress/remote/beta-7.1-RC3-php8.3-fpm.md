...
```console
$ docker pull wordpress@sha256:9aa2a71bd297bf9b28b1bfdef64d48fff245d38acfd82758949926ed782a23b2
```
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-RC3-php8.3-fpm` - linux; s390x
