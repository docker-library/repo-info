...
```console
$ docker pull wordpress@sha256:573a3cbfe26098630a9882b4ecf23afafb04961928655eadb61ba92e757f7812
```
...
### `wordpress:7.0.3-php8.5-fpm` - linux; amd64
...
### `wordpress:7.0.3-php8.5-fpm` - unknown; unknown
...
### `wordpress:7.0.3-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:7.0.3-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:7.0.3-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.3-php8.5-fpm` - linux; 386
...
### `wordpress:7.0.3-php8.5-fpm` - linux; ppc64le
...
### `wordpress:7.0.3-php8.5-fpm` - linux; s390x
