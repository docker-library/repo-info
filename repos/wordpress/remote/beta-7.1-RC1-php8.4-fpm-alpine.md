...
```console
$ docker pull wordpress@sha256:e8d7f1b9fbc58c3e87dec011abc8c2148708d9f6ce175b48e0b36433d681643d
```
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.4-fpm-alpine` - linux; s390x
