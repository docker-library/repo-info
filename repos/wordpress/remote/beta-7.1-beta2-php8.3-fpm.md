...
```console
$ docker pull wordpress@sha256:cdd48777db3835b044af70c3dfe6f5746e4c9d35012f4db1b6cd6f1497e065fa
```
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.3-fpm` - linux; s390x
