...
```console
$ docker pull wordpress@sha256:8e80b396d162623f3f56ca97d97970ca079161fa54da2a5076642a62a43cead4
```
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; 386
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-php8.5-apache` - linux; s390x
