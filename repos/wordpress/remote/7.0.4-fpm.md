...
```console
$ docker pull wordpress@sha256:99e8b1ca34fe78f0712c8f99a5667a41c6af11577ffe908901735b38c3264259
```
...
### `wordpress:7.0.4-fpm` - linux; amd64
...
### `wordpress:7.0.4-fpm` - unknown; unknown
...
### `wordpress:7.0.4-fpm` - linux; arm variant v5
...
### `wordpress:7.0.4-fpm` - linux; arm variant v7
...
### `wordpress:7.0.4-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.4-fpm` - linux; ppc64le
...
### `wordpress:7.0.4-fpm` - linux; s390x
