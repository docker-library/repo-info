...
```console
$ docker pull wordpress@sha256:eb90b43f697cb95567f966aa386339e613604001f07e742dd32b688351bc7674
```
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; amd64
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - unknown; unknown
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; 386
...
### `wordpress:beta-7.1.1-RC1-php8.5-apache` - linux; ppc64le
