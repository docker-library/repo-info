...
```console
$ docker pull wordpress@sha256:7eecff5b4bc97891d450dc1059aa64d4be90b3bd1509cfef9bad0ad8e1dffea6
```
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.1.1-php8.2-fpm-alpine` - linux; s390x
