...
```console
$ docker pull wordpress@sha256:adec3d6457e377615f3e35a37efaf8128604c156858ee0d6eea76ce6a25c5ed9
```
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.1.1-php8.3-fpm-alpine` - linux; s390x
