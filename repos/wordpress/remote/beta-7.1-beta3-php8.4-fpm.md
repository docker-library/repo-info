...
```console
$ docker pull wordpress@sha256:58a12056b771ab09735f2e8ef9d05e8ccf354a047156e60e3d4943253297746e
```
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta3-php8.4-fpm` - linux; s390x
