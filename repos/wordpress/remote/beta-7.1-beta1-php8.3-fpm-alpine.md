...
```console
$ docker pull wordpress@sha256:312d6e4bd408da5afa326d982181c37b475158268f82c0bf345d1442e4b6e5bc
```
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta1-php8.3-fpm-alpine` - linux; s390x
