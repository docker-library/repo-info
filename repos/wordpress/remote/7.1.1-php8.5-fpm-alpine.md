...
```console
$ docker pull wordpress@sha256:d5c502f205c7cd135060c720efcacc2dff34bbc219573525a27c17ccd1d81864
```
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.1.1-php8.5-fpm-alpine` - linux; s390x
