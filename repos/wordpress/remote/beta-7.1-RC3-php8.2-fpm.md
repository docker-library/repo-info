...
```console
$ docker pull wordpress@sha256:94b73662375e730de2b4ed75c7537c5c7c6732d60ccb2928eeb3a9c2497ef770
```
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-RC3-php8.2-fpm` - linux; s390x
