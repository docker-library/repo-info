...
```console
$ docker pull wordpress@sha256:f59df18245de087cd90a27a0ec559bd7439bc9d0bd4f1378e8ffa3b236616ce2
```
...
### `wordpress:7.0.3-php8.2-apache` - linux; amd64
...
### `wordpress:7.0.3-php8.2-apache` - unknown; unknown
...
### `wordpress:7.0.3-php8.2-apache` - linux; arm variant v5
...
### `wordpress:7.0.3-php8.2-apache` - linux; arm variant v7
...
### `wordpress:7.0.3-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:7.0.3-php8.2-apache` - linux; 386
...
### `wordpress:7.0.3-php8.2-apache` - linux; ppc64le
...
### `wordpress:7.0.3-php8.2-apache` - linux; s390x
