...
```console
$ docker pull wordpress@sha256:ae0bbf21b7838e4c583631cc82915c5b9c3279feac089837faaed74a33850158
```
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; amd64
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; 386
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-beta4-php8.3-apache` - linux; s390x
