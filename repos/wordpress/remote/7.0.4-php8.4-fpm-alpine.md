...
```console
$ docker pull wordpress@sha256:b400b032c7f6ee018f80f76814dafaab453db9238b28a54fdb48614b4d853f9f
```
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.4-php8.4-fpm-alpine` - linux; s390x
