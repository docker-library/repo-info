...
```console
$ docker pull wordpress@sha256:bf246e0f19c46a06d68ab2ccf0d0610a59a3de3ba8561d5390f440c74453a91b
```
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.2-fpm` - linux; s390x
