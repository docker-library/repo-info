...
```console
$ docker pull wordpress@sha256:2580c868f3da556639178455aba0aab35a37bdb8bfc3d7f61599211bd476e979
```
...
### `wordpress:7.1.1-php8.2-apache` - linux; amd64
...
### `wordpress:7.1.1-php8.2-apache` - unknown; unknown
...
### `wordpress:7.1.1-php8.2-apache` - linux; arm variant v5
...
### `wordpress:7.1.1-php8.2-apache` - linux; arm variant v7
...
### `wordpress:7.1.1-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:7.1.1-php8.2-apache` - linux; 386
...
### `wordpress:7.1.1-php8.2-apache` - linux; ppc64le
...
### `wordpress:7.1.1-php8.2-apache` - linux; s390x
