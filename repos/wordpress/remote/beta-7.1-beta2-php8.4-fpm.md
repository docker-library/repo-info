...
```console
$ docker pull wordpress@sha256:f6dd7d1796c46cc9dae4f3cb46fd14082afe279e58210cb207454b506db648c5
```
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.4-fpm` - linux; s390x
