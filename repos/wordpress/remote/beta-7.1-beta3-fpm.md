...
```console
$ docker pull wordpress@sha256:c89aa8555fcd834bc6c5b3c4384542acdc9e86f1b46e623d5b6b779fb519ccef
```
...
### `wordpress:beta-7.1-beta3-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta3-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta3-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta3-fpm` - linux; s390x
