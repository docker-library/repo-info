...
```console
$ docker pull wordpress@sha256:a25cb218dc9f6cffb86eecb50829f60b6e60b93e29bb596b81cbb0eb3adfd04a
```
...
### `wordpress:7.0.1-php8.4-fpm` - linux; amd64
...
### `wordpress:7.0.1-php8.4-fpm` - unknown; unknown
...
### `wordpress:7.0.1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:7.0.1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:7.0.1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.1-php8.4-fpm` - linux; 386
...
### `wordpress:7.0.1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:7.0.1-php8.4-fpm` - linux; riscv64
...
### `wordpress:7.0.1-php8.4-fpm` - linux; s390x
