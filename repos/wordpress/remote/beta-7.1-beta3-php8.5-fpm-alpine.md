...
```console
$ docker pull wordpress@sha256:349e7b39c0ee925d0de1072787d54bdd76c9cb2907853194905de3ccd78bde8b
```
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta3-php8.5-fpm-alpine` - linux; s390x
