...
```console
$ docker pull wordpress@sha256:10ce14116dab2912a81eb22b26c3bc95ceca5885aded9b225f40e1f069f0cdc5
```
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:7.0.2-php8.5-fpm-alpine` - linux; s390x
