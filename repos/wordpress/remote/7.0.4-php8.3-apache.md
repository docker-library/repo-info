## `wordpress:7.0.4-php8.3-apache`

```console
$ docker pull wordpress@sha256:7cb6f55d466a1e220ac85606de49a52f57a7a5029454aa0f37b8e6dec32d2e19
```
...
### `wordpress:7.0.4-php8.3-apache` - linux; amd64
...
### `wordpress:7.0.4-php8.3-apache` - unknown; unknown
...
### `wordpress:7.0.4-php8.3-apache` - linux; arm variant v5
...
### `wordpress:7.0.4-php8.3-apache` - linux; arm variant v7
...
### `wordpress:7.0.4-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:7.0.4-php8.3-apache` - linux; 386
...
### `wordpress:7.0.4-php8.3-apache` - linux; ppc64le
...
### `wordpress:7.0.4-php8.3-apache` - linux; s390x
