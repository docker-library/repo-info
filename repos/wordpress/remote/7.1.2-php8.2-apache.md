...
```console
$ docker pull wordpress@sha256:fe61cc53d63550f242123aa833cbadb745c513109d3a4f67f10ebaad9af34698
```
...
### `wordpress:7.1.2-php8.2-apache` - linux; amd64
...
### `wordpress:7.1.2-php8.2-apache` - unknown; unknown
...
### `wordpress:7.1.2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:7.1.2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:7.1.2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:7.1.2-php8.2-apache` - linux; 386
...
### `wordpress:7.1.2-php8.2-apache` - linux; ppc64le
...
### `wordpress:7.1.2-php8.2-apache` - linux; s390x
