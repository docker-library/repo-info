...
```console
$ docker pull wordpress@sha256:146b2bc660686229e144676a02fbd80cedf93d57432f3e8cce82d020cfe5761a
```
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC3-php8.5-fpm-alpine` - linux; s390x
