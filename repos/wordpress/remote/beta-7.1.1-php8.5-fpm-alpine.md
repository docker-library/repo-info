...
```console
$ docker pull wordpress@sha256:169c5a60c03d6140d7607d46ac4fcd80026620e8a84dce23a9d2ad9db38fad65
```
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1.1-php8.5-fpm-alpine` - linux; s390x
