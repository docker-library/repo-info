...
```console
$ docker pull wordpress@sha256:c69d8c2a5481d8408ed1332be8ba0277bcb82ef151ae7dda51b4b213596f1d98
```
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.2-fpm-alpine` - linux; s390x
