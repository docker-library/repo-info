...
```console
$ docker pull wordpress@sha256:8d3ba1f9f00ac1015f05e227d22e82d79456d80b2e6227889a0082a0fef18b27
```
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-php8.4-fpm-alpine` - linux; s390x
