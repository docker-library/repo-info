...
```console
$ docker pull wordpress@sha256:9132cf45cd588482cc95bd0f7857a8fe903b33390f7125e4b3354cc64121416d
```
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.4-fpm-alpine` - linux; s390x
