...
```console
$ docker pull wordpress@sha256:bf47edea9c72bf6a12fad13dde640eef9117b231f09e013b2f50f121c52a6bb8
```
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; amd64
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; 386
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; riscv64
...
### `wordpress:beta-7.1-RC4-php8.5-fpm` - linux; s390x
