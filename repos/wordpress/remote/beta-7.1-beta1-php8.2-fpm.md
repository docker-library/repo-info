...
```console
$ docker pull wordpress@sha256:d32e2a5d9f0108214a1e726bc1df18e20c13dca3c6684927221a1efb2535f873
```
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta1-php8.2-fpm` - linux; s390x
