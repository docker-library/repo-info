...
```console
$ docker pull wordpress@sha256:6ccf38751c60c81c0b65b7e93613d9c71ecee07636d80898c69e3ae917ae9ae5
```
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; amd64
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; 386
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-7.1-RC1-php8.3-apache` - linux; s390x
