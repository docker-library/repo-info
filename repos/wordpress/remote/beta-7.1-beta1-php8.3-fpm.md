...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; riscv64
...
### `wordpress:beta-7.1-beta1-php8.3-fpm` - linux; s390x
