...
```console
$ docker pull wordpress@sha256:299d0bfd444efc13801bbc1b0173aed4b266e4bf8c9ac33f4c1744f5053f5478
```
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.1-RC2-php8.4-fpm-alpine` - linux; s390x
