...
```console
$ docker pull wordpress@sha256:62c1c22891df95b4ebd374a8d63517e24b9e5095e010ce09a3bec1f3a5d79adf
```
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.1-beta2-php8.2-fpm` - linux; s390x
