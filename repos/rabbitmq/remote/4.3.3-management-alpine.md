...
```console
$ docker pull rabbitmq@sha256:a05b7f26fad1b8d6f7a36a9030fc641305a328bf7a0eff246568961522f3d46b
```
...
### `rabbitmq:4.3.3-management-alpine` - linux; amd64
...
### `rabbitmq:4.3.3-management-alpine` - unknown; unknown
...
### `rabbitmq:4.3.3-management-alpine` - linux; arm variant v6
...
### `rabbitmq:4.3.3-management-alpine` - linux; arm variant v7
...
### `rabbitmq:4.3.3-management-alpine` - linux; arm64 variant v8
...
### `rabbitmq:4.3.3-management-alpine` - linux; 386
...
### `rabbitmq:4.3.3-management-alpine` - linux; ppc64le
...
### `rabbitmq:4.3.3-management-alpine` - linux; s390x
