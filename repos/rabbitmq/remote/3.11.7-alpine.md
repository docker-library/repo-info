...
```console
$ docker pull rabbitmq@sha256:ae5c239beadea9bd2eaa0548dc733fb6b18461e29e9a03bc57d7e4dd3d3286ec
```
...
### `rabbitmq:3.11.7-alpine` - linux; amd64
...
### `rabbitmq:3.11.7-alpine` - linux; arm variant v6
...
### `rabbitmq:3.11.7-alpine` - linux; arm variant v7
...
### `rabbitmq:3.11.7-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.11.7-alpine` - linux; ppc64le
...
### `rabbitmq:3.11.7-alpine` - linux; s390x
