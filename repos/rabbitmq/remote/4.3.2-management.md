...
```console
$ docker pull rabbitmq@sha256:47bd157554ee438e52d06fc46a738aaee792415ed2e1aa1bcee2d568237e49a8
```
...
### `rabbitmq:4.3.2-management` - linux; amd64
...
### `rabbitmq:4.3.2-management` - unknown; unknown
...
### `rabbitmq:4.3.2-management` - linux; arm variant v7
...
### `rabbitmq:4.3.2-management` - linux; arm64 variant v8
...
### `rabbitmq:4.3.2-management` - linux; ppc64le
...
### `rabbitmq:4.3.2-management` - linux; riscv64
...
### `rabbitmq:4.3.2-management` - linux; s390x
