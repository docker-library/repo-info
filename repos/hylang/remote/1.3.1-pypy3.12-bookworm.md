...
### `hylang:1.3.1-pypy3.12-bookworm` - linux; amd64
...
### `hylang:1.3.1-pypy3.12-bookworm` - unknown; unknown
...
### `hylang:1.3.1-pypy3.12-bookworm` - linux; arm64 variant v8
...
### `hylang:1.3.1-pypy3.12-bookworm` - linux; 386
