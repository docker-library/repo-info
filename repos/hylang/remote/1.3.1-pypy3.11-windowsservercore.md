...
```console
$ docker pull hylang@sha256:8ec39478f51177451d2b2f4d5e9964889728a17387bcf28101966d87a3c40451
```
...
### `hylang:1.3.1-pypy3.11-windowsservercore` - windows version 10.0.26100.33438; amd64
...
### `hylang:1.3.1-pypy3.11-windowsservercore` - windows version 10.0.20348.5622; amd64
