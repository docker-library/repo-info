...
### `hylang:pypy3.12-bookworm` - linux; amd64
...
### `hylang:pypy3.12-bookworm` - unknown; unknown
...
### `hylang:pypy3.12-bookworm` - linux; arm64 variant v8
...
### `hylang:pypy3.12-bookworm` - linux; 386
