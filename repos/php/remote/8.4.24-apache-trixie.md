...
```console
$ docker pull php@sha256:17129847f39569ae3e7e164964713159428674f75a65642c8b79ab37e8be16d6
```
...
```console
$ docker pull php@sha256:df79776a606bf5546f146c6d2be6b3946c47dc9316afd8a3bf4a3625ea8622bc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153188683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fd0cd6a3c4bc0578c421af6006aa75bf76abc0573dd521359cff65aecebe7c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:a0f0dc596534d3e4519d593f8ed7240bfb25e27d1850f42cc72c1d7705f167ac
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7076909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:598817333d753fe0c8ef24d03d57a1a8a040f9b072c68f6a0f619805a6e7dc10`

```dockerfile
```

-	Layers:
	-	`sha256:cbda5e264470f1a581db81188cf7322bac9f9e3c7b2160b600e87386af5b1999`  
		Last Modified: Tue, 25 Aug 2026 00:31:47 GMT  
		Size: 7.0 MB (7014394 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fa5ee0656955f0bd863326a0531f69b8fc5fbc19ca1fca182738b560a01b909f`  
		Last Modified: Tue, 25 Aug 2026 00:31:46 GMT  
...
```console
$ docker pull php@sha256:1edc7bb114cc218934705c7683a1d59cee81cf22d19ba70cc6936b825d94a09a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176142229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:182680ba55bbbdbd70dfb86c6e7c3a3d32dd84f335717e87a6a4f0424908868b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:04339a01679253d848ec33391d22e72adf9a17d844689d06766418c690f857ac
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7276719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d8ae524aa5b0c59f8b02337c94448b4bef8db3bd399e011b26f13f79b01901a`

```dockerfile
```

-	Layers:
	-	`sha256:f4596dc9364cc038d4aba32ca5781af3cda962101fad0e73a8e41d60e6baf8ba`  
		Last Modified: Tue, 25 Aug 2026 02:17:56 GMT  
		Size: 7.2 MB (7214326 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7935654d4933d1a58fbdccaf86b79c50c583900904c8a56c7f3e40736a7004bd`  
		Last Modified: Tue, 25 Aug 2026 02:17:55 GMT  
...
```console
$ docker pull php@sha256:edcca4d480d3ace5b506ff86a1f234e312578180c006f2e1bcb662600cc3ccc3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.0 MB (209012039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef37694ea6bc838285380cc3fb9d9cd4d4273ebd2b8a324a66e895fd4cf833cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 25 Aug 2026 10:02:27 GMT
ENV PHP_SHA256=e127be09a8506f4327c5cfa78a614b00d210714484ec215ce0011b4a03c00731
# Wed, 26 Aug 2026 02:03:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	apt-get dist-clean; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 	export GNUPGHOME="$(mktemp -d)"; 	for key in $GPG_KEYS; do 		gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 	done; 	gpg --batch --verify php.tar.xz.asc php.tar.xz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false # buildkit
# Wed, 26 Aug 2026 02:03:11 GMT
COPY docker-php-source /usr/local/bin/ # buildkit
# Wed, 26 Aug 2026 02:57:44 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	test "$PHP_INI_DIR" != "${PHP_INI_DIR%/php}"; 	./configure 		--build="$gnuArch" 		--sysconfdir="${PHP_INI_DIR%/php}" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -rt dpkg-query --search 		| awk 'sub(":$", "", $1) { print $1 }' 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	apt-get dist-clean; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version # buildkit
# Wed, 26 Aug 2026 02:57:44 GMT
COPY docker-php-ext-* docker-php-entrypoint /usr/local/bin/ # buildkit
# Wed, 26 Aug 2026 02:57:45 GMT
RUN docker-php-ext-enable opcache # buildkit
# Wed, 26 Aug 2026 02:57:45 GMT
RUN docker-php-ext-enable sodium # buildkit
# Wed, 26 Aug 2026 02:57:45 GMT
...
-	Layers:
	...
	-	`sha256:20cfdcc7c18452e521252f2720b790a390be42a44250c01c56a49af9794fd1fc`  
		...
		Size: 492.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a8c427c1305255cd1f3bad4a3aea2f31037abe60723375c88661cf3dd80945e`  
		Last Modified: Wed, 26 Aug 2026 03:00:59 GMT  
		Size: 13.9 MB (13933746 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4c2c1ae823e41d7fa1f13367c832a8642c55e76c48dcb8385b875dac01308903`  
		Last Modified: Wed, 26 Aug 2026 03:00:55 GMT  
		Size: 489.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b2fc68ee4c41d14998855b718fc37eb3838e4fb802a5106294e18c19896850f3`  
		Last Modified: Wed, 26 Aug 2026 03:01:03 GMT  
		Size: 16.1 MB (16144223 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:836acf6131e36e4e20be4b516c362d20558f4e56d77a5f119005abd2450dc1bd`  
		Last Modified: Wed, 26 Aug 2026 03:00:56 GMT  
		Size: 2.5 KB (2466 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:67740d1817aa17467160b126d42f089c212f42c8d49657fd5baa01822b80f2fa`  
		Last Modified: Wed, 26 Aug 2026 03:00:58 GMT  
		Size: 255.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:79b596565459da210d4e8acabadfb81a38fec7733c5621c366c1bb2bad1eb5b0`  
		Last Modified: Wed, 26 Aug 2026 03:00:59 GMT  
		Size: 250.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d2c48c6f0ccf5105bed96caad2c9f9097ae8ae47ec0a5e6719dbe0b0cad662c6`  
		Last Modified: Wed, 26 Aug 2026 03:00:59 GMT  
		Size: 894.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
...
```console
$ docker pull php@sha256:21c5a57a6e801c338523334a9441766cec6ea737d119d59e6987a44b5e0d8c8b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7348744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34f9dcb85287f771ce9d7153d2230d26b7dcb0908a76be51ab2a21c904dd8179`

```dockerfile
```

-	Layers:
	-	`sha256:a66e2b3c9a2ec256305019f77d75fdc4b405c09fff6f24646ded0d0efa4b6283`  
		Last Modified: Wed, 26 Aug 2026 03:00:59 GMT  
		Size: 7.3 MB (7286351 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2b0868f0a022d3870eaf1b05056146efb3c2c3617c816c39bcee2bdabccb3913`  
		Last Modified: Wed, 26 Aug 2026 03:00:55 GMT  
		Size: 62.4 KB (62393 bytes)  
		MIME: application/vnd.in-toto+json
