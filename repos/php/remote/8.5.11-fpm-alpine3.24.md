## `php:8.5.11-fpm-alpine3.24`

```console
$ docker pull php@sha256:94ca6b9ecaf5e80e45759694502e55278f0b8e3652455275f4e12dd6f13ecf64
```
...
### `php:8.5.11-fpm-alpine3.24` - linux; amd64
...
### `php:8.5.11-fpm-alpine3.24` - unknown; unknown
...
### `php:8.5.11-fpm-alpine3.24` - linux; arm variant v6
...
### `php:8.5.11-fpm-alpine3.24` - linux; arm variant v7
...
### `php:8.5.11-fpm-alpine3.24` - linux; arm64 variant v8
...
### `php:8.5.11-fpm-alpine3.24` - linux; 386
...
### `php:8.5.11-fpm-alpine3.24` - linux; ppc64le
...
### `php:8.5.11-fpm-alpine3.24` - linux; s390x
