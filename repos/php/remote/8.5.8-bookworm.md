...
### `php:8.5.8-bookworm` - linux; amd64
...
### `php:8.5.8-bookworm` - unknown; unknown
...
### `php:8.5.8-bookworm` - linux; arm variant v5
...
### `php:8.5.8-bookworm` - linux; arm variant v7
...
### `php:8.5.8-bookworm` - linux; arm64 variant v8
...
### `php:8.5.8-bookworm` - linux; mips64le
...
### `php:8.5.8-bookworm` - linux; ppc64le
...
### `php:8.5.8-bookworm` - linux; s390x
