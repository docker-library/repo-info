...
```console
$ docker pull php@sha256:a095f86ffe65445c0cd72ba12c246438a93f4630f3a16853ce398f9e8824a2e6
```
...
### `php:8.5.11-zts-alpine3.23` - linux; amd64
...
### `php:8.5.11-zts-alpine3.23` - unknown; unknown
...
### `php:8.5.11-zts-alpine3.23` - linux; arm variant v6
...
### `php:8.5.11-zts-alpine3.23` - linux; arm variant v7
...
### `php:8.5.11-zts-alpine3.23` - linux; arm64 variant v8
...
### `php:8.5.11-zts-alpine3.23` - linux; 386
...
### `php:8.5.11-zts-alpine3.23` - linux; ppc64le
...
### `php:8.5.11-zts-alpine3.23` - linux; s390x
