...
```console
$ docker pull php@sha256:7f80f90b93a394c49311a816eed8a2e77ab94fec56a8f086531e62512e509472
```
...
### `php:8.4.24-fpm-alpine3.24` - linux; amd64
...
### `php:8.4.24-fpm-alpine3.24` - unknown; unknown
...
### `php:8.4.24-fpm-alpine3.24` - linux; arm variant v6
...
### `php:8.4.24-fpm-alpine3.24` - linux; arm variant v7
...
### `php:8.4.24-fpm-alpine3.24` - linux; arm64 variant v8
...
### `php:8.4.24-fpm-alpine3.24` - linux; 386
...
### `php:8.4.24-fpm-alpine3.24` - linux; ppc64le
...
### `php:8.4.24-fpm-alpine3.24` - linux; s390x
