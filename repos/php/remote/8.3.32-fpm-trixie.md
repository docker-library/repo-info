...
```console
$ docker pull php@sha256:efaea017a0c269b359a5db12987d221eac127e192f98b60bb849538d2d9a3253
```
...
### `php:8.3.32-fpm-trixie` - linux; amd64
...
### `php:8.3.32-fpm-trixie` - unknown; unknown
...
### `php:8.3.32-fpm-trixie` - linux; arm variant v5
...
### `php:8.3.32-fpm-trixie` - linux; arm variant v7
...
### `php:8.3.32-fpm-trixie` - linux; arm64 variant v8
...
### `php:8.3.32-fpm-trixie` - linux; 386
...
### `php:8.3.32-fpm-trixie` - linux; ppc64le
...
### `php:8.3.32-fpm-trixie` - linux; riscv64
...
### `php:8.3.32-fpm-trixie` - linux; s390x
