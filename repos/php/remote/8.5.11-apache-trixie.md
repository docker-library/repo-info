## `php:8.5.11-apache-trixie`

```console
$ docker pull php@sha256:b61cd94fd1bcc844142f90ec6afdf9a0c717bbbe18cac3d7ee56ed706e7e55d0
```
...
### `php:8.5.11-apache-trixie` - linux; amd64
...
### `php:8.5.11-apache-trixie` - unknown; unknown
...
### `php:8.5.11-apache-trixie` - linux; arm variant v5
...
### `php:8.5.11-apache-trixie` - linux; arm variant v7
...
### `php:8.5.11-apache-trixie` - linux; arm64 variant v8
...
### `php:8.5.11-apache-trixie` - linux; 386
...
### `php:8.5.11-apache-trixie` - linux; ppc64le
...
### `php:8.5.11-apache-trixie` - linux; s390x
