## `php:8.5.11-zts-alpine`

```console
$ docker pull php@sha256:443dd1f063adabce513e55828e65e3b543c1a6735ee8cf68f37fcfff26476bf8
```
...
### `php:8.5.11-zts-alpine` - linux; amd64
...
### `php:8.5.11-zts-alpine` - unknown; unknown
...
### `php:8.5.11-zts-alpine` - linux; arm variant v6
...
### `php:8.5.11-zts-alpine` - linux; arm variant v7
...
### `php:8.5.11-zts-alpine` - linux; arm64 variant v8
...
### `php:8.5.11-zts-alpine` - linux; 386
...
### `php:8.5.11-zts-alpine` - linux; ppc64le
...
### `php:8.5.11-zts-alpine` - linux; s390x
