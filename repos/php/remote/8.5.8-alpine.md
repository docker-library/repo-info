...
```console
$ docker pull php@sha256:c87ec5d5eddd5314857f4f23f103025d7faae684fd79a076043daa2d44cf4e7f
```
...
### `php:8.5.8-alpine` - unknown; unknown
...
### `php:8.5.8-alpine` - linux; arm variant v6
...
### `php:8.5.8-alpine` - linux; arm variant v7
...
### `php:8.5.8-alpine` - linux; arm64 variant v8
...
### `php:8.5.8-alpine` - linux; ppc64le
