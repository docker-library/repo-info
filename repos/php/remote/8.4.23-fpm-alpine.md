...
```console
$ docker pull php@sha256:913ddd6934a805429618a16aa36da47cd8a8aec8b2f111c294936ba4003fded6
```
...
### `php:8.4.23-fpm-alpine` - linux; amd64
...
### `php:8.4.23-fpm-alpine` - unknown; unknown
...
### `php:8.4.23-fpm-alpine` - linux; arm variant v6
...
### `php:8.4.23-fpm-alpine` - linux; arm variant v7
...
### `php:8.4.23-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.4.23-fpm-alpine` - linux; 386
...
### `php:8.4.23-fpm-alpine` - linux; ppc64le
...
### `php:8.4.23-fpm-alpine` - linux; riscv64

```console
$ docker pull php@sha256:aa4051b77b4bc650afa80e72a186370e4b60e205a81de11f1b396cd1f5732cfc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.2 MB (36172069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4434a2c0409a0099c8499edd87deceaa70daeb38d44a4545421aad6f7708e14`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:e1cbe81136fc1c810cc8e263795d8ac4826d2fa50151da0b4076beedaed877a8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.2 KB (309179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7690b14040618525f533ef8534a7453f9ad85786d735851cf20d11e6258e4c23`

```dockerfile
```

-	Layers:
	-	`sha256:1540a13cbc12bfb453f9651f5e0d9f16701043c26d39d1d3a1b3816b4a71e0e9`  
		Last Modified: Fri, 03 Jul 2026 12:07:25 GMT  
		Size: 258.0 KB (258038 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a4b381c8687c47a66e0877be5e1fefdd2fe5ba4b11c197f6e28fd7c0e5be8bf3`  
		Last Modified: Fri, 03 Jul 2026 12:07:25 GMT  
		Size: 51.1 KB (51141 bytes)  
		MIME: application/vnd.in-toto+json

### `php:8.4.23-fpm-alpine` - linux; s390x
