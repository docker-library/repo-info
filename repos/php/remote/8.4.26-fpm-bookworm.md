...
### `php:8.4.26-fpm-bookworm` - linux; amd64
...
### `php:8.4.26-fpm-bookworm` - unknown; unknown
...
### `php:8.4.26-fpm-bookworm` - linux; arm variant v7
...
### `php:8.4.26-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.4.26-fpm-bookworm` - linux; 386
...
### `php:8.4.26-fpm-bookworm` - linux; ppc64le
