...
### `php:8.5.10-apache-bookworm` - linux; amd64
...
### `php:8.5.10-apache-bookworm` - unknown; unknown
...
### `php:8.5.10-apache-bookworm` - linux; arm variant v7
...
### `php:8.5.10-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.5.10-apache-bookworm` - linux; 386
...
### `php:8.5.10-apache-bookworm` - linux; ppc64le
