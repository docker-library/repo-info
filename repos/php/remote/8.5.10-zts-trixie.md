...
```console
$ docker pull php@sha256:d8276baccf39a49fe6e3b36a1403c12fae0d27c12a77ace9d0f31c806248489d
```
...
### `php:8.5.10-zts-trixie` - linux; amd64
...
### `php:8.5.10-zts-trixie` - unknown; unknown
...
### `php:8.5.10-zts-trixie` - linux; arm variant v5
...
### `php:8.5.10-zts-trixie` - linux; arm variant v7
...
### `php:8.5.10-zts-trixie` - linux; arm64 variant v8
...
### `php:8.5.10-zts-trixie` - linux; ppc64le
...
### `php:8.5.10-zts-trixie` - linux; riscv64
...
### `php:8.5.10-zts-trixie` - linux; s390x
