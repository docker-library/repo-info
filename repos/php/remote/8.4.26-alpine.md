...
```console
$ docker pull php@sha256:a5afbbcd1fb5264d3f9a90e4fd40616a12b696f41aedf4a24735808002099206
```
...
### `php:8.4.26-alpine` - unknown; unknown
...
### `php:8.4.26-alpine` - linux; arm variant v6
...
### `php:8.4.26-alpine` - linux; arm variant v7
...
### `php:8.4.26-alpine` - linux; arm64 variant v8
...
### `php:8.4.26-alpine` - linux; ppc64le
